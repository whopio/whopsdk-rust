...
pub use resources::{
    ...
    FinancialActivityClient, ForumPostsClient, ForumsClient, IdentityProfilesClient,
    InvoicesClient, LeadsClient, LedgerAccountsClient, LedgersClient, MediaClient, MembersClient,
    MembershipsClient, MessagesClient, NotificationsClient, PartnersClient,
