...
pub enum CreateAdGroupsRequestPlacementsOneItemPlatform {
    Facebook,
    Instagram,
    Messenger,
    AudienceNetwork,
...
impl Serialize for CreateAdGroupsRequestPlacementsOneItemPlatform {
...
impl<'de> Deserialize<'de> for CreateAdGroupsRequestPlacementsOneItemPlatform {
...
impl fmt::Display for CreateAdGroupsRequestPlacementsOneItemPlatform {
