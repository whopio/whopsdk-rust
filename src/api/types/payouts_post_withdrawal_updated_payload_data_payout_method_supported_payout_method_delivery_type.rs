...
pub enum PostWithdrawalUpdatedPayloadDataPayoutMethodSupportedPayoutMethodDeliveryType {
    CashPickup,
    BankDeposit,
    HomeDelivery,
    MobileWallet,
...
impl Serialize for PostWithdrawalUpdatedPayloadDataPayoutMethodSupportedPayoutMethodDeliveryType {
...
impl<'de> Deserialize<'de>
    for PostWithdrawalUpdatedPayloadDataPayoutMethodSupportedPayoutMethodDeliveryType
{
