...
pub enum PostPayoutUpdatedPayloadDataStatus {
    Requested,
    InReview,
    Processing,
    Completed,
...
impl Serialize for PostPayoutUpdatedPayloadDataStatus {
...
impl<'de> Deserialize<'de> for PostPayoutUpdatedPayloadDataStatus {
...
impl fmt::Display for PostPayoutUpdatedPayloadDataStatus {
