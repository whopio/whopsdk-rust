...
pub enum CreateAdCampaignsRequestBudgetOptimization {
    AdCampaign,
    AdGroup,
...
impl Serialize for CreateAdCampaignsRequestBudgetOptimization {
...
impl<'de> Deserialize<'de> for CreateAdCampaignsRequestBudgetOptimization {
...
impl fmt::Display for CreateAdCampaignsRequestBudgetOptimization {
