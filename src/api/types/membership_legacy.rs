...
pub struct MembershipLegacy {
    ...
    #[serde(default)]
    pub company: MembershipLegacyCompany,
    ...
    #[serde(default)]
    pub custom_field_responses: Vec<MembershipLegacyCustomFieldResponsesItem>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub member: Option<MembershipLegacyMember>,
    ...
    #[serde(default)]
    pub plan: MembershipLegacyPlan,
    /// The product this membership grants access to.
    #[serde(default)]
    pub product: MembershipLegacyProduct,
    /// The promotional code currently applied to this membership's billing. Null if no promo code is active.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub promo_code: Option<MembershipLegacyPromoCode>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub user: Option<MembershipLegacyUser>,
}

impl MembershipLegacy {
    pub fn builder() -> MembershipLegacyBuilder {
        <MembershipLegacyBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct MembershipLegacyBuilder {
    ...
    company: Option<MembershipLegacyCompany>,
    created_at: Option<DateTime<FixedOffset>>,
    currency: Option<Currencies>,
    custom_field_responses: Option<Vec<MembershipLegacyCustomFieldResponsesItem>>,
    ...
    member: Option<MembershipLegacyMember>,
    metadata: Option<HashMap<String, serde_json::Value>>,
    payment_collection_paused: Option<bool>,
    plan: Option<MembershipLegacyPlan>,
    product: Option<MembershipLegacyProduct>,
    promo_code: Option<MembershipLegacyPromoCode>,
    ...
    user: Option<MembershipLegacyUser>,
}

impl MembershipLegacyBuilder {
    ...
    pub fn company(mut self, value: MembershipLegacyCompany) -> Self {
    ...
    pub fn custom_field_responses(
        mut self,
        value: Vec<MembershipLegacyCustomFieldResponsesItem>,
    ) -> Self {
    ...
    pub fn member(mut self, value: MembershipLegacyMember) -> Self {
    ...
    pub fn plan(mut self, value: MembershipLegacyPlan) -> Self {
        self.plan = Some(value);
        self
    }

    pub fn product(mut self, value: MembershipLegacyProduct) -> Self {
        self.product = Some(value);
        self
    }

    pub fn promo_code(mut self, value: MembershipLegacyPromoCode) -> Self {
    ...
    pub fn user(mut self, value: MembershipLegacyUser) -> Self {
        self.user = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`MembershipLegacy`].
    /// This method will fail if any of the following fields are not set:
    /// - [`cancel_at_period_end`](MembershipLegacyBuilder::cancel_at_period_end)
    /// - [`company`](MembershipLegacyBuilder::company)
    /// - [`created_at`](MembershipLegacyBuilder::created_at)
    /// - [`custom_field_responses`](MembershipLegacyBuilder::custom_field_responses)
    /// - [`id`](MembershipLegacyBuilder::id)
    /// - [`initial_price_paid`](MembershipLegacyBuilder::initial_price_paid)
    /// - [`payment_collection_paused`](MembershipLegacyBuilder::payment_collection_paused)
    /// - [`plan`](MembershipLegacyBuilder::plan)
    /// - [`product`](MembershipLegacyBuilder::product)
    /// - [`status`](MembershipLegacyBuilder::status)
    /// - [`updated_at`](MembershipLegacyBuilder::updated_at)
    pub fn build(self) -> Result<MembershipLegacy, BuildError> {
        Ok(MembershipLegacy {
