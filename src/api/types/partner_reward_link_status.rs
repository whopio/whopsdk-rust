...
pub enum PartnerRewardLinkStatus {
    Available,
    FullyClaimed,
    Expired,
    Unavailable,
...
impl Serialize for PartnerRewardLinkStatus {
...
impl<'de> Deserialize<'de> for PartnerRewardLinkStatus {
...
impl fmt::Display for PartnerRewardLinkStatus {
