...
pub struct AiChatListItem {
    ...
    #[serde(default)]
    pub user: AiChatListItemUser,
}

impl AiChatListItem {
    pub fn builder() -> AiChatListItemBuilder {
        <AiChatListItemBuilder as Default>::default()
    }
}
...
pub struct AiChatListItemBuilder {
    ...
    user: Option<AiChatListItemUser>,
}
...
impl AiChatListItemBuilder {
    ...
    pub fn user(mut self, value: AiChatListItemUser) -> Self {
    ...
    /// - [`message_count`](AiChatListItemBuilder::message_count)
    /// - [`notification_preference`](AiChatListItemBuilder::notification_preference)
    /// - [`updated_at`](AiChatListItemBuilder::updated_at)
