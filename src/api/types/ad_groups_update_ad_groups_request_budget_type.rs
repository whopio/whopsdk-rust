...
pub enum UpdateAdGroupsRequestBudgetType {
    Daily,
    Lifetime,
...
impl Serialize for UpdateAdGroupsRequestBudgetType {
...
impl<'de> Deserialize<'de> for UpdateAdGroupsRequestBudgetType {
...
impl fmt::Display for UpdateAdGroupsRequestBudgetType {
