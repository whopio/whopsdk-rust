...
pub struct CheckoutConfiguration {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub currency: Option<CheckoutConfigurationCurrency>,
    ...
    pub mode: CheckoutConfigurationMode,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub plan: Option<CheckoutConfigurationPlan>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub three_ds_level: Option<CheckoutConfigurationThreeDsLevel>,
...
impl CheckoutConfiguration {
    pub fn builder() -> CheckoutConfigurationBuilder {
        <CheckoutConfigurationBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CheckoutConfigurationBuilder {
    account_id: Option<String>,
    affiliate_code: Option<String>,
    created_at: Option<String>,
    currency: Option<CheckoutConfigurationCurrency>,
    effective_payment_method_configuration: Option<CheckoutSessionPaymentMethodConfiguration>,
    id: Option<String>,
    metadata: Option<HashMap<String, serde_json::Value>>,
    mode: Option<CheckoutConfigurationMode>,
    payment_method_configuration: Option<HashMap<String, serde_json::Value>>,
    plan: Option<CheckoutConfigurationPlan>,
    purchase_url: Option<String>,
    redirect_url: Option<String>,
    three_ds_level: Option<CheckoutConfigurationThreeDsLevel>,
    updated_at: Option<String>,
}

impl CheckoutConfigurationBuilder {
    ...
    pub fn currency(mut self, value: CheckoutConfigurationCurrency) -> Self {
    ...
    pub fn mode(mut self, value: CheckoutConfigurationMode) -> Self {
    ...
    pub fn plan(mut self, value: CheckoutConfigurationPlan) -> Self {
    ...
    pub fn three_ds_level(mut self, value: CheckoutConfigurationThreeDsLevel) -> Self {
    ...
    /// Consumes the builder and constructs a [`CheckoutConfiguration`].
    /// This method will fail if any of the following fields are not set:
    /// - [`account_id`](CheckoutConfigurationBuilder::account_id)
    /// - [`created_at`](CheckoutConfigurationBuilder::created_at)
    /// - [`id`](CheckoutConfigurationBuilder::id)
    /// - [`mode`](CheckoutConfigurationBuilder::mode)
    /// - [`updated_at`](CheckoutConfigurationBuilder::updated_at)
    pub fn build(self) -> Result<CheckoutConfiguration, BuildError> {
        Ok(CheckoutConfiguration {
            account_id: self
                .account_id
