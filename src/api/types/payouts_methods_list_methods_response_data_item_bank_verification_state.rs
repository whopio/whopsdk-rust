...
pub enum ListMethodsResponseDataItemBankVerificationState {
    Checking,
    Verified,
    NoData,
    Warning,
...
impl Serialize for ListMethodsResponseDataItemBankVerificationState {
...
impl<'de> Deserialize<'de> for ListMethodsResponseDataItemBankVerificationState {
...
impl fmt::Display for ListMethodsResponseDataItemBankVerificationState {
