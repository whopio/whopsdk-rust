...
pub enum PostAdCampaignUpdatedPayloadDataBudgetOptimization {
    AdCampaign,
    AdGroup,
...
impl Serialize for PostAdCampaignUpdatedPayloadDataBudgetOptimization {
...
impl<'de> Deserialize<'de> for PostAdCampaignUpdatedPayloadDataBudgetOptimization {
...
impl fmt::Display for PostAdCampaignUpdatedPayloadDataBudgetOptimization {
