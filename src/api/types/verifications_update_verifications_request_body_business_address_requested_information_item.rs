...
pub struct UpdateVerificationsRequestBodyBusinessAddressRequestedInformationItem {
...
impl UpdateVerificationsRequestBodyBusinessAddressRequestedInformationItem {
    pub fn builder() -> UpdateVerificationsRequestBodyBusinessAddressRequestedInformationItemBuilder
    {
        <UpdateVerificationsRequestBodyBusinessAddressRequestedInformationItemBuilder as Default>::default()
    }
}
...
impl UpdateVerificationsRequestBodyBusinessAddressRequestedInformationItemBuilder {
    ...
    pub fn documents(
        mut self,
        value: UpdateVerificationsRequestBodyBusinessAddressRequestedInformationItemDocuments,
    ) -> Self {
    ...
    pub fn value_type(
        mut self,
        value: UpdateVerificationsRequestBodyBusinessAddressRequestedInformationItemValueType,
    ) -> Self {
    ...
    pub fn build(
        self,
    ) -> Result<UpdateVerificationsRequestBodyBusinessAddressRequestedInformationItem, BuildError>
    {
        Ok(
