...
pub enum UpdatePreferencesResponseAdsCertificationsItemStatus {
    NotStarted,
    PendingInformation,
    InReview,
    Approved,
...
impl Serialize for UpdatePreferencesResponseAdsCertificationsItemStatus {
...
impl<'de> Deserialize<'de> for UpdatePreferencesResponseAdsCertificationsItemStatus {
...
impl fmt::Display for UpdatePreferencesResponseAdsCertificationsItemStatus {
