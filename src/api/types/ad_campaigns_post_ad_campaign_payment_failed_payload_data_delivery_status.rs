...
pub enum PostAdCampaignPaymentFailedPayloadDataDeliveryStatus {
    PaymentFailed,
    AllAdsRejected,
    Draft,
    NoAdGroups,
...
impl Serialize for PostAdCampaignPaymentFailedPayloadDataDeliveryStatus {
...
impl<'de> Deserialize<'de> for PostAdCampaignPaymentFailedPayloadDataDeliveryStatus {
...
impl fmt::Display for PostAdCampaignPaymentFailedPayloadDataDeliveryStatus {
