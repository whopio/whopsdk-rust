...
pub struct CreatePaymentsRequestBodyOnePlan {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub product: Option<CreatePaymentsRequestBodyOnePlanProduct>,
...
impl CreatePaymentsRequestBodyOnePlan {
    pub fn builder() -> CreatePaymentsRequestBodyOnePlanBuilder {
        <CreatePaymentsRequestBodyOnePlanBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreatePaymentsRequestBodyOnePlanBuilder {
    ...
    product: Option<CreatePaymentsRequestBodyOnePlanProduct>,
...
impl CreatePaymentsRequestBodyOnePlanBuilder {
    ...
    pub fn product(mut self, value: CreatePaymentsRequestBodyOnePlanProduct) -> Self {
    ...
    /// Consumes the builder and constructs a [`CreatePaymentsRequestBodyOnePlan`].
    /// This method will fail if any of the following fields are not set:
    /// - [`currency`](CreatePaymentsRequestBodyOnePlanBuilder::currency)
    pub fn build(self) -> Result<CreatePaymentsRequestBodyOnePlan, BuildError> {
        Ok(CreatePaymentsRequestBodyOnePlan {
