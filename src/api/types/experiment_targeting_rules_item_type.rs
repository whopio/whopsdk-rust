...
pub enum ExperimentTargetingRulesItemType {
    Include,
    Exclude,
...
impl Serialize for ExperimentTargetingRulesItemType {
...
impl<'de> Deserialize<'de> for ExperimentTargetingRulesItemType {
...
impl fmt::Display for ExperimentTargetingRulesItemType {
