...
pub struct CreateInvoicesRequestBodyProductBillingAddress {
...
impl CreateInvoicesRequestBodyProductBillingAddress {
    pub fn builder() -> CreateInvoicesRequestBodyProductBillingAddressBuilder {
        <CreateInvoicesRequestBodyProductBillingAddressBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateInvoicesRequestBodyProductBillingAddressBuilder {
    city: Option<String>,
...
impl CreateInvoicesRequestBodyProductBillingAddressBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateInvoicesRequestBodyProductBillingAddress`].
    pub fn build(self) -> Result<CreateInvoicesRequestBodyProductBillingAddress, BuildError> {
        Ok(CreateInvoicesRequestBodyProductBillingAddress {
            city: self.city,
