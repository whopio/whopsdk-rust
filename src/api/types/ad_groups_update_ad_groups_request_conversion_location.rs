...
pub enum UpdateAdGroupsRequestConversionLocation {
    Website,
    Profile,
...
impl Serialize for UpdateAdGroupsRequestConversionLocation {
...
impl<'de> Deserialize<'de> for UpdateAdGroupsRequestConversionLocation {
...
impl fmt::Display for UpdateAdGroupsRequestConversionLocation {
