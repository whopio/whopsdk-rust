...
pub enum WebhookTestableEventsItem {
    AccountUpdated,
...
impl Serialize for WebhookTestableEventsItem {
...
impl<'de> Deserialize<'de> for WebhookTestableEventsItem {
...
impl fmt::Display for WebhookTestableEventsItem {
