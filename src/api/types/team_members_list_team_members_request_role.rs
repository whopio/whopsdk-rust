...
pub enum ListTeamMembersRequestRole {
    Owner,
    Admin,
    SalesManager,
    Moderator,
...
impl Serialize for ListTeamMembersRequestRole {
...
impl<'de> Deserialize<'de> for ListTeamMembersRequestRole {
...
impl fmt::Display for ListTeamMembersRequestRole {
