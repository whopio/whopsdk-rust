...
pub enum CreateCheckoutConfigurationsRequestPlanThreeDsLevel {
    MandateChallenge,
    Frictionless,
...
impl Serialize for CreateCheckoutConfigurationsRequestPlanThreeDsLevel {
...
impl<'de> Deserialize<'de> for CreateCheckoutConfigurationsRequestPlanThreeDsLevel {
...
impl fmt::Display for CreateCheckoutConfigurationsRequestPlanThreeDsLevel {
