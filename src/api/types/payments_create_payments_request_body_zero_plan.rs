...
pub struct CreatePaymentsRequestBodyZeroPlan {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub product: Option<CreatePaymentsRequestBodyZeroPlanProduct>,
...
impl CreatePaymentsRequestBodyZeroPlan {
    pub fn builder() -> CreatePaymentsRequestBodyZeroPlanBuilder {
        <CreatePaymentsRequestBodyZeroPlanBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreatePaymentsRequestBodyZeroPlanBuilder {
    ...
    product: Option<CreatePaymentsRequestBodyZeroPlanProduct>,
...
impl CreatePaymentsRequestBodyZeroPlanBuilder {
    ...
    pub fn product(mut self, value: CreatePaymentsRequestBodyZeroPlanProduct) -> Self {
    ...
    /// Consumes the builder and constructs a [`CreatePaymentsRequestBodyZeroPlan`].
    /// This method will fail if any of the following fields are not set:
    /// - [`currency`](CreatePaymentsRequestBodyZeroPlanBuilder::currency)
    pub fn build(self) -> Result<CreatePaymentsRequestBodyZeroPlan, BuildError> {
        Ok(CreatePaymentsRequestBodyZeroPlan {
