...
pub struct PaymentLegacyDisputesItem {
...
impl PaymentLegacyDisputesItem {
    pub fn builder() -> PaymentLegacyDisputesItemBuilder {
        <PaymentLegacyDisputesItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PaymentLegacyDisputesItemBuilder {
    amount: Option<f64>,
...
impl PaymentLegacyDisputesItemBuilder {
    ...
    /// Consumes the builder and constructs a [`PaymentLegacyDisputesItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`amount`](PaymentLegacyDisputesItemBuilder::amount)
    /// - [`currency`](PaymentLegacyDisputesItemBuilder::currency)
    /// - [`id`](PaymentLegacyDisputesItemBuilder::id)
    /// - [`status`](PaymentLegacyDisputesItemBuilder::status)
    pub fn build(self) -> Result<PaymentLegacyDisputesItem, BuildError> {
        Ok(PaymentLegacyDisputesItem {
            amount: self
                .amount
