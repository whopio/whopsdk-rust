...
pub struct PostPayoutUpdatedPayloadDataFailure {
...
impl PostPayoutUpdatedPayloadDataFailure {
    pub fn builder() -> PostPayoutUpdatedPayloadDataFailureBuilder {
        <PostPayoutUpdatedPayloadDataFailureBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostPayoutUpdatedPayloadDataFailureBuilder {
    code: Option<String>,
    funds_returned_at: Option<DateTime<FixedOffset>>,
    message: Option<String>,
}

impl PostPayoutUpdatedPayloadDataFailureBuilder {
    ...
    /// Consumes the builder and constructs a [`PostPayoutUpdatedPayloadDataFailure`].
    pub fn build(self) -> Result<PostPayoutUpdatedPayloadDataFailure, BuildError> {
        Ok(PostPayoutUpdatedPayloadDataFailure {
            code: self.code,
