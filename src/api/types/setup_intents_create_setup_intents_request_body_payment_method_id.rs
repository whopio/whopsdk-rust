...
impl CreateSetupIntentsRequestBodyPaymentMethodId {
    pub fn builder() -> CreateSetupIntentsRequestBodyPaymentMethodIdBuilder {
        <CreateSetupIntentsRequestBodyPaymentMethodIdBuilder as Default>::default()
    }
}
