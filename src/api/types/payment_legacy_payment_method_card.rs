...
pub struct PaymentLegacyPaymentMethodCard {
...
impl PaymentLegacyPaymentMethodCard {
    pub fn builder() -> PaymentLegacyPaymentMethodCardBuilder {
        <PaymentLegacyPaymentMethodCardBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PaymentLegacyPaymentMethodCardBuilder {
...
impl PaymentLegacyPaymentMethodCardBuilder {
    ...
    /// Consumes the builder and constructs a [`PaymentLegacyPaymentMethodCard`].
    pub fn build(self) -> Result<PaymentLegacyPaymentMethodCard, BuildError> {
        Ok(PaymentLegacyPaymentMethodCard {
            brand: self.brand,
