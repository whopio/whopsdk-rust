...
pub enum PartnerRewardLinkRewardType {
    AdCredit,
    BalanceCredit,
...
impl Serialize for PartnerRewardLinkRewardType {
...
impl<'de> Deserialize<'de> for PartnerRewardLinkRewardType {
...
impl fmt::Display for PartnerRewardLinkRewardType {
