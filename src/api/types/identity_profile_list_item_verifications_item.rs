...
pub struct IdentityProfileListItemVerificationsItem {
...
impl IdentityProfileListItemVerificationsItem {
    pub fn builder() -> IdentityProfileListItemVerificationsItemBuilder {
        <IdentityProfileListItemVerificationsItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct IdentityProfileListItemVerificationsItemBuilder {
...
impl IdentityProfileListItemVerificationsItemBuilder {
    ...
    /// Consumes the builder and constructs a [`IdentityProfileListItemVerificationsItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`created_at`](IdentityProfileListItemVerificationsItemBuilder::created_at)
    /// - [`id`](IdentityProfileListItemVerificationsItemBuilder::id)
    /// - [`status`](IdentityProfileListItemVerificationsItemBuilder::status)
    pub fn build(self) -> Result<IdentityProfileListItemVerificationsItem, BuildError> {
        Ok(IdentityProfileListItemVerificationsItem {
            created_at: self
                .created_at
