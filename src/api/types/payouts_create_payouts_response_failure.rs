...
pub struct CreatePayoutsResponseFailure {
...
impl CreatePayoutsResponseFailure {
    pub fn builder() -> CreatePayoutsResponseFailureBuilder {
        <CreatePayoutsResponseFailureBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreatePayoutsResponseFailureBuilder {
    code: Option<String>,
    funds_returned_at: Option<DateTime<FixedOffset>>,
    message: Option<String>,
}

impl CreatePayoutsResponseFailureBuilder {
    ...
    /// Consumes the builder and constructs a [`CreatePayoutsResponseFailure`].
    pub fn build(self) -> Result<CreatePayoutsResponseFailure, BuildError> {
        Ok(CreatePayoutsResponseFailure {
            code: self.code,
