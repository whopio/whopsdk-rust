...
pub enum PostWithdrawalCreatedPayloadDataPayoutMethodSupportedPayoutMethodDeliveryType {
    CashPickup,
    BankDeposit,
    HomeDelivery,
    MobileWallet,
...
impl Serialize for PostWithdrawalCreatedPayloadDataPayoutMethodSupportedPayoutMethodDeliveryType {
...
impl<'de> Deserialize<'de>
    for PostWithdrawalCreatedPayloadDataPayoutMethodSupportedPayoutMethodDeliveryType
{
