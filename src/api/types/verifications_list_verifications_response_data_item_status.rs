...
pub enum ListVerificationsResponseDataItemStatus {
    NotStarted,
    Pending,
    Processing,
    ManualReview,
...
impl Serialize for ListVerificationsResponseDataItemStatus {
...
impl<'de> Deserialize<'de> for ListVerificationsResponseDataItemStatus {
...
impl fmt::Display for ListVerificationsResponseDataItemStatus {
