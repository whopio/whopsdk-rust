...
pub enum PostAdUpdatedPayloadDataCallToAction {
    LearnMore,
    ShopNow,
    SignUp,
    Subscribe,
...
impl Serialize for PostAdUpdatedPayloadDataCallToAction {
...
impl<'de> Deserialize<'de> for PostAdUpdatedPayloadDataCallToAction {
...
impl fmt::Display for PostAdUpdatedPayloadDataCallToAction {
