...
pub enum CreateAppsRequestAppType {
    B2BApp,
    B2CApp,
    CompanyApp,
    Component,
...
impl Serialize for CreateAppsRequestAppType {
...
impl<'de> Deserialize<'de> for CreateAppsRequestAppType {
...
impl fmt::Display for CreateAppsRequestAppType {
