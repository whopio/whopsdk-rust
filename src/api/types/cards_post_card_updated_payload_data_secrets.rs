...
pub struct PostCardUpdatedPayloadDataSecrets {
    /// Full card number.
    #[serde(default)]
...
impl PostCardUpdatedPayloadDataSecrets {
    pub fn builder() -> PostCardUpdatedPayloadDataSecretsBuilder {
        <PostCardUpdatedPayloadDataSecretsBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostCardUpdatedPayloadDataSecretsBuilder {
...
impl PostCardUpdatedPayloadDataSecretsBuilder {
    ...
    /// Consumes the builder and constructs a [`PostCardUpdatedPayloadDataSecrets`].
    /// This method will fail if any of the following fields are not set:
    /// - [`card_number`](PostCardUpdatedPayloadDataSecretsBuilder::card_number)
    /// - [`cvc`](PostCardUpdatedPayloadDataSecretsBuilder::cvc)
    pub fn build(self) -> Result<PostCardUpdatedPayloadDataSecrets, BuildError> {
        Ok(PostCardUpdatedPayloadDataSecrets {
            card_number: self
                .card_number
