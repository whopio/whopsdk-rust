...
pub enum UpdateCardsResponseStatus {
    Active,
    Frozen,
    Canceled,
    Invited,
...
impl Serialize for UpdateCardsResponseStatus {
...
impl<'de> Deserialize<'de> for UpdateCardsResponseStatus {
...
impl fmt::Display for UpdateCardsResponseStatus {
