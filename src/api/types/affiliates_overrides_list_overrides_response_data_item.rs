...
pub struct ListOverridesResponseDataItem {
...
impl ListOverridesResponseDataItem {
    pub fn builder() -> ListOverridesResponseDataItemBuilder {
        <ListOverridesResponseDataItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListOverridesResponseDataItemBuilder {
...
impl ListOverridesResponseDataItemBuilder {
    ...
    /// Consumes the builder and constructs a [`ListOverridesResponseDataItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`commission_type`](ListOverridesResponseDataItemBuilder::commission_type)
    /// - [`commission_value`](ListOverridesResponseDataItemBuilder::commission_value)
    /// - [`id`](ListOverridesResponseDataItemBuilder::id)
    /// - [`override_type`](ListOverridesResponseDataItemBuilder::override_type)
    /// - [`total_referral_earnings_usd`](ListOverridesResponseDataItemBuilder::total_referral_earnings_usd)
    pub fn build(self) -> Result<ListOverridesResponseDataItem, BuildError> {
        Ok(ListOverridesResponseDataItem {
