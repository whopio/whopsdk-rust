...
pub struct UpdateOverridesResponse {
...
impl UpdateOverridesResponse {
    pub fn builder() -> UpdateOverridesResponseBuilder {
        <UpdateOverridesResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct UpdateOverridesResponseBuilder {
...
impl UpdateOverridesResponseBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateOverridesResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`commission_type`](UpdateOverridesResponseBuilder::commission_type)
    /// - [`commission_value`](UpdateOverridesResponseBuilder::commission_value)
    /// - [`id`](UpdateOverridesResponseBuilder::id)
    /// - [`override_type`](UpdateOverridesResponseBuilder::override_type)
    /// - [`total_referral_earnings_usd`](UpdateOverridesResponseBuilder::total_referral_earnings_usd)
    pub fn build(self) -> Result<UpdateOverridesResponse, BuildError> {
        Ok(UpdateOverridesResponse {
