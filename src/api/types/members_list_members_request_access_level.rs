...
pub enum ListMembersRequestAccessLevel {
    NoAccess,
    Admin,
    Customer,
...
impl Serialize for ListMembersRequestAccessLevel {
...
impl<'de> Deserialize<'de> for ListMembersRequestAccessLevel {
...
impl fmt::Display for ListMembersRequestAccessLevel {
