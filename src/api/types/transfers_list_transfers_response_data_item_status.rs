...
pub enum ListTransfersResponseDataItemStatus {
    Processing,
    Succeeded,
    Failed,
...
impl Serialize for ListTransfersResponseDataItemStatus {
...
impl<'de> Deserialize<'de> for ListTransfersResponseDataItemStatus {
...
impl fmt::Display for ListTransfersResponseDataItemStatus {
