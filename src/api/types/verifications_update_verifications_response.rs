...
pub struct UpdateVerificationsResponse {
    /// Address on the verification profile. `null` when no address is set.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub address: Option<UpdateVerificationsResponseAddress>,
    /// Legal business name.
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub kind: Option<UpdateVerificationsResponseKind>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub requested_information: Option<Vec<UpdateVerificationsResponseRequestedInformationItem>>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub required_documents: Option<Vec<UpdateVerificationsResponseRequiredDocumentsItem>>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<UpdateVerificationsResponseStatus>,
    /// When the verification profile was last updated, as an ISO 8601 timestamp.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub updated_at: Option<String>,
}

impl UpdateVerificationsResponse {
    pub fn builder() -> UpdateVerificationsResponseBuilder {
        <UpdateVerificationsResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct UpdateVerificationsResponseBuilder {
    address: Option<UpdateVerificationsResponseAddress>,
    ...
    id: Option<String>,
    kind: Option<UpdateVerificationsResponseKind>,
    last_name: Option<String>,
    phone: Option<String>,
    requested_information: Option<Vec<UpdateVerificationsResponseRequestedInformationItem>>,
    required_documents: Option<Vec<UpdateVerificationsResponseRequiredDocumentsItem>>,
    session_url: Option<String>,
    status: Option<UpdateVerificationsResponseStatus>,
    updated_at: Option<String>,
}

impl UpdateVerificationsResponseBuilder {
    pub fn address(mut self, value: UpdateVerificationsResponseAddress) -> Self {
    ...
    pub fn kind(mut self, value: UpdateVerificationsResponseKind) -> Self {
    ...
    pub fn requested_information(
        mut self,
        value: Vec<UpdateVerificationsResponseRequestedInformationItem>,
    ) -> Self {
    ...
    pub fn required_documents(
        mut self,
        value: Vec<UpdateVerificationsResponseRequiredDocumentsItem>,
    ) -> Self {
    ...
    pub fn status(mut self, value: UpdateVerificationsResponseStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`UpdateVerificationsResponse`].
    pub fn build(self) -> Result<UpdateVerificationsResponse, BuildError> {
        Ok(UpdateVerificationsResponse {
