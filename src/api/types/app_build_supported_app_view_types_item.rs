...
pub enum AppBuildSupportedAppViewTypesItem {
    Hub,
    Discover,
    Dash,
    Dashboard,
...
impl Serialize for AppBuildSupportedAppViewTypesItem {
...
impl<'de> Deserialize<'de> for AppBuildSupportedAppViewTypesItem {
...
impl fmt::Display for AppBuildSupportedAppViewTypesItem {
