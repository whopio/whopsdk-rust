...
pub enum BountyListItemScheduledFrequency {
    Once,
    Hourly,
    Daily,
    Weekly,
...
impl Serialize for BountyListItemScheduledFrequency {
...
impl<'de> Deserialize<'de> for BountyListItemScheduledFrequency {
...
impl fmt::Display for BountyListItemScheduledFrequency {
