...
pub struct PostPayoutUpdatedPayloadData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub failure: Option<PostPayoutUpdatedPayloadDataFailure>,
    ...
    pub fee_paid_by: PostPayoutUpdatedPayloadDataFeePaidBy,
    ...
    pub object: PostPayoutUpdatedPayloadDataObject,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub payout_method: Option<PostPayoutUpdatedPayloadDataPayoutMethod>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub source: Option<PostPayoutUpdatedPayloadDataSource>,
    /// Payout delivery speed.
    pub speed: PostPayoutUpdatedPayloadDataSpeed,
    ...
    pub status: PostPayoutUpdatedPayloadDataStatus,
...
impl PostPayoutUpdatedPayloadData {
    pub fn builder() -> PostPayoutUpdatedPayloadDataBuilder {
        <PostPayoutUpdatedPayloadDataBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostPayoutUpdatedPayloadDataBuilder {
    ...
    failure: Option<PostPayoutUpdatedPayloadDataFailure>,
    fee_amount: Option<String>,
    fee_paid_by: Option<PostPayoutUpdatedPayloadDataFeePaidBy>,
    id: Option<String>,
    markup_fee: Option<String>,
    metadata: Option<HashMap<String, String>>,
    net_amount: Option<String>,
    notes: Option<String>,
    object: Option<PostPayoutUpdatedPayloadDataObject>,
    payer_name: Option<String>,
    payout_method: Option<PostPayoutUpdatedPayloadDataPayoutMethod>,
    payout_request_id: Option<String>,
    source: Option<PostPayoutUpdatedPayloadDataSource>,
    speed: Option<PostPayoutUpdatedPayloadDataSpeed>,
    statement_descriptor: Option<String>,
    status: Option<PostPayoutUpdatedPayloadDataStatus>,
    status_detail: Option<String>,
    trace_code: Option<String>,
}

impl PostPayoutUpdatedPayloadDataBuilder {
    ...
    pub fn failure(mut self, value: PostPayoutUpdatedPayloadDataFailure) -> Self {
    ...
    pub fn fee_paid_by(mut self, value: PostPayoutUpdatedPayloadDataFeePaidBy) -> Self {
    ...
    pub fn object(mut self, value: PostPayoutUpdatedPayloadDataObject) -> Self {
    ...
    pub fn payout_method(mut self, value: PostPayoutUpdatedPayloadDataPayoutMethod) -> Self {
    ...
    pub fn source(mut self, value: PostPayoutUpdatedPayloadDataSource) -> Self {
        self.source = Some(value);
        self
    }

    pub fn speed(mut self, value: PostPayoutUpdatedPayloadDataSpeed) -> Self {
    ...
    pub fn status(mut self, value: PostPayoutUpdatedPayloadDataStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostPayoutUpdatedPayloadData`].
    /// This method will fail if any of the following fields are not set:
    /// - [`amount`](PostPayoutUpdatedPayloadDataBuilder::amount)
    /// - [`created_at`](PostPayoutUpdatedPayloadDataBuilder::created_at)
    /// - [`currency`](PostPayoutUpdatedPayloadDataBuilder::currency)
    /// - [`fee_amount`](PostPayoutUpdatedPayloadDataBuilder::fee_amount)
    /// - [`fee_paid_by`](PostPayoutUpdatedPayloadDataBuilder::fee_paid_by)
    /// - [`id`](PostPayoutUpdatedPayloadDataBuilder::id)
    /// - [`markup_fee`](PostPayoutUpdatedPayloadDataBuilder::markup_fee)
    /// - [`metadata`](PostPayoutUpdatedPayloadDataBuilder::metadata)
    /// - [`net_amount`](PostPayoutUpdatedPayloadDataBuilder::net_amount)
    /// - [`object`](PostPayoutUpdatedPayloadDataBuilder::object)
    /// - [`speed`](PostPayoutUpdatedPayloadDataBuilder::speed)
    /// - [`status`](PostPayoutUpdatedPayloadDataBuilder::status)
    /// - [`status_detail`](PostPayoutUpdatedPayloadDataBuilder::status_detail)
    pub fn build(self) -> Result<PostPayoutUpdatedPayloadData, BuildError> {
        Ok(PostPayoutUpdatedPayloadData {
            amount: self
                .amount
