...
pub struct PostCardFrozenPayloadDataSecrets {
    /// Full card number.
    #[serde(default)]
...
impl PostCardFrozenPayloadDataSecrets {
    pub fn builder() -> PostCardFrozenPayloadDataSecretsBuilder {
        <PostCardFrozenPayloadDataSecretsBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostCardFrozenPayloadDataSecretsBuilder {
...
impl PostCardFrozenPayloadDataSecretsBuilder {
    ...
    /// Consumes the builder and constructs a [`PostCardFrozenPayloadDataSecrets`].
    /// This method will fail if any of the following fields are not set:
    /// - [`card_number`](PostCardFrozenPayloadDataSecretsBuilder::card_number)
    /// - [`cvc`](PostCardFrozenPayloadDataSecretsBuilder::cvc)
    pub fn build(self) -> Result<PostCardFrozenPayloadDataSecrets, BuildError> {
        Ok(PostCardFrozenPayloadDataSecrets {
            card_number: self
                .card_number
