...
pub struct PaymentLegacyApplicationFee {
...
impl PaymentLegacyApplicationFee {
    pub fn builder() -> PaymentLegacyApplicationFeeBuilder {
        <PaymentLegacyApplicationFeeBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PaymentLegacyApplicationFeeBuilder {
    amount: Option<f64>,
...
impl PaymentLegacyApplicationFeeBuilder {
    ...
    /// Consumes the builder and constructs a [`PaymentLegacyApplicationFee`].
    /// This method will fail if any of the following fields are not set:
    /// - [`amount`](PaymentLegacyApplicationFeeBuilder::amount)
    /// - [`amount_captured`](PaymentLegacyApplicationFeeBuilder::amount_captured)
    /// - [`amount_refunded`](PaymentLegacyApplicationFeeBuilder::amount_refunded)
    /// - [`created_at`](PaymentLegacyApplicationFeeBuilder::created_at)
    /// - [`currency`](PaymentLegacyApplicationFeeBuilder::currency)
    /// - [`id`](PaymentLegacyApplicationFeeBuilder::id)
    pub fn build(self) -> Result<PaymentLegacyApplicationFee, BuildError> {
        Ok(PaymentLegacyApplicationFee {
            amount: self
                .amount
