...
pub enum CreatePaymentsRequestPlanPlanType {
    Renewal,
    OneTime,
...
impl Serialize for CreatePaymentsRequestPlanPlanType {
...
impl<'de> Deserialize<'de> for CreatePaymentsRequestPlanPlanType {
...
impl fmt::Display for CreatePaymentsRequestPlanPlanType {
