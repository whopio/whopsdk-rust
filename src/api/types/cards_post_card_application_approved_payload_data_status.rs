...
pub enum PostCardApplicationApprovedPayloadDataStatus {
    Approved,
    Pending,
    ManualReview,
    Denied,
...
impl Serialize for PostCardApplicationApprovedPayloadDataStatus {
...
impl<'de> Deserialize<'de> for PostCardApplicationApprovedPayloadDataStatus {
...
impl fmt::Display for PostCardApplicationApprovedPayloadDataStatus {
