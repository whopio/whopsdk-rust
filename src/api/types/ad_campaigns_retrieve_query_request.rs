...
pub struct AdCampaignsRetrieveQueryRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub attribution_model: Option<RetrieveAdCampaignsRequestAttributionModel>,
}

impl AdCampaignsRetrieveQueryRequest {
    pub fn builder() -> AdCampaignsRetrieveQueryRequestBuilder {
        <AdCampaignsRetrieveQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct AdCampaignsRetrieveQueryRequestBuilder {
...
impl AdCampaignsRetrieveQueryRequestBuilder {
    ...
    pub fn attribution_model(mut self, value: RetrieveAdCampaignsRequestAttributionModel) -> Self {
        self.attribution_model = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`AdCampaignsRetrieveQueryRequest`].
    pub fn build(self) -> Result<AdCampaignsRetrieveQueryRequest, BuildError> {
        Ok(AdCampaignsRetrieveQueryRequest {
