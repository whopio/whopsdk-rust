...
pub enum PostTransferCompletedPayloadDataStatus {
    Processing,
    Succeeded,
    Failed,
...
impl Serialize for PostTransferCompletedPayloadDataStatus {
...
impl<'de> Deserialize<'de> for PostTransferCompletedPayloadDataStatus {
...
impl fmt::Display for PostTransferCompletedPayloadDataStatus {
