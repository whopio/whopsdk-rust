...
pub enum CreateTransfersResponseTransferStatus {
    Processing,
    Succeeded,
    Failed,
...
impl Serialize for CreateTransfersResponseTransferStatus {
...
impl<'de> Deserialize<'de> for CreateTransfersResponseTransferStatus {
...
impl fmt::Display for CreateTransfersResponseTransferStatus {
