...
pub struct CreateInvoicesRequestBodyProduct {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub billing_address: Option<CreateInvoicesRequestBodyProductBillingAddress>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub line_items: Option<Vec<CreateInvoicesRequestBodyProductLineItemsItem>>,
...
impl CreateInvoicesRequestBodyProduct {
    pub fn builder() -> CreateInvoicesRequestBodyProductBuilder {
        <CreateInvoicesRequestBodyProductBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateInvoicesRequestBodyProductBuilder {
    automatically_finalizes_at: Option<DateTime<FixedOffset>>,
    billing_address: Option<CreateInvoicesRequestBodyProductBillingAddress>,
    ...
    line_items: Option<Vec<CreateInvoicesRequestBodyProductLineItemsItem>>,
    mailing_address_id: Option<String>,
    member_id: Option<String>,
    payment_method_id: Option<String>,
    payment_token_id: Option<String>,
    plan: Option<CreateInvoicesRequestBodyProductPlan>,
    product: Option<CreateInvoicesRequestBodyProductProduct>,
    save_as_draft: Option<bool>,
    subscription_billing_anchor_at: Option<DateTime<FixedOffset>>,
}

impl CreateInvoicesRequestBodyProductBuilder {
    ...
    pub fn billing_address(
        mut self,
        value: CreateInvoicesRequestBodyProductBillingAddress,
    ) -> Self {
    ...
    pub fn line_items(mut self, value: Vec<CreateInvoicesRequestBodyProductLineItemsItem>) -> Self {
    ...
    pub fn plan(mut self, value: CreateInvoicesRequestBodyProductPlan) -> Self {
        self.plan = Some(value);
        self
    }

    pub fn product(mut self, value: CreateInvoicesRequestBodyProductProduct) -> Self {
    ...
    /// Consumes the builder and constructs a [`CreateInvoicesRequestBodyProduct`].
    /// This method will fail if any of the following fields are not set:
    /// - [`collection_method`](CreateInvoicesRequestBodyProductBuilder::collection_method)
    /// - [`company_id`](CreateInvoicesRequestBodyProductBuilder::company_id)
    /// - [`plan`](CreateInvoicesRequestBodyProductBuilder::plan)
    /// - [`product`](CreateInvoicesRequestBodyProductBuilder::product)
    pub fn build(self) -> Result<CreateInvoicesRequestBodyProduct, BuildError> {
        Ok(CreateInvoicesRequestBodyProduct {
