...
pub enum ListAdGroupsRequestStatus {
    Active,
    Paused,
    Rejected,
    Duplicating,
...
impl Serialize for ListAdGroupsRequestStatus {
...
impl<'de> Deserialize<'de> for ListAdGroupsRequestStatus {
...
impl fmt::Display for ListAdGroupsRequestStatus {
