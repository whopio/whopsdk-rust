...
pub enum PostPayoutReversedPayloadDataPayoutMethodSupportedPayoutMethodDeliveryType {
    CashPickup,
    BankDeposit,
    HomeDelivery,
    MobileWallet,
...
impl Serialize for PostPayoutReversedPayloadDataPayoutMethodSupportedPayoutMethodDeliveryType {
...
impl<'de> Deserialize<'de>
    for PostPayoutReversedPayloadDataPayoutMethodSupportedPayoutMethodDeliveryType
{
...
impl fmt::Display for PostPayoutReversedPayloadDataPayoutMethodSupportedPayoutMethodDeliveryType {
