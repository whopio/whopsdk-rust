...
pub enum CreateMethodsResponseBankVerificationState {
    Checking,
    Verified,
    NoData,
    Warning,
...
impl Serialize for CreateMethodsResponseBankVerificationState {
...
impl<'de> Deserialize<'de> for CreateMethodsResponseBankVerificationState {
...
impl fmt::Display for CreateMethodsResponseBankVerificationState {
