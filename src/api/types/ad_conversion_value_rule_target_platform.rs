...
pub enum AdConversionValueRuleTargetPlatform {
    Tiktok,
    Meta,
    Google,
...
impl Serialize for AdConversionValueRuleTargetPlatform {
...
impl<'de> Deserialize<'de> for AdConversionValueRuleTargetPlatform {
...
impl fmt::Display for AdConversionValueRuleTargetPlatform {
