...
pub struct IdentityProfileVerificationsItem {
...
impl IdentityProfileVerificationsItem {
    pub fn builder() -> IdentityProfileVerificationsItemBuilder {
        <IdentityProfileVerificationsItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct IdentityProfileVerificationsItemBuilder {
...
impl IdentityProfileVerificationsItemBuilder {
    ...
    /// Consumes the builder and constructs a [`IdentityProfileVerificationsItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`created_at`](IdentityProfileVerificationsItemBuilder::created_at)
    /// - [`id`](IdentityProfileVerificationsItemBuilder::id)
    /// - [`status`](IdentityProfileVerificationsItemBuilder::status)
    pub fn build(self) -> Result<IdentityProfileVerificationsItem, BuildError> {
        Ok(IdentityProfileVerificationsItem {
            created_at: self
                .created_at
