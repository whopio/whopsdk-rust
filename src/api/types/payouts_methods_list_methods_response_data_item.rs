...
pub struct ListMethodsResponseDataItem {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub bank_verification_state: Option<ListMethodsResponseDataItemBankVerificationState>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub estimated_arrival: Option<ListMethodsResponseDataItemEstimatedArrival>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub fee_structure: Option<ListMethodsResponseDataItemFeeStructure>,
    /// Payout method ID.
    #[serde(default)]
    pub id: String,
    ...
    pub object: ListMethodsResponseDataItemObject,
    ...
    pub status: ListMethodsResponseDataItemStatus,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub supported_payout_method: Option<ListMethodsResponseDataItemSupportedPayoutMethod>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub unavailable_reason: Option<ListMethodsResponseDataItemUnavailableReason>,
}

impl ListMethodsResponseDataItem {
    pub fn builder() -> ListMethodsResponseDataItemBuilder {
        <ListMethodsResponseDataItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListMethodsResponseDataItemBuilder {
    account_reference: Option<String>,
    bank_verification_state: Option<ListMethodsResponseDataItemBankVerificationState>,
    created_at: Option<DateTime<FixedOffset>>,
    destination_currency: Option<String>,
    estimated_arrival: Option<ListMethodsResponseDataItemEstimatedArrival>,
    fee_structure: Option<ListMethodsResponseDataItemFeeStructure>,
    id: Option<String>,
    ...
    object: Option<ListMethodsResponseDataItemObject>,
    payer_name: Option<String>,
    quote: Option<ListMethodsResponseDataItemQuote>,
    status: Option<ListMethodsResponseDataItemStatus>,
    status_reason: Option<String>,
    supported_payout_method: Option<ListMethodsResponseDataItemSupportedPayoutMethod>,
    unavailable_reason: Option<ListMethodsResponseDataItemUnavailableReason>,
}

impl ListMethodsResponseDataItemBuilder {
    ...
    pub fn bank_verification_state(
        mut self,
        value: ListMethodsResponseDataItemBankVerificationState,
    ) -> Self {
    ...
    pub fn estimated_arrival(mut self, value: ListMethodsResponseDataItemEstimatedArrival) -> Self {
        self.estimated_arrival = Some(value);
        self
    }

    pub fn fee_structure(mut self, value: ListMethodsResponseDataItemFeeStructure) -> Self {
    ...
    pub fn object(mut self, value: ListMethodsResponseDataItemObject) -> Self {
    ...
    pub fn quote(mut self, value: ListMethodsResponseDataItemQuote) -> Self {
        self.quote = Some(value);
        self
    }

    pub fn status(mut self, value: ListMethodsResponseDataItemStatus) -> Self {
    ...
    pub fn supported_payout_method(
        mut self,
        value: ListMethodsResponseDataItemSupportedPayoutMethod,
    ) -> Self {
    ...
    pub fn unavailable_reason(
        mut self,
        value: ListMethodsResponseDataItemUnavailableReason,
    ) -> Self {
        self.unavailable_reason = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`ListMethodsResponseDataItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`created_at`](ListMethodsResponseDataItemBuilder::created_at)
    /// - [`destination_currency`](ListMethodsResponseDataItemBuilder::destination_currency)
    /// - [`id`](ListMethodsResponseDataItemBuilder::id)
    /// - [`is_clone`](ListMethodsResponseDataItemBuilder::is_clone)
    /// - [`is_default`](ListMethodsResponseDataItemBuilder::is_default)
    /// - [`linked_via_plaid`](ListMethodsResponseDataItemBuilder::linked_via_plaid)
    /// - [`needs_plaid_reconnect`](ListMethodsResponseDataItemBuilder::needs_plaid_reconnect)
    /// - [`object`](ListMethodsResponseDataItemBuilder::object)
    /// - [`status`](ListMethodsResponseDataItemBuilder::status)
    pub fn build(self) -> Result<ListMethodsResponseDataItem, BuildError> {
        Ok(ListMethodsResponseDataItem {
