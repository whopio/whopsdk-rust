...
pub struct PostPayoutCreatedPayloadData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub failure: Option<PostPayoutCreatedPayloadDataFailure>,
    ...
    pub fee_paid_by: PostPayoutCreatedPayloadDataFeePaidBy,
    ...
    pub object: PostPayoutCreatedPayloadDataObject,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub payout_method: Option<PostPayoutCreatedPayloadDataPayoutMethod>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub source: Option<PostPayoutCreatedPayloadDataSource>,
    /// Payout delivery speed.
    pub speed: PostPayoutCreatedPayloadDataSpeed,
    ...
    pub status: PostPayoutCreatedPayloadDataStatus,
...
impl PostPayoutCreatedPayloadData {
    pub fn builder() -> PostPayoutCreatedPayloadDataBuilder {
        <PostPayoutCreatedPayloadDataBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostPayoutCreatedPayloadDataBuilder {
    ...
    failure: Option<PostPayoutCreatedPayloadDataFailure>,
    fee_amount: Option<String>,
    fee_paid_by: Option<PostPayoutCreatedPayloadDataFeePaidBy>,
    id: Option<String>,
    markup_fee: Option<String>,
    metadata: Option<HashMap<String, String>>,
    net_amount: Option<String>,
    notes: Option<String>,
    object: Option<PostPayoutCreatedPayloadDataObject>,
    payer_name: Option<String>,
    payout_method: Option<PostPayoutCreatedPayloadDataPayoutMethod>,
    payout_request_id: Option<String>,
    source: Option<PostPayoutCreatedPayloadDataSource>,
    speed: Option<PostPayoutCreatedPayloadDataSpeed>,
    statement_descriptor: Option<String>,
    status: Option<PostPayoutCreatedPayloadDataStatus>,
    status_detail: Option<String>,
    trace_code: Option<String>,
}

impl PostPayoutCreatedPayloadDataBuilder {
    ...
    pub fn failure(mut self, value: PostPayoutCreatedPayloadDataFailure) -> Self {
    ...
    pub fn fee_paid_by(mut self, value: PostPayoutCreatedPayloadDataFeePaidBy) -> Self {
    ...
    pub fn object(mut self, value: PostPayoutCreatedPayloadDataObject) -> Self {
    ...
    pub fn payout_method(mut self, value: PostPayoutCreatedPayloadDataPayoutMethod) -> Self {
    ...
    pub fn source(mut self, value: PostPayoutCreatedPayloadDataSource) -> Self {
        self.source = Some(value);
        self
    }

    pub fn speed(mut self, value: PostPayoutCreatedPayloadDataSpeed) -> Self {
    ...
    pub fn status(mut self, value: PostPayoutCreatedPayloadDataStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostPayoutCreatedPayloadData`].
    /// This method will fail if any of the following fields are not set:
    /// - [`amount`](PostPayoutCreatedPayloadDataBuilder::amount)
    /// - [`created_at`](PostPayoutCreatedPayloadDataBuilder::created_at)
    /// - [`currency`](PostPayoutCreatedPayloadDataBuilder::currency)
    /// - [`fee_amount`](PostPayoutCreatedPayloadDataBuilder::fee_amount)
    /// - [`fee_paid_by`](PostPayoutCreatedPayloadDataBuilder::fee_paid_by)
    /// - [`id`](PostPayoutCreatedPayloadDataBuilder::id)
    /// - [`markup_fee`](PostPayoutCreatedPayloadDataBuilder::markup_fee)
    /// - [`metadata`](PostPayoutCreatedPayloadDataBuilder::metadata)
    /// - [`net_amount`](PostPayoutCreatedPayloadDataBuilder::net_amount)
    /// - [`object`](PostPayoutCreatedPayloadDataBuilder::object)
    /// - [`speed`](PostPayoutCreatedPayloadDataBuilder::speed)
    /// - [`status`](PostPayoutCreatedPayloadDataBuilder::status)
    /// - [`status_detail`](PostPayoutCreatedPayloadDataBuilder::status_detail)
    pub fn build(self) -> Result<PostPayoutCreatedPayloadData, BuildError> {
        Ok(PostPayoutCreatedPayloadData {
            amount: self
                .amount
