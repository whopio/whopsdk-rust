...
impl VerificationListItem {
    pub fn builder() -> VerificationListItemBuilder {
        <VerificationListItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct VerificationListItemBuilder {
    id: Option<String>,
...
impl VerificationListItemBuilder {
    ...
    /// Consumes the builder and constructs a [`VerificationListItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](VerificationListItemBuilder::id)
    /// - [`status`](VerificationListItemBuilder::status)
    pub fn build(self) -> Result<VerificationListItem, BuildError> {
        Ok(VerificationListItem {
