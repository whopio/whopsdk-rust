...
pub struct RetrievePaymentsResponse {
    #[serde(flatten)]
...
impl RetrievePaymentsResponse {
    pub fn builder() -> RetrievePaymentsResponseBuilder {
        <RetrievePaymentsResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct RetrievePaymentsResponseBuilder {
    payment_fields: Option<Payment>,
    client_secret: Option<String>,
}

impl RetrievePaymentsResponseBuilder {
    ...
    /// Consumes the builder and constructs a [`RetrievePaymentsResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`payment_fields`](RetrievePaymentsResponseBuilder::payment_fields)
    pub fn build(self) -> Result<RetrievePaymentsResponse, BuildError> {
        Ok(RetrievePaymentsResponse {
            payment_fields: self
                .payment_fields
