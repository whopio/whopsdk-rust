...
pub struct CreateInvoicesRequestProductIdPlan {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub custom_fields: Option<Vec<CreateInvoicesRequestProductIdPlanCustomFieldsItem>>,
    ...
    pub payment_method_configuration:
        Option<CreateInvoicesRequestProductIdPlanPaymentMethodConfiguration>,
...
impl CreateInvoicesRequestProductIdPlan {
    pub fn builder() -> CreateInvoicesRequestProductIdPlanBuilder {
        <CreateInvoicesRequestProductIdPlanBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateInvoicesRequestProductIdPlanBuilder {
    adaptive_pricing_enabled: Option<bool>,
    billing_period: Option<i64>,
    currency: Option<Currencies>,
    custom_fields: Option<Vec<CreateInvoicesRequestProductIdPlanCustomFieldsItem>>,
...
impl CreateInvoicesRequestProductIdPlanBuilder {
    ...
    pub fn custom_fields(
        mut self,
        value: Vec<CreateInvoicesRequestProductIdPlanCustomFieldsItem>,
    ) -> Self {
    ...
    pub fn payment_method_configuration(
        mut self,
        value: CreateInvoicesRequestProductIdPlanPaymentMethodConfiguration,
    ) -> Self {
    ...
    /// Consumes the builder and constructs a [`CreateInvoicesRequestProductIdPlan`].
    pub fn build(self) -> Result<CreateInvoicesRequestProductIdPlan, BuildError> {
        Ok(CreateInvoicesRequestProductIdPlan {
