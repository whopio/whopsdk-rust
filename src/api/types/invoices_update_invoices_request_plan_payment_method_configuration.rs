...
pub struct UpdateInvoicesRequestPlanPaymentMethodConfiguration {
...
impl UpdateInvoicesRequestPlanPaymentMethodConfiguration {
    pub fn builder() -> UpdateInvoicesRequestPlanPaymentMethodConfigurationBuilder {
        <UpdateInvoicesRequestPlanPaymentMethodConfigurationBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct UpdateInvoicesRequestPlanPaymentMethodConfigurationBuilder {
    disabled: Option<Vec<PaymentMethodTypes>>,
    enabled: Option<Vec<PaymentMethodTypes>>,
    include_platform_defaults: Option<bool>,
}

impl UpdateInvoicesRequestPlanPaymentMethodConfigurationBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateInvoicesRequestPlanPaymentMethodConfiguration`].
    /// This method will fail if any of the following fields are not set:
    /// - [`disabled`](UpdateInvoicesRequestPlanPaymentMethodConfigurationBuilder::disabled)
    /// - [`enabled`](UpdateInvoicesRequestPlanPaymentMethodConfigurationBuilder::enabled)
    pub fn build(self) -> Result<UpdateInvoicesRequestPlanPaymentMethodConfiguration, BuildError> {
        Ok(UpdateInvoicesRequestPlanPaymentMethodConfiguration {
            disabled: self
                .disabled
