...
pub struct Review {
    ...
    #[serde(default)]
    pub attachments: Vec<ReviewAttachmentsItem>,
    /// The company that this review was written for.
    #[serde(default)]
    pub company: ReviewCompany,
...
impl Review {
    pub fn builder() -> ReviewBuilder {
        <ReviewBuilder as Default>::default()
    }
}
...
pub struct ReviewBuilder {
    attachments: Option<Vec<ReviewAttachmentsItem>>,
    company: Option<ReviewCompany>,
...
impl ReviewBuilder {
    pub fn attachments(mut self, value: Vec<ReviewAttachmentsItem>) -> Self {
        self.attachments = Some(value);
        self
    }

    pub fn company(mut self, value: ReviewCompany) -> Self {
    ...
    pub fn product(mut self, value: ReviewProduct) -> Self {
    ...
    pub fn user(mut self, value: ReviewUser) -> Self {
        self.user = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`Review`].
    /// This method will fail if any of the following fields are not set:
    /// - [`attachments`](ReviewBuilder::attachments)
    /// - [`company`](ReviewBuilder::company)
    /// - [`created_at`](ReviewBuilder::created_at)
    /// - [`id`](ReviewBuilder::id)
    /// - [`product`](ReviewBuilder::product)
    /// - [`stars`](ReviewBuilder::stars)
    /// - [`status`](ReviewBuilder::status)
    /// - [`updated_at`](ReviewBuilder::updated_at)
    /// - [`user`](ReviewBuilder::user)
    pub fn build(self) -> Result<Review, BuildError> {
        Ok(Review {
            attachments: self
                .attachments
