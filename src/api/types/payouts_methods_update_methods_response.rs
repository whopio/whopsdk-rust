...
pub struct UpdateMethodsResponse {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub bank_verification_state: Option<UpdateMethodsResponseBankVerificationState>,
    #[serde(default)]
    ...
    pub object: UpdateMethodsResponseObject,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    pub status: UpdateMethodsResponseStatus,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub supported_payout_method: Option<UpdateMethodsResponseSupportedPayoutMethod>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub unavailable_reason: Option<UpdateMethodsResponseUnavailableReason>,
}

impl UpdateMethodsResponse {
    pub fn builder() -> UpdateMethodsResponseBuilder {
        <UpdateMethodsResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct UpdateMethodsResponseBuilder {
    account_reference: Option<String>,
    bank_verification_state: Option<UpdateMethodsResponseBankVerificationState>,
    ...
    object: Option<UpdateMethodsResponseObject>,
    payer_name: Option<String>,
    quote: Option<HashMap<String, serde_json::Value>>,
    status: Option<UpdateMethodsResponseStatus>,
    status_reason: Option<String>,
    supported_payout_method: Option<UpdateMethodsResponseSupportedPayoutMethod>,
    unavailable_reason: Option<UpdateMethodsResponseUnavailableReason>,
}

impl UpdateMethodsResponseBuilder {
    ...
    pub fn bank_verification_state(
        mut self,
        value: UpdateMethodsResponseBankVerificationState,
    ) -> Self {
    ...
    pub fn object(mut self, value: UpdateMethodsResponseObject) -> Self {
    ...
    pub fn status(mut self, value: UpdateMethodsResponseStatus) -> Self {
    ...
    pub fn supported_payout_method(
        mut self,
        value: UpdateMethodsResponseSupportedPayoutMethod,
    ) -> Self {
        self.supported_payout_method = Some(value);
        self
    }

    pub fn unavailable_reason(mut self, value: UpdateMethodsResponseUnavailableReason) -> Self {
        self.unavailable_reason = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`UpdateMethodsResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`created_at`](UpdateMethodsResponseBuilder::created_at)
    /// - [`destination_currency`](UpdateMethodsResponseBuilder::destination_currency)
    /// - [`id`](UpdateMethodsResponseBuilder::id)
    /// - [`is_clone`](UpdateMethodsResponseBuilder::is_clone)
    /// - [`is_default`](UpdateMethodsResponseBuilder::is_default)
    /// - [`linked_via_plaid`](UpdateMethodsResponseBuilder::linked_via_plaid)
    /// - [`needs_plaid_reconnect`](UpdateMethodsResponseBuilder::needs_plaid_reconnect)
    /// - [`object`](UpdateMethodsResponseBuilder::object)
    /// - [`status`](UpdateMethodsResponseBuilder::status)
    pub fn build(self) -> Result<UpdateMethodsResponse, BuildError> {
        Ok(UpdateMethodsResponse {
