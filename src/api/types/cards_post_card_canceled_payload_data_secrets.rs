...
pub struct PostCardCanceledPayloadDataSecrets {
    /// Full card number.
    #[serde(default)]
...
impl PostCardCanceledPayloadDataSecrets {
    pub fn builder() -> PostCardCanceledPayloadDataSecretsBuilder {
        <PostCardCanceledPayloadDataSecretsBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostCardCanceledPayloadDataSecretsBuilder {
...
impl PostCardCanceledPayloadDataSecretsBuilder {
    ...
    /// Consumes the builder and constructs a [`PostCardCanceledPayloadDataSecrets`].
    /// This method will fail if any of the following fields are not set:
    /// - [`card_number`](PostCardCanceledPayloadDataSecretsBuilder::card_number)
    /// - [`cvc`](PostCardCanceledPayloadDataSecretsBuilder::cvc)
    pub fn build(self) -> Result<PostCardCanceledPayloadDataSecrets, BuildError> {
        Ok(PostCardCanceledPayloadDataSecrets {
            card_number: self
                .card_number
