...
pub struct ListBusinessesResponseDataItemPayoutPercentages {
...
impl ListBusinessesResponseDataItemPayoutPercentages {
    pub fn builder() -> ListBusinessesResponseDataItemPayoutPercentagesBuilder {
        <ListBusinessesResponseDataItemPayoutPercentagesBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListBusinessesResponseDataItemPayoutPercentagesBuilder {
    ad_spend: Option<f64>,
...
impl ListBusinessesResponseDataItemPayoutPercentagesBuilder {
    ...
    /// Consumes the builder and constructs a [`ListBusinessesResponseDataItemPayoutPercentages`].
    /// This method will fail if any of the following fields are not set:
    /// - [`sales`](ListBusinessesResponseDataItemPayoutPercentagesBuilder::sales)
    pub fn build(self) -> Result<ListBusinessesResponseDataItemPayoutPercentages, BuildError> {
        Ok(ListBusinessesResponseDataItemPayoutPercentages {
