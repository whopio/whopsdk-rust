...
pub struct PaymentLegacyPaymentInstrument {
    /// Card payments only: the card's network and last four.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub card: Option<PaymentLegacyPaymentInstrumentCard>,
    ...
    #[serde(default)]
    pub icons: PaymentLegacyPaymentInstrumentIcons,
...
impl PaymentLegacyPaymentInstrument {
    pub fn builder() -> PaymentLegacyPaymentInstrumentBuilder {
        <PaymentLegacyPaymentInstrumentBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PaymentLegacyPaymentInstrumentBuilder {
    card: Option<PaymentLegacyPaymentInstrumentCard>,
    display_name: Option<String>,
    icons: Option<PaymentLegacyPaymentInstrumentIcons>,
    installment_count: Option<i64>,
    payment_method_type: Option<String>,
}

impl PaymentLegacyPaymentInstrumentBuilder {
    pub fn card(mut self, value: PaymentLegacyPaymentInstrumentCard) -> Self {
    ...
    pub fn icons(mut self, value: PaymentLegacyPaymentInstrumentIcons) -> Self {
    ...
    /// Consumes the builder and constructs a [`PaymentLegacyPaymentInstrument`].
    /// This method will fail if any of the following fields are not set:
    /// - [`display_name`](PaymentLegacyPaymentInstrumentBuilder::display_name)
    /// - [`icons`](PaymentLegacyPaymentInstrumentBuilder::icons)
    /// - [`payment_method_type`](PaymentLegacyPaymentInstrumentBuilder::payment_method_type)
    pub fn build(self) -> Result<PaymentLegacyPaymentInstrument, BuildError> {
        Ok(PaymentLegacyPaymentInstrument {
            card: self.card,
            display_name: self
                .display_name
