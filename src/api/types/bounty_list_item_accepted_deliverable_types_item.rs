...
pub enum BountyListItemAcceptedDeliverableTypesItem {
    ContentUrl,
    Media,
    DataCapture,
...
impl Serialize for BountyListItemAcceptedDeliverableTypesItem {
...
impl<'de> Deserialize<'de> for BountyListItemAcceptedDeliverableTypesItem {
...
impl fmt::Display for BountyListItemAcceptedDeliverableTypesItem {
