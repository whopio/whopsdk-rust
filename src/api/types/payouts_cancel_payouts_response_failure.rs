...
pub struct CancelPayoutsResponseFailure {
...
impl CancelPayoutsResponseFailure {
    pub fn builder() -> CancelPayoutsResponseFailureBuilder {
        <CancelPayoutsResponseFailureBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CancelPayoutsResponseFailureBuilder {
    code: Option<String>,
    funds_returned_at: Option<DateTime<FixedOffset>>,
    message: Option<String>,
}

impl CancelPayoutsResponseFailureBuilder {
    ...
    /// Consumes the builder and constructs a [`CancelPayoutsResponseFailure`].
    pub fn build(self) -> Result<CancelPayoutsResponseFailure, BuildError> {
        Ok(CancelPayoutsResponseFailure {
            code: self.code,
