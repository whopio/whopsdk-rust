...
pub struct PostWithdrawalUpdatedPayloadData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub failure: Option<PostWithdrawalUpdatedPayloadDataFailure>,
    ...
    pub fee_paid_by: PostWithdrawalUpdatedPayloadDataFeePaidBy,
    ...
    pub object: PostWithdrawalUpdatedPayloadDataObject,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub payout_method: Option<PostWithdrawalUpdatedPayloadDataPayoutMethod>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub source: Option<PostWithdrawalUpdatedPayloadDataSource>,
    /// Payout delivery speed.
    pub speed: PostWithdrawalUpdatedPayloadDataSpeed,
    /// Current payout status.
    pub status: PostWithdrawalUpdatedPayloadDataStatus,
...
impl PostWithdrawalUpdatedPayloadData {
    pub fn builder() -> PostWithdrawalUpdatedPayloadDataBuilder {
        <PostWithdrawalUpdatedPayloadDataBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostWithdrawalUpdatedPayloadDataBuilder {
    ...
    failure: Option<PostWithdrawalUpdatedPayloadDataFailure>,
    fee_amount: Option<String>,
    fee_paid_by: Option<PostWithdrawalUpdatedPayloadDataFeePaidBy>,
    id: Option<String>,
    markup_fee: Option<String>,
    metadata: Option<HashMap<String, String>>,
    net_amount: Option<String>,
    notes: Option<String>,
    object: Option<PostWithdrawalUpdatedPayloadDataObject>,
    payer_name: Option<String>,
    payout_method: Option<PostWithdrawalUpdatedPayloadDataPayoutMethod>,
    payout_request_id: Option<String>,
    source: Option<PostWithdrawalUpdatedPayloadDataSource>,
    speed: Option<PostWithdrawalUpdatedPayloadDataSpeed>,
    status: Option<PostWithdrawalUpdatedPayloadDataStatus>,
    status_detail: Option<String>,
    trace_code: Option<String>,
}

impl PostWithdrawalUpdatedPayloadDataBuilder {
    ...
    pub fn failure(mut self, value: PostWithdrawalUpdatedPayloadDataFailure) -> Self {
    ...
    pub fn fee_paid_by(mut self, value: PostWithdrawalUpdatedPayloadDataFeePaidBy) -> Self {
    ...
    pub fn object(mut self, value: PostWithdrawalUpdatedPayloadDataObject) -> Self {
    ...
    pub fn payout_method(mut self, value: PostWithdrawalUpdatedPayloadDataPayoutMethod) -> Self {
    ...
    pub fn source(mut self, value: PostWithdrawalUpdatedPayloadDataSource) -> Self {
        self.source = Some(value);
        self
    }

    pub fn speed(mut self, value: PostWithdrawalUpdatedPayloadDataSpeed) -> Self {
        self.speed = Some(value);
        self
    }

    pub fn status(mut self, value: PostWithdrawalUpdatedPayloadDataStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostWithdrawalUpdatedPayloadData`].
    /// This method will fail if any of the following fields are not set:
    /// - [`amount`](PostWithdrawalUpdatedPayloadDataBuilder::amount)
    /// - [`created_at`](PostWithdrawalUpdatedPayloadDataBuilder::created_at)
    /// - [`currency`](PostWithdrawalUpdatedPayloadDataBuilder::currency)
    /// - [`fee_amount`](PostWithdrawalUpdatedPayloadDataBuilder::fee_amount)
    /// - [`fee_paid_by`](PostWithdrawalUpdatedPayloadDataBuilder::fee_paid_by)
    /// - [`id`](PostWithdrawalUpdatedPayloadDataBuilder::id)
    /// - [`markup_fee`](PostWithdrawalUpdatedPayloadDataBuilder::markup_fee)
    /// - [`metadata`](PostWithdrawalUpdatedPayloadDataBuilder::metadata)
    /// - [`net_amount`](PostWithdrawalUpdatedPayloadDataBuilder::net_amount)
    /// - [`object`](PostWithdrawalUpdatedPayloadDataBuilder::object)
    /// - [`speed`](PostWithdrawalUpdatedPayloadDataBuilder::speed)
    /// - [`status`](PostWithdrawalUpdatedPayloadDataBuilder::status)
    /// - [`status_detail`](PostWithdrawalUpdatedPayloadDataBuilder::status_detail)
    pub fn build(self) -> Result<PostWithdrawalUpdatedPayloadData, BuildError> {
        Ok(PostWithdrawalUpdatedPayloadData {
            amount: self
                .amount
