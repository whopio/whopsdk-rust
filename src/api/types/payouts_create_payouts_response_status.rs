...
pub enum CreatePayoutsResponseStatus {
    Requested,
    InReview,
    Processing,
    Completed,
...
impl Serialize for CreatePayoutsResponseStatus {
...
impl<'de> Deserialize<'de> for CreatePayoutsResponseStatus {
...
impl fmt::Display for CreatePayoutsResponseStatus {
