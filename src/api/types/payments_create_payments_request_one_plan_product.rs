...
pub struct CreatePaymentsRequestOnePlanProduct {
...
impl CreatePaymentsRequestOnePlanProduct {
    pub fn builder() -> CreatePaymentsRequestOnePlanProductBuilder {
        <CreatePaymentsRequestOnePlanProductBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreatePaymentsRequestOnePlanProductBuilder {
...
impl CreatePaymentsRequestOnePlanProductBuilder {
    ...
    /// Consumes the builder and constructs a [`CreatePaymentsRequestOnePlanProduct`].
    /// This method will fail if any of the following fields are not set:
    /// - [`external_identifier`](CreatePaymentsRequestOnePlanProductBuilder::external_identifier)
    /// - [`title`](CreatePaymentsRequestOnePlanProductBuilder::title)
    pub fn build(self) -> Result<CreatePaymentsRequestOnePlanProduct, BuildError> {
        Ok(CreatePaymentsRequestOnePlanProduct {
