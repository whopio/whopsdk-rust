...
pub enum CheckoutConfigurationMode {
    Payment,
    Setup,
...
impl Serialize for CheckoutConfigurationMode {
...
impl<'de> Deserialize<'de> for CheckoutConfigurationMode {
...
impl fmt::Display for CheckoutConfigurationMode {
