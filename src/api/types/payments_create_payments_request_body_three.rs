...
pub struct CreatePaymentsRequestBodyThree {
...
impl CreatePaymentsRequestBodyThree {
    pub fn builder() -> CreatePaymentsRequestBodyThreeBuilder {
        <CreatePaymentsRequestBodyThreeBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreatePaymentsRequestBodyThreeBuilder {
    capture: Option<bool>,
...
impl CreatePaymentsRequestBodyThreeBuilder {
    ...
    /// Consumes the builder and constructs a [`CreatePaymentsRequestBodyThree`].
    /// This method will fail if any of the following fields are not set:
    /// - [`company_id`](CreatePaymentsRequestBodyThreeBuilder::company_id)
    /// - [`member_id`](CreatePaymentsRequestBodyThreeBuilder::member_id)
    /// - [`plan_id`](CreatePaymentsRequestBodyThreeBuilder::plan_id)
    pub fn build(self) -> Result<CreatePaymentsRequestBodyThree, BuildError> {
        Ok(CreatePaymentsRequestBodyThree {
