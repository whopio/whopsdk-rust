...
pub enum AdCampaignResultEvent {
    Purchase,
    Lead,
    Schedule,
    SubmitApplication,
...
impl Serialize for AdCampaignResultEvent {
...
impl<'de> Deserialize<'de> for AdCampaignResultEvent {
...
impl fmt::Display for AdCampaignResultEvent {
