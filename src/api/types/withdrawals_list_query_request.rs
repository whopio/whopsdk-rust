...
pub struct WithdrawalsListQueryRequest {
...
impl WithdrawalsListQueryRequest {
    pub fn builder() -> WithdrawalsListQueryRequestBuilder {
        <WithdrawalsListQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct WithdrawalsListQueryRequestBuilder {
    after: Option<String>,
...
impl WithdrawalsListQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`WithdrawalsListQueryRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`company_id`](WithdrawalsListQueryRequestBuilder::company_id)
    pub fn build(self) -> Result<WithdrawalsListQueryRequest, BuildError> {
        Ok(WithdrawalsListQueryRequest {
            after: self.after,
            before: self.before,
            first: self.first,
            last: self.last,
