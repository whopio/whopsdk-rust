...
pub enum PaymentNextActionAwaitConfirmationRenderItem {
    Inline,
    FullPage,
...
impl Serialize for PaymentNextActionAwaitConfirmationRenderItem {
...
impl<'de> Deserialize<'de> for PaymentNextActionAwaitConfirmationRenderItem {
...
impl fmt::Display for PaymentNextActionAwaitConfirmationRenderItem {
