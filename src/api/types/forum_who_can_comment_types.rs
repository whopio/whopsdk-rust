...
pub enum ForumWhoCanCommentTypes {
    Everyone,
    Admins,
...
impl Serialize for ForumWhoCanCommentTypes {
...
impl<'de> Deserialize<'de> for ForumWhoCanCommentTypes {
...
impl fmt::Display for ForumWhoCanCommentTypes {
