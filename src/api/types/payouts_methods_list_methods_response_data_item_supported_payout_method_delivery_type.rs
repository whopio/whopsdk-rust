...
pub enum ListMethodsResponseDataItemSupportedPayoutMethodDeliveryType {
    CashPickup,
    BankDeposit,
    HomeDelivery,
    MobileWallet,
...
impl Serialize for ListMethodsResponseDataItemSupportedPayoutMethodDeliveryType {
...
impl<'de> Deserialize<'de> for ListMethodsResponseDataItemSupportedPayoutMethodDeliveryType {
...
impl fmt::Display for ListMethodsResponseDataItemSupportedPayoutMethodDeliveryType {
