...
pub enum UpdateAdGroupsRequestBidType {
    MinimumCost,
    AverageTarget,
    MaximumTarget,
...
impl Serialize for UpdateAdGroupsRequestBidType {
...
impl<'de> Deserialize<'de> for UpdateAdGroupsRequestBidType {
...
impl fmt::Display for UpdateAdGroupsRequestBidType {
