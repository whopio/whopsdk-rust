...
pub struct PostPaymentFailedPayload {
    /// The account ID that this webhook event is associated with
    #[serde(skip_serializing_if = "Option::is_none")]
    pub account_id: Option<String>,
    /// The API version for this webhook
    pub api_version: PostPaymentFailedPayloadApiVersion,
    ...
    pub r#type: PostPaymentFailedPayloadType,
}

impl PostPaymentFailedPayload {
    pub fn builder() -> PostPaymentFailedPayloadBuilder {
        <PostPaymentFailedPayloadBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostPaymentFailedPayloadBuilder {
    ...
    r#type: Option<PostPaymentFailedPayloadType>,
}

impl PostPaymentFailedPayloadBuilder {
    pub fn account_id(mut self, value: impl Into<String>) -> Self {
        self.account_id = Some(value.into());
        self
    }

    pub fn api_version(mut self, value: PostPaymentFailedPayloadApiVersion) -> Self {
    ...
    pub fn r#type(mut self, value: PostPaymentFailedPayloadType) -> Self {
        self.r#type = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`PostPaymentFailedPayload`].
    /// This method will fail if any of the following fields are not set:
    /// - [`api_version`](PostPaymentFailedPayloadBuilder::api_version)
    /// - [`data`](PostPaymentFailedPayloadBuilder::data)
    /// - [`id`](PostPaymentFailedPayloadBuilder::id)
    /// - [`timestamp`](PostPaymentFailedPayloadBuilder::timestamp)
    /// - [`r#type`](PostPaymentFailedPayloadBuilder::r#type)
    pub fn build(self) -> Result<PostPaymentFailedPayload, BuildError> {
        Ok(PostPaymentFailedPayload {
