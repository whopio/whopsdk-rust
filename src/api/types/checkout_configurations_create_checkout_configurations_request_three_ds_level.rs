...
pub enum CreateCheckoutConfigurationsRequestThreeDsLevel {
    MandateChallenge,
    Frictionless,
...
impl Serialize for CreateCheckoutConfigurationsRequestThreeDsLevel {
...
impl<'de> Deserialize<'de> for CreateCheckoutConfigurationsRequestThreeDsLevel {
...
impl fmt::Display for CreateCheckoutConfigurationsRequestThreeDsLevel {
