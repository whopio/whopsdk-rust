...
pub enum CreateCardsRequestSpendLimitFrequency {
    Daily,
    Weekly,
    Monthly,
    OneTime,
...
impl Serialize for CreateCardsRequestSpendLimitFrequency {
...
impl<'de> Deserialize<'de> for CreateCardsRequestSpendLimitFrequency {
...
impl fmt::Display for CreateCardsRequestSpendLimitFrequency {
