...
pub enum ListPeopleResponseDataItemFirstSourceType {
    AdClick,
    LeadForm,
    ExternalAdClick,
    Referrer,
...
impl Serialize for ListPeopleResponseDataItemFirstSourceType {
...
impl<'de> Deserialize<'de> for ListPeopleResponseDataItemFirstSourceType {
...
impl fmt::Display for ListPeopleResponseDataItemFirstSourceType {
