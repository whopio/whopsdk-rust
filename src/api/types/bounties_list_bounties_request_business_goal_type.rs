...
pub enum ListBountiesRequestBusinessGoalType {
    Clipping,
    PostEngagement,
    OwnedAccountGrowth,
    UgcContent,
...
impl Serialize for ListBountiesRequestBusinessGoalType {
...
impl<'de> Deserialize<'de> for ListBountiesRequestBusinessGoalType {
...
impl fmt::Display for ListBountiesRequestBusinessGoalType {
