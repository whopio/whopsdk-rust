...
pub enum UpdateAdCampaignsRequestSpecialAdCategoriesItem {
    Housing,
    Employment,
    FinancialProducts,
    Politics,
...
impl Serialize for UpdateAdCampaignsRequestSpecialAdCategoriesItem {
...
impl<'de> Deserialize<'de> for UpdateAdCampaignsRequestSpecialAdCategoriesItem {
...
impl fmt::Display for UpdateAdCampaignsRequestSpecialAdCategoriesItem {
