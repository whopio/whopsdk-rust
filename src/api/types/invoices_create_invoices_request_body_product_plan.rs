...
pub struct CreateInvoicesRequestBodyProductPlan {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub custom_fields: Option<Vec<CreateInvoicesRequestBodyProductPlanCustomFieldsItem>>,
    ...
    pub payment_method_configuration:
        Option<CreateInvoicesRequestBodyProductPlanPaymentMethodConfiguration>,
...
impl CreateInvoicesRequestBodyProductPlan {
    pub fn builder() -> CreateInvoicesRequestBodyProductPlanBuilder {
        <CreateInvoicesRequestBodyProductPlanBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateInvoicesRequestBodyProductPlanBuilder {
    adaptive_pricing_enabled: Option<bool>,
    billing_period: Option<i64>,
    currency: Option<Currencies>,
    custom_fields: Option<Vec<CreateInvoicesRequestBodyProductPlanCustomFieldsItem>>,
...
impl CreateInvoicesRequestBodyProductPlanBuilder {
    ...
    pub fn custom_fields(
        mut self,
        value: Vec<CreateInvoicesRequestBodyProductPlanCustomFieldsItem>,
    ) -> Self {
    ...
    pub fn payment_method_configuration(
        mut self,
        value: CreateInvoicesRequestBodyProductPlanPaymentMethodConfiguration,
    ) -> Self {
    ...
    /// Consumes the builder and constructs a [`CreateInvoicesRequestBodyProductPlan`].
    pub fn build(self) -> Result<CreateInvoicesRequestBodyProductPlan, BuildError> {
        Ok(CreateInvoicesRequestBodyProductPlan {
