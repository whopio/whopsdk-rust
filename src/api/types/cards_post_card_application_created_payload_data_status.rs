...
pub enum PostCardApplicationCreatedPayloadDataStatus {
    Approved,
    Pending,
    ManualReview,
    Denied,
...
impl Serialize for PostCardApplicationCreatedPayloadDataStatus {
...
impl<'de> Deserialize<'de> for PostCardApplicationCreatedPayloadDataStatus {
...
impl fmt::Display for PostCardApplicationCreatedPayloadDataStatus {
