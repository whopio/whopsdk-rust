...
pub enum CreatePayoutsRequestSpeed {
    Standard,
    Instant,
...
impl Serialize for CreatePayoutsRequestSpeed {
...
impl<'de> Deserialize<'de> for CreatePayoutsRequestSpeed {
...
impl fmt::Display for CreatePayoutsRequestSpeed {
