...
pub enum PostTransferFailedPayloadDataStatus {
    Processing,
    Succeeded,
    Failed,
...
impl Serialize for PostTransferFailedPayloadDataStatus {
...
impl<'de> Deserialize<'de> for PostTransferFailedPayloadDataStatus {
...
impl fmt::Display for PostTransferFailedPayloadDataStatus {
