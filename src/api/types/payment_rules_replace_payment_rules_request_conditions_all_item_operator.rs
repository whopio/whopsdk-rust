...
pub enum ReplacePaymentRulesRequestConditionsAllItemOperator {
    Eq,
    Neq,
    Gt,
    Gte,
...
impl Serialize for ReplacePaymentRulesRequestConditionsAllItemOperator {
...
impl<'de> Deserialize<'de> for ReplacePaymentRulesRequestConditionsAllItemOperator {
...
impl fmt::Display for ReplacePaymentRulesRequestConditionsAllItemOperator {
