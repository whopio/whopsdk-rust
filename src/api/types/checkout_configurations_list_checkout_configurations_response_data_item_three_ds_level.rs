...
pub enum ListCheckoutConfigurationsResponseDataItemThreeDsLevel {
    MandateChallenge,
    Frictionless,
...
impl Serialize for ListCheckoutConfigurationsResponseDataItemThreeDsLevel {
...
impl<'de> Deserialize<'de> for ListCheckoutConfigurationsResponseDataItemThreeDsLevel {
...
impl fmt::Display for ListCheckoutConfigurationsResponseDataItemThreeDsLevel {
