...
pub enum PartnerPayoutTierTier {
    First,
    Second,
...
impl Serialize for PartnerPayoutTierTier {
...
impl<'de> Deserialize<'de> for PartnerPayoutTierTier {
...
impl fmt::Display for PartnerPayoutTierTier {
