...
pub enum ListAppsRequestAppType {
    B2BApp,
    B2CApp,
    CompanyApp,
    Component,
...
impl Serialize for ListAppsRequestAppType {
...
impl<'de> Deserialize<'de> for ListAppsRequestAppType {
...
impl fmt::Display for ListAppsRequestAppType {
