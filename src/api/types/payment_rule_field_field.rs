...
pub enum PaymentRuleFieldField {
    RiskScore,
    CardCountry,
    CustomerEmail,
...
impl Serialize for PaymentRuleFieldField {
...
impl<'de> Deserialize<'de> for PaymentRuleFieldField {
...
impl fmt::Display for PaymentRuleFieldField {
