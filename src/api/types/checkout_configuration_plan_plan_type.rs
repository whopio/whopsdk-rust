...
pub enum CheckoutConfigurationPlanPlanType {
    Renewal,
    OneTime,
...
impl Serialize for CheckoutConfigurationPlanPlanType {
...
impl<'de> Deserialize<'de> for CheckoutConfigurationPlanPlanType {
...
impl fmt::Display for CheckoutConfigurationPlanPlanType {
