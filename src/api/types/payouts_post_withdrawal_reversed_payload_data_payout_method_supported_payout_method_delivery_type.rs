...
pub enum PostWithdrawalReversedPayloadDataPayoutMethodSupportedPayoutMethodDeliveryType {
    CashPickup,
    BankDeposit,
    HomeDelivery,
    MobileWallet,
...
impl Serialize for PostWithdrawalReversedPayloadDataPayoutMethodSupportedPayoutMethodDeliveryType {
...
impl<'de> Deserialize<'de>
    for PostWithdrawalReversedPayloadDataPayoutMethodSupportedPayoutMethodDeliveryType
{
