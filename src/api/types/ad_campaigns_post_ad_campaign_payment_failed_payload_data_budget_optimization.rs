...
pub enum PostAdCampaignPaymentFailedPayloadDataBudgetOptimization {
    AdCampaign,
    AdGroup,
...
impl Serialize for PostAdCampaignPaymentFailedPayloadDataBudgetOptimization {
...
impl<'de> Deserialize<'de> for PostAdCampaignPaymentFailedPayloadDataBudgetOptimization {
...
impl fmt::Display for PostAdCampaignPaymentFailedPayloadDataBudgetOptimization {
