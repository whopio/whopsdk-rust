...
pub enum ShipmentCheckpointStatus {
    Unknown,
    PreTransit,
    InTransit,
    OutForDelivery,
...
impl Serialize for ShipmentCheckpointStatus {
...
impl<'de> Deserialize<'de> for ShipmentCheckpointStatus {
...
impl fmt::Display for ShipmentCheckpointStatus {
