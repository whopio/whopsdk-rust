...
pub struct RetrieveCheckoutConfigurationsResponse {
    ...
    pub effective_payment_method_configuration:
        Option<RetrieveCheckoutConfigurationsResponseEffectivePaymentMethodConfiguration>,
    ...
    pub mode: RetrieveCheckoutConfigurationsResponseMode,
    ...
    pub payment_method_configuration:
        Option<RetrieveCheckoutConfigurationsResponsePaymentMethodConfiguration>,
    /// Plan used for payment checkout. `null` in setup mode.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub plan: Option<RetrieveCheckoutConfigurationsResponsePlan>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub three_ds_level: Option<RetrieveCheckoutConfigurationsResponseThreeDsLevel>,
    /// When the checkout configuration was last updated, as an ISO 8601 timestamp.
    #[serde(default)]
    pub updated_at: String,
}

impl RetrieveCheckoutConfigurationsResponse {
    pub fn builder() -> RetrieveCheckoutConfigurationsResponseBuilder {
        <RetrieveCheckoutConfigurationsResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct RetrieveCheckoutConfigurationsResponseBuilder {
    ...
    mode: Option<RetrieveCheckoutConfigurationsResponseMode>,
    payment_method_configuration:
        Option<RetrieveCheckoutConfigurationsResponsePaymentMethodConfiguration>,
    plan: Option<RetrieveCheckoutConfigurationsResponsePlan>,
    purchase_url: Option<String>,
    redirect_url: Option<String>,
    three_ds_level: Option<RetrieveCheckoutConfigurationsResponseThreeDsLevel>,
    updated_at: Option<String>,
}

impl RetrieveCheckoutConfigurationsResponseBuilder {
    ...
    pub fn effective_payment_method_configuration(
        mut self,
        value: RetrieveCheckoutConfigurationsResponseEffectivePaymentMethodConfiguration,
    ) -> Self {
    ...
    pub fn mode(mut self, value: RetrieveCheckoutConfigurationsResponseMode) -> Self {
    ...
    pub fn payment_method_configuration(
        mut self,
        value: RetrieveCheckoutConfigurationsResponsePaymentMethodConfiguration,
    ) -> Self {
        self.payment_method_configuration = Some(value);
        self
    }

    pub fn plan(mut self, value: RetrieveCheckoutConfigurationsResponsePlan) -> Self {
    ...
    pub fn three_ds_level(
        mut self,
        value: RetrieveCheckoutConfigurationsResponseThreeDsLevel,
    ) -> Self {
    ...
    /// Consumes the builder and constructs a [`RetrieveCheckoutConfigurationsResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`account_id`](RetrieveCheckoutConfigurationsResponseBuilder::account_id)
    /// - [`created_at`](RetrieveCheckoutConfigurationsResponseBuilder::created_at)
    /// - [`id`](RetrieveCheckoutConfigurationsResponseBuilder::id)
    /// - [`mode`](RetrieveCheckoutConfigurationsResponseBuilder::mode)
    /// - [`updated_at`](RetrieveCheckoutConfigurationsResponseBuilder::updated_at)
    pub fn build(self) -> Result<RetrieveCheckoutConfigurationsResponse, BuildError> {
        Ok(RetrieveCheckoutConfigurationsResponse {
            account_id: self
                .account_id
