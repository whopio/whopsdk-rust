...
pub enum PostPayoutCreatedPayloadDataSource {
    Api,
    Dashboard,
    Automatic,
...
impl Serialize for PostPayoutCreatedPayloadDataSource {
...
impl<'de> Deserialize<'de> for PostPayoutCreatedPayloadDataSource {
...
impl fmt::Display for PostPayoutCreatedPayloadDataSource {
