...
pub enum PlanListItemVisibility {
    Visible,
    Hidden,
    Archived,
    QuickLink,
...
impl Serialize for PlanListItemVisibility {
...
impl<'de> Deserialize<'de> for PlanListItemVisibility {
...
impl fmt::Display for PlanListItemVisibility {
