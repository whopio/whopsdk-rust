...
pub enum PostAdUpdatedPayloadDataStatus {
    Active,
    Paused,
    InReview,
    Rejected,
...
impl Serialize for PostAdUpdatedPayloadDataStatus {
...
impl<'de> Deserialize<'de> for PostAdUpdatedPayloadDataStatus {
...
impl fmt::Display for PostAdUpdatedPayloadDataStatus {
