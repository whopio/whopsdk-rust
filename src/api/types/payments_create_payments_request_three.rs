...
pub struct CreatePaymentsRequestThree {
...
impl CreatePaymentsRequestThree {
    pub fn builder() -> CreatePaymentsRequestThreeBuilder {
        <CreatePaymentsRequestThreeBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreatePaymentsRequestThreeBuilder {
...
impl CreatePaymentsRequestThreeBuilder {
    ...
    /// Consumes the builder and constructs a [`CreatePaymentsRequestThree`].
    /// This method will fail if any of the following fields are not set:
    /// - [`company_id`](CreatePaymentsRequestThreeBuilder::company_id)
    /// - [`member_id`](CreatePaymentsRequestThreeBuilder::member_id)
    /// - [`plan_id`](CreatePaymentsRequestThreeBuilder::plan_id)
    pub fn build(self) -> Result<CreatePaymentsRequestThree, BuildError> {
        Ok(CreatePaymentsRequestThree {
            company_id: self
                .company_id
