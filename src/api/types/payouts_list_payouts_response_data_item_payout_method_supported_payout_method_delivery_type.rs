...
pub enum ListPayoutsResponseDataItemPayoutMethodSupportedPayoutMethodDeliveryType {
    CashPickup,
    BankDeposit,
    HomeDelivery,
    MobileWallet,
...
impl Serialize for ListPayoutsResponseDataItemPayoutMethodSupportedPayoutMethodDeliveryType {
...
impl<'de> Deserialize<'de>
    for ListPayoutsResponseDataItemPayoutMethodSupportedPayoutMethodDeliveryType
{
...
impl fmt::Display for ListPayoutsResponseDataItemPayoutMethodSupportedPayoutMethodDeliveryType {
