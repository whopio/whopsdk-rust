...
pub struct CourseListItem {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub resume_lesson: Option<CourseListItemResumeLesson>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub thumbnail: Option<CourseListItemThumbnail>,
...
impl CourseListItem {
    pub fn builder() -> CourseListItemBuilder {
        <CourseListItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CourseListItemBuilder {
    ...
    resume_lesson: Option<CourseListItemResumeLesson>,
    started_at: Option<DateTime<FixedOffset>>,
    tagline: Option<String>,
    thumbnail: Option<CourseListItemThumbnail>,
    title: Option<String>,
...
impl CourseListItemBuilder {
    ...
    pub fn resume_lesson(mut self, value: CourseListItemResumeLesson) -> Self {
    ...
    pub fn thumbnail(mut self, value: CourseListItemThumbnail) -> Self {
    ...
    /// Consumes the builder and constructs a [`CourseListItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`chapters_count`](CourseListItemBuilder::chapters_count)
    /// - [`completed_lessons_count`](CourseListItemBuilder::completed_lessons_count)
    /// - [`created_at`](CourseListItemBuilder::created_at)
    /// - [`id`](CourseListItemBuilder::id)
    /// - [`language`](CourseListItemBuilder::language)
    /// - [`lesson_unlock_days`](CourseListItemBuilder::lesson_unlock_days)
    /// - [`order`](CourseListItemBuilder::order)
    /// - [`require_completing_lessons_in_order`](CourseListItemBuilder::require_completing_lessons_in_order)
    /// - [`total_duration_seconds`](CourseListItemBuilder::total_duration_seconds)
    /// - [`total_lessons_count`](CourseListItemBuilder::total_lessons_count)
    /// - [`updated_at`](CourseListItemBuilder::updated_at)
    /// - [`visibility`](CourseListItemBuilder::visibility)
    pub fn build(self) -> Result<CourseListItem, BuildError> {
        Ok(CourseListItem {
