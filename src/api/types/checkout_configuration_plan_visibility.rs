...
pub enum CheckoutConfigurationPlanVisibility {
    Visible,
    Hidden,
    Archived,
    QuickLink,
...
impl Serialize for CheckoutConfigurationPlanVisibility {
...
impl<'de> Deserialize<'de> for CheckoutConfigurationPlanVisibility {
...
impl fmt::Display for CheckoutConfigurationPlanVisibility {
