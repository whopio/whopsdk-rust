...
pub enum PartnerReferralRequestStatus {
    Pending,
    Accepted,
    Denied,
    Cancelled,
...
impl Serialize for PartnerReferralRequestStatus {
...
impl<'de> Deserialize<'de> for PartnerReferralRequestStatus {
...
impl fmt::Display for PartnerReferralRequestStatus {
