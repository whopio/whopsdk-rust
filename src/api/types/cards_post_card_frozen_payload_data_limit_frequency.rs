...
pub enum PostCardFrozenPayloadDataLimitFrequency {
    Daily,
    Weekly,
    Monthly,
    OneTime,
...
impl Serialize for PostCardFrozenPayloadDataLimitFrequency {
...
impl<'de> Deserialize<'de> for PostCardFrozenPayloadDataLimitFrequency {
...
impl fmt::Display for PostCardFrozenPayloadDataLimitFrequency {
