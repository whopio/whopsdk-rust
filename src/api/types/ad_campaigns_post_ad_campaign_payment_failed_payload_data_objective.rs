...
pub enum PostAdCampaignPaymentFailedPayloadDataObjective {
    Awareness,
    Traffic,
    Engagement,
    Leads,
...
impl Serialize for PostAdCampaignPaymentFailedPayloadDataObjective {
...
impl<'de> Deserialize<'de> for PostAdCampaignPaymentFailedPayloadDataObjective {
...
impl fmt::Display for PostAdCampaignPaymentFailedPayloadDataObjective {
