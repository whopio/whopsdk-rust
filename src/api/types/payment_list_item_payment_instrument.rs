...
pub struct PaymentListItemPaymentInstrument {
    /// Card payments only: the card's network and last four.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub card: Option<PaymentListItemPaymentInstrumentCard>,
    ...
    #[serde(default)]
    pub icons: PaymentListItemPaymentInstrumentIcons,
...
impl PaymentListItemPaymentInstrument {
    pub fn builder() -> PaymentListItemPaymentInstrumentBuilder {
        <PaymentListItemPaymentInstrumentBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PaymentListItemPaymentInstrumentBuilder {
    card: Option<PaymentListItemPaymentInstrumentCard>,
    display_name: Option<String>,
    icons: Option<PaymentListItemPaymentInstrumentIcons>,
    installment_count: Option<i64>,
    payment_method_type: Option<String>,
}

impl PaymentListItemPaymentInstrumentBuilder {
    pub fn card(mut self, value: PaymentListItemPaymentInstrumentCard) -> Self {
    ...
    pub fn icons(mut self, value: PaymentListItemPaymentInstrumentIcons) -> Self {
    ...
    /// Consumes the builder and constructs a [`PaymentListItemPaymentInstrument`].
    /// This method will fail if any of the following fields are not set:
    /// - [`display_name`](PaymentListItemPaymentInstrumentBuilder::display_name)
    /// - [`icons`](PaymentListItemPaymentInstrumentBuilder::icons)
    /// - [`payment_method_type`](PaymentListItemPaymentInstrumentBuilder::payment_method_type)
    pub fn build(self) -> Result<PaymentListItemPaymentInstrument, BuildError> {
        Ok(PaymentListItemPaymentInstrument {
            card: self.card,
            display_name: self
                .display_name
