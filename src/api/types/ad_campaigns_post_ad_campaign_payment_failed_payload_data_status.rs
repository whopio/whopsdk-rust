...
pub enum PostAdCampaignPaymentFailedPayloadDataStatus {
    Active,
    Paused,
    Inactive,
    Stale,
...
impl Serialize for PostAdCampaignPaymentFailedPayloadDataStatus {
...
impl<'de> Deserialize<'de> for PostAdCampaignPaymentFailedPayloadDataStatus {
...
impl fmt::Display for PostAdCampaignPaymentFailedPayloadDataStatus {
