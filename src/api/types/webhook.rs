...
pub struct Webhook {
    ...
    pub api_version: WebhookApiVersion,
    ...
    pub enabled: bool,
    #[serde(default)]
    pub events: Vec<WebhookEventsItem>,
    ...
    #[serde(default)]
    pub testable_events: Vec<WebhookTestableEventsItem>,
...
pub struct WebhookBuilder {
    api_version: Option<WebhookApiVersion>,
    api_version_date: Option<String>,
    child_resource_events: Option<bool>,
    consecutive_failures: Option<i64>,
    created_at: Option<String>,
    disabled_at: Option<String>,
    disabled_reason: Option<WebhookDisabledReason>,
    enabled: Option<bool>,
    events: Option<Vec<WebhookEventsItem>>,
    failing_since: Option<String>,
    id: Option<String>,
    last_failure_at: Option<String>,
    resource_id: Option<String>,
    testable_events: Option<Vec<WebhookTestableEventsItem>>,
    url: Option<String>,
    webhook_secret: Option<String>,
}

impl WebhookBuilder {
    pub fn api_version(mut self, value: WebhookApiVersion) -> Self {
    ...
    pub fn disabled_reason(mut self, value: WebhookDisabledReason) -> Self {
    ...
    pub fn events(mut self, value: Vec<WebhookEventsItem>) -> Self {
    ...
    pub fn testable_events(mut self, value: Vec<WebhookTestableEventsItem>) -> Self {
        self.testable_events = Some(value);
        self
    }
    ...
    /// - [`api_version`](WebhookBuilder::api_version)
    /// - [`child_resource_events`](WebhookBuilder::child_resource_events)
    /// - [`consecutive_failures`](WebhookBuilder::consecutive_failures)
    /// - [`created_at`](WebhookBuilder::created_at)
    /// - [`enabled`](WebhookBuilder::enabled)
    /// - [`events`](WebhookBuilder::events)
    /// - [`id`](WebhookBuilder::id)
    /// - [`resource_id`](WebhookBuilder::resource_id)
    /// - [`testable_events`](WebhookBuilder::testable_events)
    ...
    pub fn build(self) -> Result<Webhook, BuildError> {
        Ok(Webhook {
            ...
            testable_events: self
                .testable_events
                .ok_or_else(|| BuildError::missing_field("testable_events"))?,
