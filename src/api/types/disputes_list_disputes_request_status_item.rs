...
pub enum ListDisputesRequestStatusItem {
    NeedsResponse,
    UnderReview,
    Won,
    Lost,
...
impl Serialize for ListDisputesRequestStatusItem {
...
impl<'de> Deserialize<'de> for ListDisputesRequestStatusItem {
...
impl fmt::Display for ListDisputesRequestStatusItem {
