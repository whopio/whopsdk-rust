...
pub enum WebhookListItemEventsItem {
    AccountUpdated,
...
impl Serialize for WebhookListItemEventsItem {
...
impl<'de> Deserialize<'de> for WebhookListItemEventsItem {
...
impl fmt::Display for WebhookListItemEventsItem {
