...
pub enum ResolutionCenterCaseReporters {
    Merchant,
    Customer,
    Platform,
    System,
...
impl Serialize for ResolutionCenterCaseReporters {
...
impl<'de> Deserialize<'de> for ResolutionCenterCaseReporters {
...
impl fmt::Display for ResolutionCenterCaseReporters {
