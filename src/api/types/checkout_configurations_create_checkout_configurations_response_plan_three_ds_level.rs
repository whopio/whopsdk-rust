...
pub enum CreateCheckoutConfigurationsResponsePlanThreeDsLevel {
    MandateChallenge,
    Frictionless,
...
impl Serialize for CreateCheckoutConfigurationsResponsePlanThreeDsLevel {
...
impl<'de> Deserialize<'de> for CreateCheckoutConfigurationsResponsePlanThreeDsLevel {
...
impl fmt::Display for CreateCheckoutConfigurationsResponsePlanThreeDsLevel {
