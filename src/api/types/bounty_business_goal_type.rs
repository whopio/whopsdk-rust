...
pub enum BountyBusinessGoalType {
    Clipping,
    PostEngagement,
    OwnedAccountGrowth,
    UgcContent,
...
impl Serialize for BountyBusinessGoalType {
...
impl<'de> Deserialize<'de> for BountyBusinessGoalType {
...
impl fmt::Display for BountyBusinessGoalType {
