...
pub enum RetrievePayoutsResponseSource {
    Api,
    Dashboard,
    Automatic,
...
impl Serialize for RetrievePayoutsResponseSource {
...
impl<'de> Deserialize<'de> for RetrievePayoutsResponseSource {
...
impl fmt::Display for RetrievePayoutsResponseSource {
