...
pub enum AdGroupDemographicCategoryType {
    LifeEvents,
    Industries,
    Income,
    FamilyStatuses,
...
impl Serialize for AdGroupDemographicCategoryType {
...
impl<'de> Deserialize<'de> for AdGroupDemographicCategoryType {
...
impl fmt::Display for AdGroupDemographicCategoryType {
