...
pub enum UpdateAdsRequestCallToAction {
    ApplyNow,
    BookNow,
    CallNow,
    ContactUs,
...
impl Serialize for UpdateAdsRequestCallToAction {
...
impl<'de> Deserialize<'de> for UpdateAdsRequestCallToAction {
...
impl fmt::Display for UpdateAdsRequestCallToAction {
