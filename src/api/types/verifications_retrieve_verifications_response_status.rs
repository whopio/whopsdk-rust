...
pub enum RetrieveVerificationsResponseStatus {
    NotStarted,
    Pending,
    Processing,
    ManualReview,
...
impl Serialize for RetrieveVerificationsResponseStatus {
...
impl<'de> Deserialize<'de> for RetrieveVerificationsResponseStatus {
...
impl fmt::Display for RetrieveVerificationsResponseStatus {
