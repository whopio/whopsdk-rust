...
pub enum PostAdCampaignPaymentFailedPayloadDataSpecialAdCategoriesItem {
    Housing,
    Employment,
    FinancialProducts,
    Politics,
...
impl Serialize for PostAdCampaignPaymentFailedPayloadDataSpecialAdCategoriesItem {
...
impl<'de> Deserialize<'de> for PostAdCampaignPaymentFailedPayloadDataSpecialAdCategoriesItem {
...
impl fmt::Display for PostAdCampaignPaymentFailedPayloadDataSpecialAdCategoriesItem {
