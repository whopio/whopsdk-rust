...
pub enum CreatePaymentsRequestPlanVisibility {
    Visible,
    Hidden,
    Archived,
    QuickLink,
...
impl Serialize for CreatePaymentsRequestPlanVisibility {
...
impl<'de> Deserialize<'de> for CreatePaymentsRequestPlanVisibility {
...
impl fmt::Display for CreatePaymentsRequestPlanVisibility {
