...
pub struct ForumPostListItem {
    /// All file attachments on this post, such as images, documents, and videos.
    #[serde(default)]
    pub attachments: Vec<ForumPostListItemAttachmentsItem>,
    ...
    #[serde(default)]
    pub user: ForumPostListItemUser,
    /// The total number of times this post has been viewed by users.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub view_count: Option<i64>,
}

impl ForumPostListItem {
    pub fn builder() -> ForumPostListItemBuilder {
        <ForumPostListItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ForumPostListItemBuilder {
    attachments: Option<Vec<ForumPostListItemAttachmentsItem>>,
    ...
    user: Option<ForumPostListItemUser>,
    view_count: Option<i64>,
}

impl ForumPostListItemBuilder {
    pub fn attachments(mut self, value: Vec<ForumPostListItemAttachmentsItem>) -> Self {
    ...
    pub fn user(mut self, value: ForumPostListItemUser) -> Self {
    ...
    /// Consumes the builder and constructs a [`ForumPostListItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`attachments`](ForumPostListItemBuilder::attachments)
    /// - [`comment_count`](ForumPostListItemBuilder::comment_count)
    /// - [`created_at`](ForumPostListItemBuilder::created_at)
    /// - [`id`](ForumPostListItemBuilder::id)
    /// - [`is_edited`](ForumPostListItemBuilder::is_edited)
    /// - [`is_pinned`](ForumPostListItemBuilder::is_pinned)
    /// - [`is_poster_admin`](ForumPostListItemBuilder::is_poster_admin)
    /// - [`updated_at`](ForumPostListItemBuilder::updated_at)
    /// - [`user`](ForumPostListItemBuilder::user)
    pub fn build(self) -> Result<ForumPostListItem, BuildError> {
        Ok(ForumPostListItem {
            attachments: self
                .attachments
