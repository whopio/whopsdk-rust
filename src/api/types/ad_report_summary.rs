...
impl AdReportSummary {
    pub fn builder() -> AdReportSummaryBuilder {
        <AdReportSummaryBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct AdReportSummaryBuilder {
...
impl AdReportSummaryBuilder {
    ...
    /// Consumes the builder and constructs a [`AdReportSummary`].
    /// This method will fail if any of the following fields are not set:
    /// - [`click_through_rate`](AdReportSummaryBuilder::click_through_rate)
    /// - [`clicks`](AdReportSummaryBuilder::clicks)
    /// - [`cost_per_click`](AdReportSummaryBuilder::cost_per_click)
    /// - [`impressions`](AdReportSummaryBuilder::impressions)
    /// - [`reach`](AdReportSummaryBuilder::reach)
    /// - [`spend`](AdReportSummaryBuilder::spend)
    pub fn build(self) -> Result<AdReportSummary, BuildError> {
        Ok(AdReportSummary {
