...
pub enum RefundReferenceStatus {
    Available,
    Pending,
    Unavailable,
...
impl Serialize for RefundReferenceStatus {
...
impl<'de> Deserialize<'de> for RefundReferenceStatus {
...
impl fmt::Display for RefundReferenceStatus {
