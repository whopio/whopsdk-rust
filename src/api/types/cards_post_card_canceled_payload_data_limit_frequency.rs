...
pub enum PostCardCanceledPayloadDataLimitFrequency {
    Daily,
    Weekly,
    Monthly,
    OneTime,
...
impl Serialize for PostCardCanceledPayloadDataLimitFrequency {
...
impl<'de> Deserialize<'de> for PostCardCanceledPayloadDataLimitFrequency {
...
impl fmt::Display for PostCardCanceledPayloadDataLimitFrequency {
