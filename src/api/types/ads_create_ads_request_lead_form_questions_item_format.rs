...
pub enum CreateAdsRequestLeadFormQuestionsItemFormat {
    ShortAnswer,
    MultipleChoice,
    Appointment,
...
impl Serialize for CreateAdsRequestLeadFormQuestionsItemFormat {
...
impl<'de> Deserialize<'de> for CreateAdsRequestLeadFormQuestionsItemFormat {
...
impl fmt::Display for CreateAdsRequestLeadFormQuestionsItemFormat {
