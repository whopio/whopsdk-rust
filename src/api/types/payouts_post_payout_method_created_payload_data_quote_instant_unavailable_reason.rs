...
pub enum PostPayoutMethodCreatedPayloadDataQuoteInstantUnavailableReason {
    #[serde(rename = "minimum_crypto_sales_not_met")]
    MinimumCryptoSalesNotMet,
}
impl fmt::Display for PostPayoutMethodCreatedPayloadDataQuoteInstantUnavailableReason {
