...
pub struct ListVerificationsResponseDataItem {
    ...
    pub address: Option<ListVerificationsResponseDataItemAddress>,
    /// Legal business name.
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub kind: Option<ListVerificationsResponseDataItemKind>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    pub requested_information:
        Option<Vec<ListVerificationsResponseDataItemRequestedInformationItem>>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub required_documents: Option<Vec<ListVerificationsResponseDataItemRequiredDocumentsItem>>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<ListVerificationsResponseDataItemStatus>,
    /// When the verification profile was last updated, as an ISO 8601 timestamp.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub updated_at: Option<String>,
}

impl ListVerificationsResponseDataItem {
    pub fn builder() -> ListVerificationsResponseDataItemBuilder {
        <ListVerificationsResponseDataItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListVerificationsResponseDataItemBuilder {
    address: Option<ListVerificationsResponseDataItemAddress>,
    ...
    id: Option<String>,
    kind: Option<ListVerificationsResponseDataItemKind>,
    last_name: Option<String>,
    phone: Option<String>,
    requested_information: Option<Vec<ListVerificationsResponseDataItemRequestedInformationItem>>,
    required_documents: Option<Vec<ListVerificationsResponseDataItemRequiredDocumentsItem>>,
    session_url: Option<String>,
    status: Option<ListVerificationsResponseDataItemStatus>,
    updated_at: Option<String>,
}

impl ListVerificationsResponseDataItemBuilder {
    pub fn address(mut self, value: ListVerificationsResponseDataItemAddress) -> Self {
    ...
    pub fn kind(mut self, value: ListVerificationsResponseDataItemKind) -> Self {
    ...
    pub fn requested_information(
        mut self,
        value: Vec<ListVerificationsResponseDataItemRequestedInformationItem>,
    ) -> Self {
    ...
    pub fn required_documents(
        mut self,
        value: Vec<ListVerificationsResponseDataItemRequiredDocumentsItem>,
    ) -> Self {
    ...
    pub fn status(mut self, value: ListVerificationsResponseDataItemStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`ListVerificationsResponseDataItem`].
    pub fn build(self) -> Result<ListVerificationsResponseDataItem, BuildError> {
        Ok(ListVerificationsResponseDataItem {
