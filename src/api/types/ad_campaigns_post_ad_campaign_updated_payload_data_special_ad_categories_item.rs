...
pub enum PostAdCampaignUpdatedPayloadDataSpecialAdCategoriesItem {
    Housing,
    Employment,
    FinancialProducts,
    Politics,
...
impl Serialize for PostAdCampaignUpdatedPayloadDataSpecialAdCategoriesItem {
...
impl<'de> Deserialize<'de> for PostAdCampaignUpdatedPayloadDataSpecialAdCategoriesItem {
...
impl fmt::Display for PostAdCampaignUpdatedPayloadDataSpecialAdCategoriesItem {
