...
pub struct UpdateCardsResponseSecrets {
    /// Full card number.
    #[serde(default)]
...
impl UpdateCardsResponseSecrets {
    pub fn builder() -> UpdateCardsResponseSecretsBuilder {
        <UpdateCardsResponseSecretsBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct UpdateCardsResponseSecretsBuilder {
...
impl UpdateCardsResponseSecretsBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateCardsResponseSecrets`].
    /// This method will fail if any of the following fields are not set:
    /// - [`card_number`](UpdateCardsResponseSecretsBuilder::card_number)
    /// - [`cvc`](UpdateCardsResponseSecretsBuilder::cvc)
    pub fn build(self) -> Result<UpdateCardsResponseSecrets, BuildError> {
        Ok(UpdateCardsResponseSecrets {
            card_number: self
                .card_number
