...
pub struct DisputeEvidenceDocument {
    ...
    pub upload_status: DisputeEvidenceDocumentUploadStatus,
    ...
    pub visibility: DisputeEvidenceDocumentVisibility,
}
...
pub struct DisputeEvidenceDocumentBuilder {
    ...
    upload_status: Option<DisputeEvidenceDocumentUploadStatus>,
    upload_url: Option<String>,
    url: Option<String>,
    visibility: Option<DisputeEvidenceDocumentVisibility>,
}
...
impl DisputeEvidenceDocumentBuilder {
    ...
    pub fn upload_status(mut self, value: DisputeEvidenceDocumentUploadStatus) -> Self {
    ...
    pub fn visibility(mut self, value: DisputeEvidenceDocumentVisibility) -> Self {
    ...
    /// - [`created_at`](DisputeEvidenceDocumentBuilder::created_at)
    /// - [`document_type`](DisputeEvidenceDocumentBuilder::document_type)
    /// - [`id`](DisputeEvidenceDocumentBuilder::id)
    /// - [`object`](DisputeEvidenceDocumentBuilder::object)
    /// - [`upload_status`](DisputeEvidenceDocumentBuilder::upload_status)
    /// - [`visibility`](DisputeEvidenceDocumentBuilder::visibility)
