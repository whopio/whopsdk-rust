...
pub enum CreateAudiencesRequestSourceType {
    CsvUpload,
    PeopleFilter,
    Engagement,
...
impl Serialize for CreateAudiencesRequestSourceType {
...
impl<'de> Deserialize<'de> for CreateAudiencesRequestSourceType {
...
impl fmt::Display for CreateAudiencesRequestSourceType {
