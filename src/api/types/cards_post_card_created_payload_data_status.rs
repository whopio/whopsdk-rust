...
pub enum PostCardCreatedPayloadDataStatus {
    Active,
    Frozen,
    Canceled,
    Invited,
...
impl Serialize for PostCardCreatedPayloadDataStatus {
...
impl<'de> Deserialize<'de> for PostCardCreatedPayloadDataStatus {
...
impl fmt::Display for PostCardCreatedPayloadDataStatus {
