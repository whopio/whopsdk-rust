...
pub enum UpdateCardsRequestSpendLimitFrequency {
    Daily,
    Weekly,
    Monthly,
    OneTime,
...
impl Serialize for UpdateCardsRequestSpendLimitFrequency {
...
impl<'de> Deserialize<'de> for UpdateCardsRequestSpendLimitFrequency {
...
impl fmt::Display for UpdateCardsRequestSpendLimitFrequency {
