...
impl DmChannel {
    pub fn builder() -> DmChannelBuilder {
        <DmChannelBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct DmChannelBuilder {
...
impl DmChannelBuilder {
    ...
    /// Consumes the builder and constructs a [`DmChannel`].
    /// This method will fail if any of the following fields are not set:
    /// - [`created_at`](DmChannelBuilder::created_at)
    /// - [`id`](DmChannelBuilder::id)
    pub fn build(self) -> Result<DmChannel, BuildError> {
        Ok(DmChannel {
            created_at: self
                .created_at
