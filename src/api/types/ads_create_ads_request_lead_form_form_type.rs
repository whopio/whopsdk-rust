...
pub enum CreateAdsRequestLeadFormFormType {
    MoreVolume,
    HigherIntent,
...
impl Serialize for CreateAdsRequestLeadFormFormType {
...
impl<'de> Deserialize<'de> for CreateAdsRequestLeadFormFormType {
...
impl fmt::Display for CreateAdsRequestLeadFormFormType {
