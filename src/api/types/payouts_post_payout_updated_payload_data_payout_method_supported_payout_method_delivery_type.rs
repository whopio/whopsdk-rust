...
pub enum PostPayoutUpdatedPayloadDataPayoutMethodSupportedPayoutMethodDeliveryType {
    CashPickup,
    BankDeposit,
    HomeDelivery,
    MobileWallet,
...
impl Serialize for PostPayoutUpdatedPayloadDataPayoutMethodSupportedPayoutMethodDeliveryType {
...
impl<'de> Deserialize<'de>
    for PostPayoutUpdatedPayloadDataPayoutMethodSupportedPayoutMethodDeliveryType
{
...
impl fmt::Display for PostPayoutUpdatedPayloadDataPayoutMethodSupportedPayoutMethodDeliveryType {
