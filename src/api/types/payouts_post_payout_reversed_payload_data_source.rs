...
pub enum PostPayoutReversedPayloadDataSource {
    Api,
    Dashboard,
    Automatic,
...
impl Serialize for PostPayoutReversedPayloadDataSource {
...
impl<'de> Deserialize<'de> for PostPayoutReversedPayloadDataSource {
...
impl fmt::Display for PostPayoutReversedPayloadDataSource {
