...
pub enum ListAdGroupsRequestOrder {
    CreatedAt,
    UpdatedAt,
    Spend,
    Impressions,
...
impl Serialize for ListAdGroupsRequestOrder {
...
impl<'de> Deserialize<'de> for ListAdGroupsRequestOrder {
...
impl fmt::Display for ListAdGroupsRequestOrder {
