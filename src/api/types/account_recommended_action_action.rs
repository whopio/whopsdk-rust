...
pub enum AccountRecommendedActionAction {
    ThemeBusiness,
    CreateProduct,
    CreatePlan,
    VerifyIdentity,
...
impl Serialize for AccountRecommendedActionAction {
...
impl<'de> Deserialize<'de> for AccountRecommendedActionAction {
...
impl fmt::Display for AccountRecommendedActionAction {
