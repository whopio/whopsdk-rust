...
pub enum CreatePayoutsResponsePayoutMethodSupportedPayoutMethodDeliveryType {
    CashPickup,
    BankDeposit,
    HomeDelivery,
    MobileWallet,
...
impl Serialize for CreatePayoutsResponsePayoutMethodSupportedPayoutMethodDeliveryType {
...
impl<'de> Deserialize<'de> for CreatePayoutsResponsePayoutMethodSupportedPayoutMethodDeliveryType {
...
impl fmt::Display for CreatePayoutsResponsePayoutMethodSupportedPayoutMethodDeliveryType {
