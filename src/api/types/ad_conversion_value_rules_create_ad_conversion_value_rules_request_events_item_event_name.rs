...
pub enum CreateAdConversionValueRulesRequestEventsItemEventName {
    Purchase,
    Subscribe,
    StartTrial,
    Lead,
...
impl Serialize for CreateAdConversionValueRulesRequestEventsItemEventName {
...
impl<'de> Deserialize<'de> for CreateAdConversionValueRulesRequestEventsItemEventName {
...
impl fmt::Display for CreateAdConversionValueRulesRequestEventsItemEventName {
