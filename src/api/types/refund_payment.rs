...
pub struct RefundPayment {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub member: Option<RefundPaymentMember>,
    /// The membership attached to this payment.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub membership: Option<RefundPaymentMembership>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub plan: Option<RefundPaymentPlan>,
    /// The product this payment was made for
    #[serde(skip_serializing_if = "Option::is_none")]
    pub product: Option<RefundPaymentProduct>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub user: Option<RefundPaymentUser>,
}

impl RefundPayment {
    pub fn builder() -> RefundPaymentBuilder {
        <RefundPaymentBuilder as Default>::default()
    }
}
...
pub struct RefundPaymentBuilder {
    ...
    id: Option<String>,
    member: Option<RefundPaymentMember>,
    membership: Option<RefundPaymentMembership>,
    metadata: Option<HashMap<String, serde_json::Value>>,
    paid_at: Option<DateTime<FixedOffset>>,
    payment_method_type: Option<PaymentMethodTypes>,
    plan: Option<RefundPaymentPlan>,
    product: Option<RefundPaymentProduct>,
    subtotal: Option<f64>,
...
impl RefundPaymentBuilder {
    ...
    pub fn member(mut self, value: RefundPaymentMember) -> Self {
        self.member = Some(value);
        self
    }

    pub fn membership(mut self, value: RefundPaymentMembership) -> Self {
    ...
    pub fn plan(mut self, value: RefundPaymentPlan) -> Self {
        self.plan = Some(value);
        self
    }

    pub fn product(mut self, value: RefundPaymentProduct) -> Self {
    ...
    pub fn user(mut self, value: RefundPaymentUser) -> Self {
        self.user = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`RefundPayment`].
    /// This method will fail if any of the following fields are not set:
    /// - [`created_at`](RefundPaymentBuilder::created_at)
    /// - [`currency`](RefundPaymentBuilder::currency)
    /// - [`id`](RefundPaymentBuilder::id)
    pub fn build(self) -> Result<RefundPayment, BuildError> {
        Ok(RefundPayment {
