...
pub struct CreateInvoicesRequestProductIdPlanPaymentMethodConfiguration {
...
impl CreateInvoicesRequestProductIdPlanPaymentMethodConfiguration {
    pub fn builder() -> CreateInvoicesRequestProductIdPlanPaymentMethodConfigurationBuilder {
        <CreateInvoicesRequestProductIdPlanPaymentMethodConfigurationBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateInvoicesRequestProductIdPlanPaymentMethodConfigurationBuilder {
    disabled: Option<Vec<PaymentMethodTypes>>,
    enabled: Option<Vec<PaymentMethodTypes>>,
    include_platform_defaults: Option<bool>,
}

impl CreateInvoicesRequestProductIdPlanPaymentMethodConfigurationBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateInvoicesRequestProductIdPlanPaymentMethodConfiguration`].
    /// This method will fail if any of the following fields are not set:
    /// - [`disabled`](CreateInvoicesRequestProductIdPlanPaymentMethodConfigurationBuilder::disabled)
    /// - [`enabled`](CreateInvoicesRequestProductIdPlanPaymentMethodConfigurationBuilder::enabled)
    pub fn build(
        self,
    ) -> Result<CreateInvoicesRequestProductIdPlanPaymentMethodConfiguration, BuildError> {
        Ok(
