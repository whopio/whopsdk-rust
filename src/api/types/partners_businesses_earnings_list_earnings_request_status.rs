...
pub enum ListEarningsRequestStatus {
    AwaitingSettlement,
    Pending,
    Completed,
    Canceled,
...
impl Serialize for ListEarningsRequestStatus {
...
impl<'de> Deserialize<'de> for ListEarningsRequestStatus {
...
impl fmt::Display for ListEarningsRequestStatus {
