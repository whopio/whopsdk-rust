...
pub enum PostWithdrawalReversedPayloadDataSource {
    Api,
    Dashboard,
    Automatic,
...
impl Serialize for PostWithdrawalReversedPayloadDataSource {
...
impl<'de> Deserialize<'de> for PostWithdrawalReversedPayloadDataSource {
...
impl fmt::Display for PostWithdrawalReversedPayloadDataSource {
