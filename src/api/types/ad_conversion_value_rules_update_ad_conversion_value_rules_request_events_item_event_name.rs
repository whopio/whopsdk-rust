...
pub enum UpdateAdConversionValueRulesRequestEventsItemEventName {
    Purchase,
    Subscribe,
    StartTrial,
    Lead,
...
impl Serialize for UpdateAdConversionValueRulesRequestEventsItemEventName {
...
impl<'de> Deserialize<'de> for UpdateAdConversionValueRulesRequestEventsItemEventName {
...
impl fmt::Display for UpdateAdConversionValueRulesRequestEventsItemEventName {
