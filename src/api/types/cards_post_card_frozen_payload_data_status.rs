...
pub enum PostCardFrozenPayloadDataStatus {
    Active,
    Frozen,
    Canceled,
    Invited,
...
impl Serialize for PostCardFrozenPayloadDataStatus {
...
impl<'de> Deserialize<'de> for PostCardFrozenPayloadDataStatus {
...
impl fmt::Display for PostCardFrozenPayloadDataStatus {
