...
pub struct SetupIntentListItemPaymentMethodCard {
...
impl SetupIntentListItemPaymentMethodCard {
    pub fn builder() -> SetupIntentListItemPaymentMethodCardBuilder {
        <SetupIntentListItemPaymentMethodCardBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct SetupIntentListItemPaymentMethodCardBuilder {
...
impl SetupIntentListItemPaymentMethodCardBuilder {
    ...
    /// Consumes the builder and constructs a [`SetupIntentListItemPaymentMethodCard`].
    pub fn build(self) -> Result<SetupIntentListItemPaymentMethodCard, BuildError> {
        Ok(SetupIntentListItemPaymentMethodCard {
            brand: self.brand,
