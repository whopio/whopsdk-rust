...
pub enum PaymentRuleConditionOperator {
    Eq,
    Neq,
    Gt,
    Gte,
...
impl Serialize for PaymentRuleConditionOperator {
...
impl<'de> Deserialize<'de> for PaymentRuleConditionOperator {
...
impl fmt::Display for PaymentRuleConditionOperator {
