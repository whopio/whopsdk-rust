...
pub struct RefundLegacy {
    ...
    pub payment: Option<RefundLegacyPayment>,
...
impl RefundLegacy {
    pub fn builder() -> RefundLegacyBuilder {
        <RefundLegacyBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct RefundLegacyBuilder {
    amount: Option<f64>,
    created_at: Option<DateTime<FixedOffset>>,
    currency: Option<Currencies>,
    id: Option<String>,
    payment: Option<RefundLegacyPayment>,
...
impl RefundLegacyBuilder {
    ...
    pub fn payment(mut self, value: RefundLegacyPayment) -> Self {
    ...
    /// Consumes the builder and constructs a [`RefundLegacy`].
    /// This method will fail if any of the following fields are not set:
    /// - [`amount`](RefundLegacyBuilder::amount)
    /// - [`created_at`](RefundLegacyBuilder::created_at)
    /// - [`currency`](RefundLegacyBuilder::currency)
    /// - [`id`](RefundLegacyBuilder::id)
    /// - [`provider`](RefundLegacyBuilder::provider)
    /// - [`status`](RefundLegacyBuilder::status)
    pub fn build(self) -> Result<RefundLegacy, BuildError> {
        Ok(RefundLegacy {
            amount: self
                .amount
