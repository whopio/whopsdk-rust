...
pub enum CreateAdCampaignsRequestBudgetType {
    Daily,
    Lifetime,
...
impl Serialize for CreateAdCampaignsRequestBudgetType {
...
impl<'de> Deserialize<'de> for CreateAdCampaignsRequestBudgetType {
...
impl fmt::Display for CreateAdCampaignsRequestBudgetType {
