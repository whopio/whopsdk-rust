...
pub enum ListAudiencesRequestSourceType {
    CsvUpload,
    PeopleFilter,
...
impl Serialize for ListAudiencesRequestSourceType {
...
impl<'de> Deserialize<'de> for ListAudiencesRequestSourceType {
...
impl fmt::Display for ListAudiencesRequestSourceType {
