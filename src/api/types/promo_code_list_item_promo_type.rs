...
pub enum PromoCodeListItemPromoType {
    Percentage,
    FlatAmount,
...
impl Serialize for PromoCodeListItemPromoType {
...
impl<'de> Deserialize<'de> for PromoCodeListItemPromoType {
...
impl fmt::Display for PromoCodeListItemPromoType {
