...
pub struct MemberLegacy {
    ...
    #[serde(default)]
    pub company: MemberLegacyCompany,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub user: Option<MemberLegacyUser>,
}

impl MemberLegacy {
    pub fn builder() -> MemberLegacyBuilder {
        <MemberLegacyBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct MemberLegacyBuilder {
    access_level: Option<AccessLevel>,
    company: Option<MemberLegacyCompany>,
    ...
    user: Option<MemberLegacyUser>,
}

impl MemberLegacyBuilder {
    pub fn access_level(mut self, value: AccessLevel) -> Self {
        self.access_level = Some(value);
        self
    }

    pub fn company(mut self, value: MemberLegacyCompany) -> Self {
    ...
    pub fn user(mut self, value: MemberLegacyUser) -> Self {
        self.user = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`MemberLegacy`].
    /// This method will fail if any of the following fields are not set:
    /// - [`access_level`](MemberLegacyBuilder::access_level)
    /// - [`company`](MemberLegacyBuilder::company)
    /// - [`company_token_balance`](MemberLegacyBuilder::company_token_balance)
    /// - [`created_at`](MemberLegacyBuilder::created_at)
    /// - [`id`](MemberLegacyBuilder::id)
    /// - [`joined_at`](MemberLegacyBuilder::joined_at)
    /// - [`status`](MemberLegacyBuilder::status)
    /// - [`updated_at`](MemberLegacyBuilder::updated_at)
    /// - [`usd_total_spent`](MemberLegacyBuilder::usd_total_spent)
    pub fn build(self) -> Result<MemberLegacy, BuildError> {
        Ok(MemberLegacy {
            access_level: self
                .access_level
