...
pub enum GenerateMediaRequestResolution {
    FourHundredEightyP,
    SevenHundredTwentyP,
    OneThousandEightyP,
    FourK,
...
impl Serialize for GenerateMediaRequestResolution {
...
impl<'de> Deserialize<'de> for GenerateMediaRequestResolution {
...
impl fmt::Display for GenerateMediaRequestResolution {
