...
pub enum CreatePayoutsRequestBodySpeed {
    Standard,
    Instant,
...
impl Serialize for CreatePayoutsRequestBodySpeed {
...
impl<'de> Deserialize<'de> for CreatePayoutsRequestBodySpeed {
...
impl fmt::Display for CreatePayoutsRequestBodySpeed {
