...
pub struct PaymentListItemPromoCode {
...
impl PaymentListItemPromoCode {
    pub fn builder() -> PaymentListItemPromoCodeBuilder {
        <PaymentListItemPromoCodeBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PaymentListItemPromoCodeBuilder {
...
impl PaymentListItemPromoCodeBuilder {
    ...
    /// Consumes the builder and constructs a [`PaymentListItemPromoCode`].
    /// This method will fail if any of the following fields are not set:
    /// - [`amount_off`](PaymentListItemPromoCodeBuilder::amount_off)
    /// - [`base_currency`](PaymentListItemPromoCodeBuilder::base_currency)
    /// - [`id`](PaymentListItemPromoCodeBuilder::id)
    /// - [`promo_type`](PaymentListItemPromoCodeBuilder::promo_type)
    pub fn build(self) -> Result<PaymentListItemPromoCode, BuildError> {
        Ok(PaymentListItemPromoCode {
            amount_off: self
                .amount_off
