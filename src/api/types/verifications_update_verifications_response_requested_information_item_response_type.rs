...
pub enum UpdateVerificationsResponseRequestedInformationItemResponseType {
    YesNo,
    YesNoNa,
    Date,
    Url,
...
impl Serialize for UpdateVerificationsResponseRequestedInformationItemResponseType {
...
impl<'de> Deserialize<'de> for UpdateVerificationsResponseRequestedInformationItemResponseType {
...
impl fmt::Display for UpdateVerificationsResponseRequestedInformationItemResponseType {
