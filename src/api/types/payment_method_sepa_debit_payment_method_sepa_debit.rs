...
pub struct PaymentMethodSepaDebitPaymentMethodSepaDebit {
...
impl PaymentMethodSepaDebitPaymentMethodSepaDebit {
    pub fn builder() -> PaymentMethodSepaDebitPaymentMethodSepaDebitBuilder {
        <PaymentMethodSepaDebitPaymentMethodSepaDebitBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PaymentMethodSepaDebitPaymentMethodSepaDebitBuilder {
...
impl PaymentMethodSepaDebitPaymentMethodSepaDebitBuilder {
    ...
    /// Consumes the builder and constructs a [`PaymentMethodSepaDebitPaymentMethodSepaDebit`].
    pub fn build(self) -> Result<PaymentMethodSepaDebitPaymentMethodSepaDebit, BuildError> {
        Ok(PaymentMethodSepaDebitPaymentMethodSepaDebit {
