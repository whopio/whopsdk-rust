...
pub enum ListMethodsResponseDataItemStatus {
    Created,
    Active,
    Broken,
...
impl Serialize for ListMethodsResponseDataItemStatus {
...
impl<'de> Deserialize<'de> for ListMethodsResponseDataItemStatus {
...
impl fmt::Display for ListMethodsResponseDataItemStatus {
