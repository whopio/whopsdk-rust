...
pub enum AccountStorePageConfigAccentColor {
    Ruby,
    Tomato,
    Red,
    Crimson,
...
impl Serialize for AccountStorePageConfigAccentColor {
...
impl<'de> Deserialize<'de> for AccountStorePageConfigAccentColor {
...
impl fmt::Display for AccountStorePageConfigAccentColor {
