...
pub enum ListPayoutsRequestStatus {
    Requested,
    InReview,
    Processing,
    Completed,
...
impl Serialize for ListPayoutsRequestStatus {
...
impl<'de> Deserialize<'de> for ListPayoutsRequestStatus {
...
impl fmt::Display for ListPayoutsRequestStatus {
