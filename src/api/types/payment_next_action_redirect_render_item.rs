...
pub enum PaymentNextActionRedirectRenderItem {
    Inline,
    FullPage,
...
impl Serialize for PaymentNextActionRedirectRenderItem {
...
impl<'de> Deserialize<'de> for PaymentNextActionRedirectRenderItem {
...
impl fmt::Display for PaymentNextActionRedirectRenderItem {
