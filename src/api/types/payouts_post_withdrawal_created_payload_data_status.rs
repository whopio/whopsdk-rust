...
pub enum PostWithdrawalCreatedPayloadDataStatus {
    Requested,
    InReview,
    Processing,
    Completed,
...
impl Serialize for PostWithdrawalCreatedPayloadDataStatus {
...
impl<'de> Deserialize<'de> for PostWithdrawalCreatedPayloadDataStatus {
...
impl fmt::Display for PostWithdrawalCreatedPayloadDataStatus {
