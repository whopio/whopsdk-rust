...
pub enum SearchTargetingOptionsAdGroupsRequestSpecialAdCategoriesItem {
    Housing,
    Employment,
    FinancialProducts,
    Politics,
...
impl Serialize for SearchTargetingOptionsAdGroupsRequestSpecialAdCategoriesItem {
...
impl<'de> Deserialize<'de> for SearchTargetingOptionsAdGroupsRequestSpecialAdCategoriesItem {
...
impl fmt::Display for SearchTargetingOptionsAdGroupsRequestSpecialAdCategoriesItem {
