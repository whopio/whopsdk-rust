...
pub struct PostCardCreatedPayloadDataSecrets {
    /// Full card number.
    #[serde(default)]
...
impl PostCardCreatedPayloadDataSecrets {
    pub fn builder() -> PostCardCreatedPayloadDataSecretsBuilder {
        <PostCardCreatedPayloadDataSecretsBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostCardCreatedPayloadDataSecretsBuilder {
...
impl PostCardCreatedPayloadDataSecretsBuilder {
    ...
    /// Consumes the builder and constructs a [`PostCardCreatedPayloadDataSecrets`].
    /// This method will fail if any of the following fields are not set:
    /// - [`card_number`](PostCardCreatedPayloadDataSecretsBuilder::card_number)
    /// - [`cvc`](PostCardCreatedPayloadDataSecretsBuilder::cvc)
    pub fn build(self) -> Result<PostCardCreatedPayloadDataSecrets, BuildError> {
        Ok(PostCardCreatedPayloadDataSecrets {
            card_number: self
                .card_number
