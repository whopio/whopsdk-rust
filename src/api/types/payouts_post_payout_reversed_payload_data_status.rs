...
pub enum PostPayoutReversedPayloadDataStatus {
    Requested,
    InReview,
    Processing,
    Completed,
...
impl Serialize for PostPayoutReversedPayloadDataStatus {
...
impl<'de> Deserialize<'de> for PostPayoutReversedPayloadDataStatus {
...
impl fmt::Display for PostPayoutReversedPayloadDataStatus {
