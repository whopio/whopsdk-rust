...
pub enum CreateAdsRequestLeadFormQuestionsItemType {
    Email,
    Phone,
    FullName,
    FirstName,
...
impl Serialize for CreateAdsRequestLeadFormQuestionsItemType {
...
impl<'de> Deserialize<'de> for CreateAdsRequestLeadFormQuestionsItemType {
...
impl fmt::Display for CreateAdsRequestLeadFormQuestionsItemType {
