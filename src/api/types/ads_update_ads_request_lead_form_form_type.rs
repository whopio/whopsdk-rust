...
pub enum UpdateAdsRequestLeadFormFormType {
    MoreVolume,
    HigherIntent,
...
impl Serialize for UpdateAdsRequestLeadFormFormType {
...
impl<'de> Deserialize<'de> for UpdateAdsRequestLeadFormFormType {
...
impl fmt::Display for UpdateAdsRequestLeadFormFormType {
