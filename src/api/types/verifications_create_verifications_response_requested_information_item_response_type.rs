...
pub enum CreateVerificationsResponseRequestedInformationItemResponseType {
    YesNo,
    YesNoNa,
    Date,
    Url,
...
impl Serialize for CreateVerificationsResponseRequestedInformationItemResponseType {
...
impl<'de> Deserialize<'de> for CreateVerificationsResponseRequestedInformationItemResponseType {
...
impl fmt::Display for CreateVerificationsResponseRequestedInformationItemResponseType {
