...
pub enum PermissionSystemRoles {
    Owner,
    Admin,
    Moderator,
    SalesManager,
...
impl Serialize for PermissionSystemRoles {
...
impl<'de> Deserialize<'de> for PermissionSystemRoles {
...
impl fmt::Display for PermissionSystemRoles {
