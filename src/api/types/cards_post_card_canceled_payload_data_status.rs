...
pub enum PostCardCanceledPayloadDataStatus {
    Active,
    Frozen,
    Canceled,
    Invited,
...
impl Serialize for PostCardCanceledPayloadDataStatus {
...
impl<'de> Deserialize<'de> for PostCardCanceledPayloadDataStatus {
...
impl fmt::Display for PostCardCanceledPayloadDataStatus {
