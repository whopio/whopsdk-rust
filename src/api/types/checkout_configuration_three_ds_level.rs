...
pub enum CheckoutConfigurationThreeDsLevel {
    MandateChallenge,
    Frictionless,
...
impl Serialize for CheckoutConfigurationThreeDsLevel {
...
impl<'de> Deserialize<'de> for CheckoutConfigurationThreeDsLevel {
...
impl fmt::Display for CheckoutConfigurationThreeDsLevel {
