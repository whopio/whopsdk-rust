...
pub struct CardTransactionListItem {
...
impl CardTransactionListItem {
    pub fn builder() -> CardTransactionListItemBuilder {
        <CardTransactionListItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CardTransactionListItemBuilder {
...
impl CardTransactionListItemBuilder {
    ...
    /// Consumes the builder and constructs a [`CardTransactionListItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`card_id`](CardTransactionListItemBuilder::card_id)
    /// - [`created_at`](CardTransactionListItemBuilder::created_at)
    /// - [`id`](CardTransactionListItemBuilder::id)
    /// - [`international`](CardTransactionListItemBuilder::international)
    /// - [`status`](CardTransactionListItemBuilder::status)
    /// - [`transaction_type`](CardTransactionListItemBuilder::transaction_type)
    pub fn build(self) -> Result<CardTransactionListItem, BuildError> {
        Ok(CardTransactionListItem {
