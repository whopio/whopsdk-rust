...
pub struct CreateVerificationsResponseRequestedInformationItem {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub errors: Option<Vec<CreateVerificationsResponseRequestedInformationItemErrorsItem>>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub response_type: Option<CreateVerificationsResponseRequestedInformationItemResponseType>,
    /// Whether a question with `options` accepts one value or multiple values.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub selection_mode: Option<CreateVerificationsResponseRequestedInformationItemSelectionMode>,
...
impl CreateVerificationsResponseRequestedInformationItem {
    pub fn builder() -> CreateVerificationsResponseRequestedInformationItemBuilder {
        <CreateVerificationsResponseRequestedInformationItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateVerificationsResponseRequestedInformationItemBuilder {
    action_url: Option<String>,
    details_label: Option<String>,
    details_required: Option<bool>,
    details_visible_for: Option<Vec<String>>,
    errors: Option<Vec<CreateVerificationsResponseRequestedInformationItemErrorsItem>>,
    id: Option<String>,
    label: Option<String>,
    optional: Option<bool>,
    options: Option<Vec<String>>,
    requirement: Option<String>,
    response_type: Option<CreateVerificationsResponseRequestedInformationItemResponseType>,
    selection_mode: Option<CreateVerificationsResponseRequestedInformationItemSelectionMode>,
...
impl CreateVerificationsResponseRequestedInformationItemBuilder {
    ...
    pub fn errors(
        mut self,
        value: Vec<CreateVerificationsResponseRequestedInformationItemErrorsItem>,
    ) -> Self {
    ...
    pub fn response_type(
        mut self,
        value: CreateVerificationsResponseRequestedInformationItemResponseType,
    ) -> Self {
    ...
    pub fn selection_mode(
        mut self,
        value: CreateVerificationsResponseRequestedInformationItemSelectionMode,
    ) -> Self {
    ...
    /// Consumes the builder and constructs a [`CreateVerificationsResponseRequestedInformationItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](CreateVerificationsResponseRequestedInformationItemBuilder::id)
    /// - [`label`](CreateVerificationsResponseRequestedInformationItemBuilder::label)
    /// - [`requirement`](CreateVerificationsResponseRequestedInformationItemBuilder::requirement)
    /// - [`r#type`](CreateVerificationsResponseRequestedInformationItemBuilder::r#type)
    pub fn build(self) -> Result<CreateVerificationsResponseRequestedInformationItem, BuildError> {
        Ok(CreateVerificationsResponseRequestedInformationItem {
