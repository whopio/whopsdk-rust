...
pub enum RetrieveSwapsResponseStatus {
    Queued,
    Working,
    Complete,
    Failed,
...
impl Serialize for RetrieveSwapsResponseStatus {
...
impl<'de> Deserialize<'de> for RetrieveSwapsResponseStatus {
...
impl fmt::Display for RetrieveSwapsResponseStatus {
