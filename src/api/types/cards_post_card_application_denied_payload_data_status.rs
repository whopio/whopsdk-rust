...
pub enum PostCardApplicationDeniedPayloadDataStatus {
    Approved,
    Pending,
    ManualReview,
    Denied,
...
impl Serialize for PostCardApplicationDeniedPayloadDataStatus {
...
impl<'de> Deserialize<'de> for PostCardApplicationDeniedPayloadDataStatus {
...
impl fmt::Display for PostCardApplicationDeniedPayloadDataStatus {
