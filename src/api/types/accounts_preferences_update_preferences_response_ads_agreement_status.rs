...
pub enum UpdatePreferencesResponseAdsAgreementStatus {
    NotRequired,
    PendingSignature,
    Signed,
...
impl Serialize for UpdatePreferencesResponseAdsAgreementStatus {
...
impl<'de> Deserialize<'de> for UpdatePreferencesResponseAdsAgreementStatus {
...
impl fmt::Display for UpdatePreferencesResponseAdsAgreementStatus {
