...
pub enum RetrieveVerificationsResponseRequestedInformationItemResponseType {
    YesNo,
    YesNoNa,
    Date,
    Url,
...
impl Serialize for RetrieveVerificationsResponseRequestedInformationItemResponseType {
...
impl<'de> Deserialize<'de> for RetrieveVerificationsResponseRequestedInformationItemResponseType {
...
impl fmt::Display for RetrieveVerificationsResponseRequestedInformationItemResponseType {
