...
pub struct CreateInvoicesRequestProductPlanPaymentMethodConfiguration {
...
impl CreateInvoicesRequestProductPlanPaymentMethodConfiguration {
    pub fn builder() -> CreateInvoicesRequestProductPlanPaymentMethodConfigurationBuilder {
        <CreateInvoicesRequestProductPlanPaymentMethodConfigurationBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateInvoicesRequestProductPlanPaymentMethodConfigurationBuilder {
    disabled: Option<Vec<PaymentMethodTypes>>,
    enabled: Option<Vec<PaymentMethodTypes>>,
    include_platform_defaults: Option<bool>,
}

impl CreateInvoicesRequestProductPlanPaymentMethodConfigurationBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateInvoicesRequestProductPlanPaymentMethodConfiguration`].
    /// This method will fail if any of the following fields are not set:
    /// - [`disabled`](CreateInvoicesRequestProductPlanPaymentMethodConfigurationBuilder::disabled)
    /// - [`enabled`](CreateInvoicesRequestProductPlanPaymentMethodConfigurationBuilder::enabled)
    pub fn build(
        self,
    ) -> Result<CreateInvoicesRequestProductPlanPaymentMethodConfiguration, BuildError> {
        Ok(CreateInvoicesRequestProductPlanPaymentMethodConfiguration {
            disabled: self
                .disabled
