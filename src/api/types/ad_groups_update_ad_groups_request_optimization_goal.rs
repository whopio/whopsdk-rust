...
pub enum UpdateAdGroupsRequestOptimizationGoal {
    Conversions,
    LinkClicks,
    LandingPageViews,
    Reach,
...
impl Serialize for UpdateAdGroupsRequestOptimizationGoal {
...
impl<'de> Deserialize<'de> for UpdateAdGroupsRequestOptimizationGoal {
...
impl fmt::Display for UpdateAdGroupsRequestOptimizationGoal {
