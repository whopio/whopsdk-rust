...
pub enum UpdateAdsRequestPostSource {
    Facebook,
    Instagram,
...
impl Serialize for UpdateAdsRequestPostSource {
...
impl<'de> Deserialize<'de> for UpdateAdsRequestPostSource {
...
impl fmt::Display for UpdateAdsRequestPostSource {
