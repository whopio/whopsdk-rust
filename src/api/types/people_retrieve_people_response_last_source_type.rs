...
pub enum RetrievePeopleResponseLastSourceType {
    AdClick,
    LeadForm,
    ExternalAdClick,
    Referrer,
...
impl Serialize for RetrievePeopleResponseLastSourceType {
...
impl<'de> Deserialize<'de> for RetrievePeopleResponseLastSourceType {
...
impl fmt::Display for RetrievePeopleResponseLastSourceType {
