...
pub enum CreatePaymentsRequestPlanProductVisibility {
    Visible,
    Hidden,
    Archived,
    QuickLink,
...
impl Serialize for CreatePaymentsRequestPlanProductVisibility {
...
impl<'de> Deserialize<'de> for CreatePaymentsRequestPlanProductVisibility {
...
impl fmt::Display for CreatePaymentsRequestPlanProductVisibility {
