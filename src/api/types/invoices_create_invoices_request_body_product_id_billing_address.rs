...
pub struct CreateInvoicesRequestBodyProductIdBillingAddress {
...
impl CreateInvoicesRequestBodyProductIdBillingAddress {
    pub fn builder() -> CreateInvoicesRequestBodyProductIdBillingAddressBuilder {
        <CreateInvoicesRequestBodyProductIdBillingAddressBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateInvoicesRequestBodyProductIdBillingAddressBuilder {
    city: Option<String>,
...
impl CreateInvoicesRequestBodyProductIdBillingAddressBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateInvoicesRequestBodyProductIdBillingAddress`].
    pub fn build(self) -> Result<CreateInvoicesRequestBodyProductIdBillingAddress, BuildError> {
        Ok(CreateInvoicesRequestBodyProductIdBillingAddress {
            city: self.city,
