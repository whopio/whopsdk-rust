...
pub struct PostPayoutReversedPayloadDataFailure {
...
impl PostPayoutReversedPayloadDataFailure {
    pub fn builder() -> PostPayoutReversedPayloadDataFailureBuilder {
        <PostPayoutReversedPayloadDataFailureBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostPayoutReversedPayloadDataFailureBuilder {
    code: Option<String>,
    funds_returned_at: Option<DateTime<FixedOffset>>,
    message: Option<String>,
}

impl PostPayoutReversedPayloadDataFailureBuilder {
    ...
    /// Consumes the builder and constructs a [`PostPayoutReversedPayloadDataFailure`].
    pub fn build(self) -> Result<PostPayoutReversedPayloadDataFailure, BuildError> {
        Ok(PostPayoutReversedPayloadDataFailure {
            code: self.code,
