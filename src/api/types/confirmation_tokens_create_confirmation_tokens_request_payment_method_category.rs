...
pub enum CreateConfirmationTokensRequestPaymentMethodCategory {
    Card,
    Wallet,
    BankDebit,
    BankTransfer,
...
impl Serialize for CreateConfirmationTokensRequestPaymentMethodCategory {
...
impl<'de> Deserialize<'de> for CreateConfirmationTokensRequestPaymentMethodCategory {
...
impl fmt::Display for CreateConfirmationTokensRequestPaymentMethodCategory {
