...
pub struct ListCardsResponseDataItemSecrets {
    /// Full card number.
    #[serde(default)]
...
impl ListCardsResponseDataItemSecrets {
    pub fn builder() -> ListCardsResponseDataItemSecretsBuilder {
        <ListCardsResponseDataItemSecretsBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListCardsResponseDataItemSecretsBuilder {
...
impl ListCardsResponseDataItemSecretsBuilder {
    ...
    /// Consumes the builder and constructs a [`ListCardsResponseDataItemSecrets`].
    /// This method will fail if any of the following fields are not set:
    /// - [`card_number`](ListCardsResponseDataItemSecretsBuilder::card_number)
    /// - [`cvc`](ListCardsResponseDataItemSecretsBuilder::cvc)
    pub fn build(self) -> Result<ListCardsResponseDataItemSecrets, BuildError> {
        Ok(ListCardsResponseDataItemSecrets {
            card_number: self
                .card_number
