...
pub struct CreatePaymentsRequestBodyZero {
    ...
    pub plan: CreatePaymentsRequestBodyZeroPlan,
...
impl CreatePaymentsRequestBodyZero {
    pub fn builder() -> CreatePaymentsRequestBodyZeroBuilder {
        <CreatePaymentsRequestBodyZeroBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreatePaymentsRequestBodyZeroBuilder {
    capture: Option<bool>,
    ...
    plan: Option<CreatePaymentsRequestBodyZeroPlan>,
    promo_code_id: Option<String>,
    return_url: Option<String>,
}

impl CreatePaymentsRequestBodyZeroBuilder {
    ...
    pub fn plan(mut self, value: CreatePaymentsRequestBodyZeroPlan) -> Self {
    ...
    /// Consumes the builder and constructs a [`CreatePaymentsRequestBodyZero`].
    /// This method will fail if any of the following fields are not set:
    /// - [`company_id`](CreatePaymentsRequestBodyZeroBuilder::company_id)
    /// - [`confirmation_token`](CreatePaymentsRequestBodyZeroBuilder::confirmation_token)
    /// - [`plan`](CreatePaymentsRequestBodyZeroBuilder::plan)
    pub fn build(self) -> Result<CreatePaymentsRequestBodyZero, BuildError> {
        Ok(CreatePaymentsRequestBodyZero {
