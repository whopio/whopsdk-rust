...
pub enum PostWithdrawalCreatedPayloadDataSource {
    Api,
    Dashboard,
    Automatic,
...
impl Serialize for PostWithdrawalCreatedPayloadDataSource {
...
impl<'de> Deserialize<'de> for PostWithdrawalCreatedPayloadDataSource {
...
impl fmt::Display for PostWithdrawalCreatedPayloadDataSource {
