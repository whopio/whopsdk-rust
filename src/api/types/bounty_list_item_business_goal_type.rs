...
pub enum BountyListItemBusinessGoalType {
    Clipping,
    PostEngagement,
    OwnedAccountGrowth,
    UgcContent,
...
impl Serialize for BountyListItemBusinessGoalType {
...
impl<'de> Deserialize<'de> for BountyListItemBusinessGoalType {
...
impl fmt::Display for BountyListItemBusinessGoalType {
