...
pub enum UpdateApiKeysRequestPermissionsSystemRole {
    Owner,
    Admin,
    Moderator,
    SalesManager,
...
impl Serialize for UpdateApiKeysRequestPermissionsSystemRole {
...
impl<'de> Deserialize<'de> for UpdateApiKeysRequestPermissionsSystemRole {
...
impl fmt::Display for UpdateApiKeysRequestPermissionsSystemRole {
