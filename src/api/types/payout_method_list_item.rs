...
pub struct PayoutMethodListItem {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub company: Option<PayoutMethodListItemCompany>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub destination: Option<PayoutMethodListItemDestination>,
...
impl PayoutMethodListItem {
    pub fn builder() -> PayoutMethodListItemBuilder {
        <PayoutMethodListItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PayoutMethodListItemBuilder {
    account_reference: Option<String>,
    company: Option<PayoutMethodListItemCompany>,
    created_at: Option<DateTime<FixedOffset>>,
    currency: Option<String>,
    destination: Option<PayoutMethodListItemDestination>,
    id: Option<String>,
...
impl PayoutMethodListItemBuilder {
    ...
    pub fn destination(mut self, value: PayoutMethodListItemDestination) -> Self {
    ...
    /// Consumes the builder and constructs a [`PayoutMethodListItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`created_at`](PayoutMethodListItemBuilder::created_at)
    /// - [`currency`](PayoutMethodListItemBuilder::currency)
    /// - [`id`](PayoutMethodListItemBuilder::id)
    /// - [`is_default`](PayoutMethodListItemBuilder::is_default)
    pub fn build(self) -> Result<PayoutMethodListItem, BuildError> {
        Ok(PayoutMethodListItem {
