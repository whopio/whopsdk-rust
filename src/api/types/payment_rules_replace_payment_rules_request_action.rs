...
pub enum ReplacePaymentRulesRequestAction {
    Allow,
    Block,
    Enforce3Ds,
...
impl Serialize for ReplacePaymentRulesRequestAction {
...
impl<'de> Deserialize<'de> for ReplacePaymentRulesRequestAction {
...
impl fmt::Display for ReplacePaymentRulesRequestAction {
