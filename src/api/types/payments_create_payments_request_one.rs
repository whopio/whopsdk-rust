...
pub struct CreatePaymentsRequestOne {
    ...
    pub plan: CreatePaymentsRequestOnePlan,
...
impl CreatePaymentsRequestOne {
    pub fn builder() -> CreatePaymentsRequestOneBuilder {
        <CreatePaymentsRequestOneBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreatePaymentsRequestOneBuilder {
    company_id: Option<String>,
    email: Option<String>,
    member_id: Option<String>,
    metadata: Option<HashMap<String, serde_json::Value>>,
    payment_method_id: Option<String>,
    plan: Option<CreatePaymentsRequestOnePlan>,
    promo_code_id: Option<String>,
    return_url: Option<String>,
}

impl CreatePaymentsRequestOneBuilder {
    ...
    pub fn plan(mut self, value: CreatePaymentsRequestOnePlan) -> Self {
    ...
    /// Consumes the builder and constructs a [`CreatePaymentsRequestOne`].
    /// This method will fail if any of the following fields are not set:
    /// - [`company_id`](CreatePaymentsRequestOneBuilder::company_id)
    /// - [`member_id`](CreatePaymentsRequestOneBuilder::member_id)
    /// - [`plan`](CreatePaymentsRequestOneBuilder::plan)
    pub fn build(self) -> Result<CreatePaymentsRequestOne, BuildError> {
        Ok(CreatePaymentsRequestOne {
            company_id: self
                .company_id
