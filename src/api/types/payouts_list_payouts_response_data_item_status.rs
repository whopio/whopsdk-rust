...
pub enum ListPayoutsResponseDataItemStatus {
    Requested,
    InReview,
    Processing,
    Completed,
...
impl Serialize for ListPayoutsResponseDataItemStatus {
...
impl<'de> Deserialize<'de> for ListPayoutsResponseDataItemStatus {
...
impl fmt::Display for ListPayoutsResponseDataItemStatus {
