...
pub enum CreatePlansRequestThreeDsLevel {
    MandateChallenge,
    Frictionless,
...
impl Serialize for CreatePlansRequestThreeDsLevel {
...
impl<'de> Deserialize<'de> for CreatePlansRequestThreeDsLevel {
...
impl fmt::Display for CreatePlansRequestThreeDsLevel {
