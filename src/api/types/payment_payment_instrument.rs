...
pub struct PaymentPaymentInstrument {
    /// Card payments only: the card's network and last four.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub card: Option<PaymentPaymentInstrumentCard>,
    ...
    #[serde(default)]
    pub icons: PaymentPaymentInstrumentIcons,
...
impl PaymentPaymentInstrument {
    pub fn builder() -> PaymentPaymentInstrumentBuilder {
        <PaymentPaymentInstrumentBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PaymentPaymentInstrumentBuilder {
    card: Option<PaymentPaymentInstrumentCard>,
    display_name: Option<String>,
    icons: Option<PaymentPaymentInstrumentIcons>,
    installment_count: Option<i64>,
    payment_method_type: Option<String>,
}

impl PaymentPaymentInstrumentBuilder {
    pub fn card(mut self, value: PaymentPaymentInstrumentCard) -> Self {
    ...
    pub fn icons(mut self, value: PaymentPaymentInstrumentIcons) -> Self {
    ...
    /// Consumes the builder and constructs a [`PaymentPaymentInstrument`].
    /// This method will fail if any of the following fields are not set:
    /// - [`display_name`](PaymentPaymentInstrumentBuilder::display_name)
    /// - [`icons`](PaymentPaymentInstrumentBuilder::icons)
    /// - [`payment_method_type`](PaymentPaymentInstrumentBuilder::payment_method_type)
    pub fn build(self) -> Result<PaymentPaymentInstrument, BuildError> {
        Ok(PaymentPaymentInstrument {
            card: self.card,
            display_name: self
                .display_name
