...
pub enum PostAdCampaignPaymentFailedPayloadDataBidType {
    MinimumCost,
    AverageTarget,
    MaximumTarget,
...
impl Serialize for PostAdCampaignPaymentFailedPayloadDataBidType {
...
impl<'de> Deserialize<'de> for PostAdCampaignPaymentFailedPayloadDataBidType {
...
impl fmt::Display for PostAdCampaignPaymentFailedPayloadDataBidType {
