...
pub enum CreateMethodsResponseSupportedPayoutMethodDeliveryType {
    CashPickup,
    BankDeposit,
    HomeDelivery,
    MobileWallet,
...
impl Serialize for CreateMethodsResponseSupportedPayoutMethodDeliveryType {
...
impl<'de> Deserialize<'de> for CreateMethodsResponseSupportedPayoutMethodDeliveryType {
...
impl fmt::Display for CreateMethodsResponseSupportedPayoutMethodDeliveryType {
