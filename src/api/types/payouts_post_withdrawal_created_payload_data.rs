...
pub struct PostWithdrawalCreatedPayloadData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub failure: Option<PostWithdrawalCreatedPayloadDataFailure>,
    ...
    pub fee_paid_by: PostWithdrawalCreatedPayloadDataFeePaidBy,
    ...
    pub object: PostWithdrawalCreatedPayloadDataObject,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub payout_method: Option<PostWithdrawalCreatedPayloadDataPayoutMethod>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub source: Option<PostWithdrawalCreatedPayloadDataSource>,
    /// Payout delivery speed.
    pub speed: PostWithdrawalCreatedPayloadDataSpeed,
    /// Current payout status.
    pub status: PostWithdrawalCreatedPayloadDataStatus,
...
impl PostWithdrawalCreatedPayloadData {
    pub fn builder() -> PostWithdrawalCreatedPayloadDataBuilder {
        <PostWithdrawalCreatedPayloadDataBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostWithdrawalCreatedPayloadDataBuilder {
    ...
    failure: Option<PostWithdrawalCreatedPayloadDataFailure>,
    fee_amount: Option<String>,
    fee_paid_by: Option<PostWithdrawalCreatedPayloadDataFeePaidBy>,
    id: Option<String>,
    markup_fee: Option<String>,
    metadata: Option<HashMap<String, String>>,
    net_amount: Option<String>,
    notes: Option<String>,
    object: Option<PostWithdrawalCreatedPayloadDataObject>,
    payer_name: Option<String>,
    payout_method: Option<PostWithdrawalCreatedPayloadDataPayoutMethod>,
    payout_request_id: Option<String>,
    source: Option<PostWithdrawalCreatedPayloadDataSource>,
    speed: Option<PostWithdrawalCreatedPayloadDataSpeed>,
    status: Option<PostWithdrawalCreatedPayloadDataStatus>,
    status_detail: Option<String>,
    trace_code: Option<String>,
}

impl PostWithdrawalCreatedPayloadDataBuilder {
    ...
    pub fn failure(mut self, value: PostWithdrawalCreatedPayloadDataFailure) -> Self {
    ...
    pub fn fee_paid_by(mut self, value: PostWithdrawalCreatedPayloadDataFeePaidBy) -> Self {
    ...
    pub fn object(mut self, value: PostWithdrawalCreatedPayloadDataObject) -> Self {
    ...
    pub fn payout_method(mut self, value: PostWithdrawalCreatedPayloadDataPayoutMethod) -> Self {
    ...
    pub fn source(mut self, value: PostWithdrawalCreatedPayloadDataSource) -> Self {
        self.source = Some(value);
        self
    }

    pub fn speed(mut self, value: PostWithdrawalCreatedPayloadDataSpeed) -> Self {
        self.speed = Some(value);
        self
    }

    pub fn status(mut self, value: PostWithdrawalCreatedPayloadDataStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostWithdrawalCreatedPayloadData`].
    /// This method will fail if any of the following fields are not set:
    /// - [`amount`](PostWithdrawalCreatedPayloadDataBuilder::amount)
    /// - [`created_at`](PostWithdrawalCreatedPayloadDataBuilder::created_at)
    /// - [`currency`](PostWithdrawalCreatedPayloadDataBuilder::currency)
    /// - [`fee_amount`](PostWithdrawalCreatedPayloadDataBuilder::fee_amount)
    /// - [`fee_paid_by`](PostWithdrawalCreatedPayloadDataBuilder::fee_paid_by)
    /// - [`id`](PostWithdrawalCreatedPayloadDataBuilder::id)
    /// - [`markup_fee`](PostWithdrawalCreatedPayloadDataBuilder::markup_fee)
    /// - [`metadata`](PostWithdrawalCreatedPayloadDataBuilder::metadata)
    /// - [`net_amount`](PostWithdrawalCreatedPayloadDataBuilder::net_amount)
    /// - [`object`](PostWithdrawalCreatedPayloadDataBuilder::object)
    /// - [`speed`](PostWithdrawalCreatedPayloadDataBuilder::speed)
    /// - [`status`](PostWithdrawalCreatedPayloadDataBuilder::status)
    /// - [`status_detail`](PostWithdrawalCreatedPayloadDataBuilder::status_detail)
    pub fn build(self) -> Result<PostWithdrawalCreatedPayloadData, BuildError> {
        Ok(PostWithdrawalCreatedPayloadData {
            amount: self
                .amount
