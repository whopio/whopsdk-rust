...
pub struct UpdateCardsResponse {
    ...
    pub billing: Option<UpdateCardsResponseBilling>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub limit: Option<UpdateCardsResponseLimit>,
    /// Card display name.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    pub object: UpdateCardsResponseObject,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub secrets: Option<UpdateCardsResponseSecrets>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<UpdateCardsResponseStatus>,
    /// The card type.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub r#type: Option<UpdateCardsResponseType>,
...
pub struct UpdateCardsResponseBuilder {
    billing: Option<UpdateCardsResponseBilling>,
    ...
    id: Option<String>,
    last4: Option<String>,
    limit: Option<UpdateCardsResponseLimit>,
    name: Option<String>,
    object: Option<UpdateCardsResponseObject>,
    secrets: Option<UpdateCardsResponseSecrets>,
    spent_last_month: Option<i64>,
    status: Option<UpdateCardsResponseStatus>,
    r#type: Option<UpdateCardsResponseType>,
    user_id: Option<String>,
}

impl UpdateCardsResponseBuilder {
    pub fn billing(mut self, value: UpdateCardsResponseBilling) -> Self {
    ...
    pub fn limit(mut self, value: UpdateCardsResponseLimit) -> Self {
    ...
    pub fn object(mut self, value: UpdateCardsResponseObject) -> Self {
        self.object = Some(value);
        self
    }

    pub fn secrets(mut self, value: UpdateCardsResponseSecrets) -> Self {
    ...
    pub fn status(mut self, value: UpdateCardsResponseStatus) -> Self {
        self.status = Some(value);
        self
    }

    pub fn r#type(mut self, value: UpdateCardsResponseType) -> Self {
    ...
    /// - [`object`](UpdateCardsResponseBuilder::object)
