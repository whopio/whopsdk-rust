...
pub enum PostPayoutMethodCreatedPayloadDataStatus {
    Created,
    Active,
    Broken,
...
impl Serialize for PostPayoutMethodCreatedPayloadDataStatus {
...
impl<'de> Deserialize<'de> for PostPayoutMethodCreatedPayloadDataStatus {
...
impl fmt::Display for PostPayoutMethodCreatedPayloadDataStatus {
