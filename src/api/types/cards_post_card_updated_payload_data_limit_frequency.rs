...
pub enum PostCardUpdatedPayloadDataLimitFrequency {
    Daily,
    Weekly,
    Monthly,
    OneTime,
...
impl Serialize for PostCardUpdatedPayloadDataLimitFrequency {
...
impl<'de> Deserialize<'de> for PostCardUpdatedPayloadDataLimitFrequency {
...
impl fmt::Display for PostCardUpdatedPayloadDataLimitFrequency {
