...
pub enum ResolutionCenterCaseActions {
    Created,
    Responded,
    Accepted,
    Denied,
...
impl Serialize for ResolutionCenterCaseActions {
...
impl<'de> Deserialize<'de> for ResolutionCenterCaseActions {
...
impl fmt::Display for ResolutionCenterCaseActions {
