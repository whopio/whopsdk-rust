...
pub enum CreateBountiesRequestBusinessGoalType {
    Clipping,
    PostEngagement,
    OwnedAccountGrowth,
    UgcContent,
...
impl Serialize for CreateBountiesRequestBusinessGoalType {
...
impl<'de> Deserialize<'de> for CreateBountiesRequestBusinessGoalType {
...
impl fmt::Display for CreateBountiesRequestBusinessGoalType {
