...
impl PaymentPromoCode {
    pub fn builder() -> PaymentPromoCodeBuilder {
        <PaymentPromoCodeBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PaymentPromoCodeBuilder {
...
impl PaymentPromoCodeBuilder {
    ...
    /// Consumes the builder and constructs a [`PaymentPromoCode`].
    /// This method will fail if any of the following fields are not set:
    /// - [`amount_off`](PaymentPromoCodeBuilder::amount_off)
    /// - [`base_currency`](PaymentPromoCodeBuilder::base_currency)
    /// - [`id`](PaymentPromoCodeBuilder::id)
    /// - [`promo_type`](PaymentPromoCodeBuilder::promo_type)
    pub fn build(self) -> Result<PaymentPromoCode, BuildError> {
        Ok(PaymentPromoCode {
            amount_off: self
                .amount_off
