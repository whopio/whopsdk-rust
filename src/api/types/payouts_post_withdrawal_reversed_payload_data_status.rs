...
pub enum PostWithdrawalReversedPayloadDataStatus {
    Requested,
    InReview,
    Processing,
    Completed,
...
impl Serialize for PostWithdrawalReversedPayloadDataStatus {
...
impl<'de> Deserialize<'de> for PostWithdrawalReversedPayloadDataStatus {
...
impl fmt::Display for PostWithdrawalReversedPayloadDataStatus {
