...
pub struct CreateInvoicesRequestBodyProductId {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub billing_address: Option<CreateInvoicesRequestBodyProductIdBillingAddress>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub line_items: Option<Vec<CreateInvoicesRequestBodyProductIdLineItemsItem>>,
    ...
    #[serde(default)]
    pub plan: CreateInvoicesRequestBodyProductIdPlan,
...
impl CreateInvoicesRequestBodyProductId {
    pub fn builder() -> CreateInvoicesRequestBodyProductIdBuilder {
        <CreateInvoicesRequestBodyProductIdBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateInvoicesRequestBodyProductIdBuilder {
    account_id: Option<String>,
    automatically_finalizes_at: Option<DateTime<FixedOffset>>,
    billing_address: Option<CreateInvoicesRequestBodyProductIdBillingAddress>,
    ...
    line_items: Option<Vec<CreateInvoicesRequestBodyProductIdLineItemsItem>>,
    mailing_address_id: Option<String>,
    member_id: Option<String>,
    payment_method_id: Option<String>,
    payment_token_id: Option<String>,
    plan: Option<CreateInvoicesRequestBodyProductIdPlan>,
    product_id: Option<String>,
    save_as_draft: Option<bool>,
    subscription_billing_anchor_at: Option<DateTime<FixedOffset>>,
}

impl CreateInvoicesRequestBodyProductIdBuilder {
    ...
    pub fn billing_address(
        mut self,
        value: CreateInvoicesRequestBodyProductIdBillingAddress,
    ) -> Self {
    ...
    pub fn line_items(
        mut self,
        value: Vec<CreateInvoicesRequestBodyProductIdLineItemsItem>,
    ) -> Self {
    ...
    pub fn plan(mut self, value: CreateInvoicesRequestBodyProductIdPlan) -> Self {
    ...
    /// Consumes the builder and constructs a [`CreateInvoicesRequestBodyProductId`].
    /// This method will fail if any of the following fields are not set:
    /// - [`account_id`](CreateInvoicesRequestBodyProductIdBuilder::account_id)
    /// - [`collection_method`](CreateInvoicesRequestBodyProductIdBuilder::collection_method)
    /// - [`plan`](CreateInvoicesRequestBodyProductIdBuilder::plan)
    /// - [`product_id`](CreateInvoicesRequestBodyProductIdBuilder::product_id)
    pub fn build(self) -> Result<CreateInvoicesRequestBodyProductId, BuildError> {
        Ok(CreateInvoicesRequestBodyProductId {
            account_id: self
                .account_id
