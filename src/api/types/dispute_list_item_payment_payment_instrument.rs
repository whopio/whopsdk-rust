...
pub struct DisputeListItemPaymentPaymentInstrument {
    ...
    #[serde(default)]
    pub icons: DisputeListItemPaymentPaymentInstrumentIcons,
...
impl DisputeListItemPaymentPaymentInstrument {
    pub fn builder() -> DisputeListItemPaymentPaymentInstrumentBuilder {
        <DisputeListItemPaymentPaymentInstrumentBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct DisputeListItemPaymentPaymentInstrumentBuilder {
    display_name: Option<String>,
    icons: Option<DisputeListItemPaymentPaymentInstrumentIcons>,
    installment_count: Option<i64>,
    payment_method_type: Option<String>,
}

impl DisputeListItemPaymentPaymentInstrumentBuilder {
    pub fn display_name(mut self, value: impl Into<String>) -> Self {
        self.display_name = Some(value.into());
        self
    }

    pub fn icons(mut self, value: DisputeListItemPaymentPaymentInstrumentIcons) -> Self {
    ...
    /// Consumes the builder and constructs a [`DisputeListItemPaymentPaymentInstrument`].
    /// This method will fail if any of the following fields are not set:
    /// - [`display_name`](DisputeListItemPaymentPaymentInstrumentBuilder::display_name)
    /// - [`icons`](DisputeListItemPaymentPaymentInstrumentBuilder::icons)
    /// - [`payment_method_type`](DisputeListItemPaymentPaymentInstrumentBuilder::payment_method_type)
    pub fn build(self) -> Result<DisputeListItemPaymentPaymentInstrument, BuildError> {
        Ok(DisputeListItemPaymentPaymentInstrument {
            display_name: self
                .display_name
