...
pub enum CreateResolutionCenterCasesRequestReason {
    Fraudulent,
    ProductNotReceived,
    NotAsDescribed,
    ProductUnacceptable,
...
impl Serialize for CreateResolutionCenterCasesRequestReason {
...
impl<'de> Deserialize<'de> for CreateResolutionCenterCasesRequestReason {
...
impl fmt::Display for CreateResolutionCenterCasesRequestReason {
