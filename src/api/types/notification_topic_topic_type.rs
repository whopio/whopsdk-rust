...
pub enum NotificationTopicTopicType {
    Account,
    User,
    AccountTeam,
...
impl Serialize for NotificationTopicTopicType {
...
impl<'de> Deserialize<'de> for NotificationTopicTopicType {
...
impl fmt::Display for NotificationTopicTopicType {
