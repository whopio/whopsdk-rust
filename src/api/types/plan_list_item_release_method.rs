...
pub enum PlanListItemReleaseMethod {
    BuyNow,
    Waitlist,
...
impl Serialize for PlanListItemReleaseMethod {
...
impl<'de> Deserialize<'de> for PlanListItemReleaseMethod {
...
impl fmt::Display for PlanListItemReleaseMethod {
