...
pub enum CreateApiKeysRequestPermissionsSystemRole {
    Owner,
    Admin,
    Moderator,
    SalesManager,
...
impl Serialize for CreateApiKeysRequestPermissionsSystemRole {
...
impl<'de> Deserialize<'de> for CreateApiKeysRequestPermissionsSystemRole {
...
impl fmt::Display for CreateApiKeysRequestPermissionsSystemRole {
