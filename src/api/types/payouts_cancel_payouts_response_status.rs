...
pub enum CancelPayoutsResponseStatus {
    Requested,
    InReview,
    Processing,
    Completed,
...
impl Serialize for CancelPayoutsResponseStatus {
...
impl<'de> Deserialize<'de> for CancelPayoutsResponseStatus {
...
impl fmt::Display for CancelPayoutsResponseStatus {
