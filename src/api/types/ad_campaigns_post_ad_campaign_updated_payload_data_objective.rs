...
pub enum PostAdCampaignUpdatedPayloadDataObjective {
    Awareness,
    Traffic,
    Engagement,
    Leads,
...
impl Serialize for PostAdCampaignUpdatedPayloadDataObjective {
...
impl<'de> Deserialize<'de> for PostAdCampaignUpdatedPayloadDataObjective {
...
impl fmt::Display for PostAdCampaignUpdatedPayloadDataObjective {
