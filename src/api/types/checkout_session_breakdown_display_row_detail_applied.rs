...
pub enum CheckoutSessionBreakdownDisplayRowDetailApplied {
    Added,
    Included,
...
impl Serialize for CheckoutSessionBreakdownDisplayRowDetailApplied {
...
impl<'de> Deserialize<'de> for CheckoutSessionBreakdownDisplayRowDetailApplied {
...
impl fmt::Display for CheckoutSessionBreakdownDisplayRowDetailApplied {
