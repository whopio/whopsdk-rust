...
pub struct PaymentLegacy {
    ...
    pub application_fee: Option<PaymentLegacyApplicationFee>,
    /// Whether this payment was auto refunded or not
    #[serde(default)]
    pub auto_refunded: bool,
    /// The address of the user who made the payment.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub billing_address: Option<PaymentLegacyBillingAddress>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub company: Option<PaymentLegacyCompany>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub disputes: Option<Vec<PaymentLegacyDisputesItem>>,
    /// If the payment failed, the reason for the failure.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub failure_message: Option<String>,
    /// The fees associated with this specific payment.
    #[serde(default)]
    pub fees: Vec<PaymentLegacyFeesItem>,
    ...
    #[serde(default)]
    pub financing_transactions: Vec<PaymentLegacyFinancingTransactionsItem>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub member: Option<PaymentLegacyMember>,
    /// The membership attached to this payment.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub membership: Option<PaymentLegacyMembership>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub payment_instrument: Option<PaymentLegacyPaymentInstrument>,
    /// The tokenized payment method reference used for this payment. Null if no token was used.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub payment_method: Option<PaymentLegacyPaymentMethod>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub plan: Option<PaymentLegacyPlan>,
    /// The product this payment was made for
    #[serde(skip_serializing_if = "Option::is_none")]
    pub product: Option<PaymentLegacyProduct>,
    ...
    #[serde(default)]
    pub refunds: Vec<PaymentLegacyRefundsItem>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub resolutions: Option<Vec<PaymentLegacyResolutionsItem>>,
...
impl PaymentLegacy {
    pub fn builder() -> PaymentLegacyBuilder {
        <PaymentLegacyBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PaymentLegacyBuilder {
    amount_after_fees: Option<f64>,
    application_fee: Option<PaymentLegacyApplicationFee>,
    auto_refunded: Option<bool>,
    billing_address: Option<PaymentLegacyBillingAddress>,
    ...
    company: Option<PaymentLegacyCompany>,
    ...
    disputes: Option<Vec<PaymentLegacyDisputesItem>>,
    failure_message: Option<String>,
    fees: Option<Vec<PaymentLegacyFeesItem>>,
    financing_installments_count: Option<i64>,
    financing_transactions: Option<Vec<PaymentLegacyFinancingTransactionsItem>>,
    id: Option<String>,
    last_payment_attempt: Option<DateTime<FixedOffset>>,
    member: Option<PaymentLegacyMember>,
    membership: Option<PaymentLegacyMembership>,
    metadata: Option<HashMap<String, serde_json::Value>>,
    needs_tracking: Option<bool>,
    next_payment_attempt: Option<DateTime<FixedOffset>>,
    paid_at: Option<DateTime<FixedOffset>>,
    payment_instrument: Option<PaymentLegacyPaymentInstrument>,
    payment_method: Option<PaymentLegacyPaymentMethod>,
    ...
    refunds: Option<Vec<PaymentLegacyRefundsItem>>,
    resolutions: Option<Vec<PaymentLegacyResolutionsItem>>,
    ...
    shipment: Option<PaymentLegacyShipment>,
    shipping_address: Option<PaymentLegacyShippingAddress>,
    ...
    user: Option<PaymentLegacyUser>,
    verification_checks: Option<PaymentLegacyVerificationChecks>,
    voidable: Option<bool>,
}

impl PaymentLegacyBuilder {
    pub fn amount_after_fees(mut self, value: f64) -> Self {
        self.amount_after_fees = Some(value);
        self
    }

    pub fn application_fee(mut self, value: PaymentLegacyApplicationFee) -> Self {
    ...
    pub fn billing_address(mut self, value: PaymentLegacyBillingAddress) -> Self {
    ...
    pub fn company(mut self, value: PaymentLegacyCompany) -> Self {
    ...
    pub fn disputes(mut self, value: Vec<PaymentLegacyDisputesItem>) -> Self {
    ...
    pub fn fees(mut self, value: Vec<PaymentLegacyFeesItem>) -> Self {
    ...
    pub fn financing_transactions(
        mut self,
        value: Vec<PaymentLegacyFinancingTransactionsItem>,
    ) -> Self {
    ...
    pub fn member(mut self, value: PaymentLegacyMember) -> Self {
        self.member = Some(value);
        self
    }

    pub fn membership(mut self, value: PaymentLegacyMembership) -> Self {
    ...
    pub fn payment_instrument(mut self, value: PaymentLegacyPaymentInstrument) -> Self {
        self.payment_instrument = Some(value);
        self
    }

    pub fn payment_method(mut self, value: PaymentLegacyPaymentMethod) -> Self {
    ...
    pub fn plan(mut self, value: PaymentLegacyPlan) -> Self {
        self.plan = Some(value);
        self
    }

    pub fn product(mut self, value: PaymentLegacyProduct) -> Self {
        self.product = Some(value);
        self
    }

    pub fn promo_code(mut self, value: PaymentLegacyPromoCode) -> Self {
    ...
    pub fn refunds(mut self, value: Vec<PaymentLegacyRefundsItem>) -> Self {
        self.refunds = Some(value);
        self
    }

    pub fn resolutions(mut self, value: Vec<PaymentLegacyResolutionsItem>) -> Self {
    ...
    pub fn shipment(mut self, value: PaymentLegacyShipment) -> Self {
        self.shipment = Some(value);
        self
    }

    pub fn shipping_address(mut self, value: PaymentLegacyShippingAddress) -> Self {
    ...
    pub fn user(mut self, value: PaymentLegacyUser) -> Self {
        self.user = Some(value);
        self
    }

    pub fn verification_checks(mut self, value: PaymentLegacyVerificationChecks) -> Self {
    ...
    /// Consumes the builder and constructs a [`PaymentLegacy`].
    /// This method will fail if any of the following fields are not set:
    /// - [`amount_after_fees`](PaymentLegacyBuilder::amount_after_fees)
    /// - [`auto_refunded`](PaymentLegacyBuilder::auto_refunded)
    /// - [`created_at`](PaymentLegacyBuilder::created_at)
    /// - [`currency`](PaymentLegacyBuilder::currency)
    /// - [`fees`](PaymentLegacyBuilder::fees)
    /// - [`financing_transactions`](PaymentLegacyBuilder::financing_transactions)
    /// - [`id`](PaymentLegacyBuilder::id)
    /// - [`refundable`](PaymentLegacyBuilder::refundable)
    /// - [`refunds`](PaymentLegacyBuilder::refunds)
    /// - [`retryable`](PaymentLegacyBuilder::retryable)
    /// - [`settlement_amount`](PaymentLegacyBuilder::settlement_amount)
    /// - [`settlement_currency`](PaymentLegacyBuilder::settlement_currency)
    /// - [`substatus`](PaymentLegacyBuilder::substatus)
    /// - [`three_ds_verified`](PaymentLegacyBuilder::three_ds_verified)
    /// - [`updated_at`](PaymentLegacyBuilder::updated_at)
    /// - [`voidable`](PaymentLegacyBuilder::voidable)
    pub fn build(self) -> Result<PaymentLegacy, BuildError> {
        Ok(PaymentLegacy {
