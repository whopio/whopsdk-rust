...
pub enum PostWithdrawalUpdatedPayloadDataStatus {
    Requested,
    InReview,
    Processing,
    Completed,
...
impl Serialize for PostWithdrawalUpdatedPayloadDataStatus {
...
impl<'de> Deserialize<'de> for PostWithdrawalUpdatedPayloadDataStatus {
...
impl fmt::Display for PostWithdrawalUpdatedPayloadDataStatus {
