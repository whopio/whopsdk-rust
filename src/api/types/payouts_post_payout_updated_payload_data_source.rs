...
pub enum PostPayoutUpdatedPayloadDataSource {
    Api,
    Dashboard,
    Automatic,
...
impl Serialize for PostPayoutUpdatedPayloadDataSource {
...
impl<'de> Deserialize<'de> for PostPayoutUpdatedPayloadDataSource {
...
impl fmt::Display for PostPayoutUpdatedPayloadDataSource {
