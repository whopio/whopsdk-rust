...
pub struct CreatePaymentsRequestZeroPlan {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub product: Option<CreatePaymentsRequestZeroPlanProduct>,
...
impl CreatePaymentsRequestZeroPlan {
    pub fn builder() -> CreatePaymentsRequestZeroPlanBuilder {
        <CreatePaymentsRequestZeroPlanBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreatePaymentsRequestZeroPlanBuilder {
    ...
    product: Option<CreatePaymentsRequestZeroPlanProduct>,
...
impl CreatePaymentsRequestZeroPlanBuilder {
    ...
    pub fn product(mut self, value: CreatePaymentsRequestZeroPlanProduct) -> Self {
    ...
    /// Consumes the builder and constructs a [`CreatePaymentsRequestZeroPlan`].
    /// This method will fail if any of the following fields are not set:
    /// - [`currency`](CreatePaymentsRequestZeroPlanBuilder::currency)
    pub fn build(self) -> Result<CreatePaymentsRequestZeroPlan, BuildError> {
        Ok(CreatePaymentsRequestZeroPlan {
