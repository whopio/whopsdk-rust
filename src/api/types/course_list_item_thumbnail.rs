...
pub struct CourseListItemThumbnail {
...
impl CourseListItemThumbnail {
    pub fn builder() -> CourseListItemThumbnailBuilder {
        <CourseListItemThumbnailBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CourseListItemThumbnailBuilder {
...
impl CourseListItemThumbnailBuilder {
    ...
    /// Consumes the builder and constructs a [`CourseListItemThumbnail`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](CourseListItemThumbnailBuilder::id)
    pub fn build(self) -> Result<CourseListItemThumbnail, BuildError> {
        Ok(CourseListItemThumbnail {
