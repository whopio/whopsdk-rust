...
pub enum AdGroupMessageAppsItem {
    Messenger,
    Instagram,
    Whatsapp,
...
impl Serialize for AdGroupMessageAppsItem {
...
impl<'de> Deserialize<'de> for AdGroupMessageAppsItem {
...
impl fmt::Display for AdGroupMessageAppsItem {
