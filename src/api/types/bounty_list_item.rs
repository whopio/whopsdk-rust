...
pub struct BountyListItem {
    #[serde(default)]
    pub accepted_deliverable_types: Vec<BountyListItemAcceptedDeliverableTypesItem>,
    ...
    pub business_goal_type: Option<BountyListItemBusinessGoalType>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub scheduled_frequency: Option<BountyListItemScheduledFrequency>,
    ...
    pub status: BountyListItemStatus,
...
impl BountyListItem {
    pub fn builder() -> BountyListItemBuilder {
        <BountyListItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct BountyListItemBuilder {
    accepted_deliverable_types: Option<Vec<BountyListItemAcceptedDeliverableTypesItem>>,
    ...
    business_goal_type: Option<BountyListItemBusinessGoalType>,
    ...
    status: Option<BountyListItemStatus>,
...
impl BountyListItemBuilder {
    pub fn accepted_deliverable_types(
        mut self,
        value: Vec<BountyListItemAcceptedDeliverableTypesItem>,
    ) -> Self {
    ...
    pub fn business_goal_type(mut self, value: BountyListItemBusinessGoalType) -> Self {
    ...
    pub fn scheduled_frequency(mut self, value: BountyListItemScheduledFrequency) -> Self {
    ...
    pub fn status(mut self, value: BountyListItemStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`BountyListItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`accepted_deliverable_types`](BountyListItemBuilder::accepted_deliverable_types)
    /// - [`accepted_submissions_count`](BountyListItemBuilder::accepted_submissions_count)
    /// - [`accepted_submissions_limit`](BountyListItemBuilder::accepted_submissions_limit)
    /// - [`accepted_submissions_per_user_limit`](BountyListItemBuilder::accepted_submissions_per_user_limit)
    /// - [`affiliate_share_amount`](BountyListItemBuilder::affiliate_share_amount)
    /// - [`allowed_country_codes`](BountyListItemBuilder::allowed_country_codes)
    /// - [`budget_amount`](BountyListItemBuilder::budget_amount)
    /// - [`created_at`](BountyListItemBuilder::created_at)
    /// - [`currency`](BountyListItemBuilder::currency)
    /// - [`description`](BountyListItemBuilder::description)
    /// - [`gross_paid_out_amount`](BountyListItemBuilder::gross_paid_out_amount)
    /// - [`gross_reward_amount`](BountyListItemBuilder::gross_reward_amount)
    /// - [`id`](BountyListItemBuilder::id)
    /// - [`net_reward_amount`](BountyListItemBuilder::net_reward_amount)
    /// - [`poster`](BountyListItemBuilder::poster)
    /// - [`spots_remaining`](BountyListItemBuilder::spots_remaining)
    /// - [`status`](BountyListItemBuilder::status)
    /// - [`title`](BountyListItemBuilder::title)
    /// - [`unresolved_submissions_count`](BountyListItemBuilder::unresolved_submissions_count)
    /// - [`updated_at`](BountyListItemBuilder::updated_at)
    /// - [`viewer_accepted_submissions_count`](BountyListItemBuilder::viewer_accepted_submissions_count)
    pub fn build(self) -> Result<BountyListItem, BuildError> {
        Ok(BountyListItem {
