...
pub struct CreateInvoicesRequestProductIdBillingAddress {
...
impl CreateInvoicesRequestProductIdBillingAddress {
    pub fn builder() -> CreateInvoicesRequestProductIdBillingAddressBuilder {
        <CreateInvoicesRequestProductIdBillingAddressBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateInvoicesRequestProductIdBillingAddressBuilder {
    city: Option<String>,
...
impl CreateInvoicesRequestProductIdBillingAddressBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateInvoicesRequestProductIdBillingAddress`].
    pub fn build(self) -> Result<CreateInvoicesRequestProductIdBillingAddress, BuildError> {
        Ok(CreateInvoicesRequestProductIdBillingAddress {
            city: self.city,
