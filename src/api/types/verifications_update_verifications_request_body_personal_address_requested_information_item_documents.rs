...
pub struct UpdateVerificationsRequestBodyPersonalAddressRequestedInformationItemDocuments {
...
impl UpdateVerificationsRequestBodyPersonalAddressRequestedInformationItemDocuments {
    pub fn builder(
    ) -> UpdateVerificationsRequestBodyPersonalAddressRequestedInformationItemDocumentsBuilder {
        <UpdateVerificationsRequestBodyPersonalAddressRequestedInformationItemDocumentsBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct UpdateVerificationsRequestBodyPersonalAddressRequestedInformationItemDocumentsBuilder {
...
impl UpdateVerificationsRequestBodyPersonalAddressRequestedInformationItemDocumentsBuilder {
    ...
    /// Consumes the builder and constructs a [`UpdateVerificationsRequestBodyPersonalAddressRequestedInformationItemDocuments`].
    pub fn build(
        self,
    ) -> Result<
