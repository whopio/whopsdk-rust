...
pub enum CreateBountiesRequestFrequency {
    Once,
    Hourly,
    Daily,
    Weekly,
...
impl Serialize for CreateBountiesRequestFrequency {
...
impl<'de> Deserialize<'de> for CreateBountiesRequestFrequency {
...
impl fmt::Display for CreateBountiesRequestFrequency {
