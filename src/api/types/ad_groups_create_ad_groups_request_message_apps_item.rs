...
pub enum CreateAdGroupsRequestMessageAppsItem {
    Messenger,
    Instagram,
    Whatsapp,
...
impl Serialize for CreateAdGroupsRequestMessageAppsItem {
...
impl<'de> Deserialize<'de> for CreateAdGroupsRequestMessageAppsItem {
...
impl fmt::Display for CreateAdGroupsRequestMessageAppsItem {
