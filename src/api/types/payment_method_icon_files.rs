...
pub struct PaymentMethodIconFiles {
...
impl PaymentMethodIconFiles {
    pub fn builder() -> PaymentMethodIconFilesBuilder {
        <PaymentMethodIconFilesBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PaymentMethodIconFilesBuilder {
    png1x: Option<String>,
    png2x: Option<String>,
    png4x: Option<String>,
    svg: Option<String>,
...
impl PaymentMethodIconFilesBuilder {
    ...
    /// Consumes the builder and constructs a [`PaymentMethodIconFiles`].
    /// This method will fail if any of the following fields are not set:
    /// - [`png1x`](PaymentMethodIconFilesBuilder::png1x)
    /// - [`png2x`](PaymentMethodIconFilesBuilder::png2x)
    /// - [`png4x`](PaymentMethodIconFilesBuilder::png4x)
    /// - [`svg`](PaymentMethodIconFilesBuilder::svg)
    pub fn build(self) -> Result<PaymentMethodIconFiles, BuildError> {
        Ok(PaymentMethodIconFiles {
            png1x: self
                .png1x
