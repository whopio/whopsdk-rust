...
pub struct CreatePaymentsRequestZeroPlanProduct {
...
impl CreatePaymentsRequestZeroPlanProduct {
    pub fn builder() -> CreatePaymentsRequestZeroPlanProductBuilder {
        <CreatePaymentsRequestZeroPlanProductBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreatePaymentsRequestZeroPlanProductBuilder {
...
impl CreatePaymentsRequestZeroPlanProductBuilder {
    ...
    /// Consumes the builder and constructs a [`CreatePaymentsRequestZeroPlanProduct`].
    /// This method will fail if any of the following fields are not set:
    /// - [`external_identifier`](CreatePaymentsRequestZeroPlanProductBuilder::external_identifier)
    /// - [`title`](CreatePaymentsRequestZeroPlanProductBuilder::title)
    pub fn build(self) -> Result<CreatePaymentsRequestZeroPlanProduct, BuildError> {
        Ok(CreatePaymentsRequestZeroPlanProduct {
