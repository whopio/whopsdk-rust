...
pub enum PostAdCampaignUpdatedPayloadDataStatus {
    Active,
    Paused,
    Inactive,
    Stale,
...
impl Serialize for PostAdCampaignUpdatedPayloadDataStatus {
...
impl<'de> Deserialize<'de> for PostAdCampaignUpdatedPayloadDataStatus {
...
impl fmt::Display for PostAdCampaignUpdatedPayloadDataStatus {
