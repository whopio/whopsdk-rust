...
pub enum UpdateAdCampaignsRequestBudgetType {
    Daily,
    Lifetime,
...
impl Serialize for UpdateAdCampaignsRequestBudgetType {
...
impl<'de> Deserialize<'de> for UpdateAdCampaignsRequestBudgetType {
...
impl fmt::Display for UpdateAdCampaignsRequestBudgetType {
