...
pub enum CreateCardsResponseStatus {
    Active,
    Frozen,
    Canceled,
    Invited,
...
impl Serialize for CreateCardsResponseStatus {
...
impl<'de> Deserialize<'de> for CreateCardsResponseStatus {
...
impl fmt::Display for CreateCardsResponseStatus {
