...
impl PaymentProduct {
    pub fn builder() -> PaymentProductBuilder {
        <PaymentProductBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PaymentProductBuilder {
    id: Option<String>,
...
impl PaymentProductBuilder {
    ...
    /// Consumes the builder and constructs a [`PaymentProduct`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](PaymentProductBuilder::id)
    /// - [`route`](PaymentProductBuilder::route)
    /// - [`title`](PaymentProductBuilder::title)
    pub fn build(self) -> Result<PaymentProduct, BuildError> {
        Ok(PaymentProduct {
