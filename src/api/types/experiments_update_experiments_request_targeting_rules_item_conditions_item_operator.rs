...
pub enum UpdateExperimentsRequestTargetingRulesItemConditionsItemOperator {
    Any,
    None,
    Eq,
    Neq,
...
impl Serialize for UpdateExperimentsRequestTargetingRulesItemConditionsItemOperator {
...
impl<'de> Deserialize<'de> for UpdateExperimentsRequestTargetingRulesItemConditionsItemOperator {
...
impl fmt::Display for UpdateExperimentsRequestTargetingRulesItemConditionsItemOperator {
