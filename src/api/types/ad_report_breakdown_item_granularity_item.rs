...
pub struct AdReportBreakdownItemGranularityItem {
...
impl AdReportBreakdownItemGranularityItem {
    pub fn builder() -> AdReportBreakdownItemGranularityItemBuilder {
        <AdReportBreakdownItemGranularityItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct AdReportBreakdownItemGranularityItemBuilder {
...
impl AdReportBreakdownItemGranularityItemBuilder {
    ...
    /// Consumes the builder and constructs a [`AdReportBreakdownItemGranularityItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`bucket_start`](AdReportBreakdownItemGranularityItemBuilder::bucket_start)
    /// - [`clicks`](AdReportBreakdownItemGranularityItemBuilder::clicks)
    /// - [`granularity`](AdReportBreakdownItemGranularityItemBuilder::granularity)
    /// - [`impressions`](AdReportBreakdownItemGranularityItemBuilder::impressions)
    /// - [`reach`](AdReportBreakdownItemGranularityItemBuilder::reach)
    /// - [`spend`](AdReportBreakdownItemGranularityItemBuilder::spend)
    /// - [`spend_currency`](AdReportBreakdownItemGranularityItemBuilder::spend_currency)
    /// - [`stat_date`](AdReportBreakdownItemGranularityItemBuilder::stat_date)
    pub fn build(self) -> Result<AdReportBreakdownItemGranularityItem, BuildError> {
        Ok(AdReportBreakdownItemGranularityItem {
            bucket_start: self
                .bucket_start
