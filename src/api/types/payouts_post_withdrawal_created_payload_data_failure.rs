...
pub struct PostWithdrawalCreatedPayloadDataFailure {
...
impl PostWithdrawalCreatedPayloadDataFailure {
    pub fn builder() -> PostWithdrawalCreatedPayloadDataFailureBuilder {
        <PostWithdrawalCreatedPayloadDataFailureBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostWithdrawalCreatedPayloadDataFailureBuilder {
    code: Option<String>,
    funds_returned_at: Option<DateTime<FixedOffset>>,
    message: Option<String>,
}

impl PostWithdrawalCreatedPayloadDataFailureBuilder {
    ...
    /// Consumes the builder and constructs a [`PostWithdrawalCreatedPayloadDataFailure`].
    pub fn build(self) -> Result<PostWithdrawalCreatedPayloadDataFailure, BuildError> {
        Ok(PostWithdrawalCreatedPayloadDataFailure {
            code: self.code,
