...
pub enum RetrievePayoutsResponsePayoutMethodSupportedPayoutMethodDeliveryType {
    CashPickup,
    BankDeposit,
    HomeDelivery,
    MobileWallet,
...
impl Serialize for RetrievePayoutsResponsePayoutMethodSupportedPayoutMethodDeliveryType {
...
impl<'de> Deserialize<'de>
    for RetrievePayoutsResponsePayoutMethodSupportedPayoutMethodDeliveryType
{
...
impl fmt::Display for RetrievePayoutsResponsePayoutMethodSupportedPayoutMethodDeliveryType {
