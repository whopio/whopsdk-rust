...
pub enum PostTransferCreatedPayloadDataStatus {
    Processing,
    Succeeded,
    Failed,
...
impl Serialize for PostTransferCreatedPayloadDataStatus {
...
impl<'de> Deserialize<'de> for PostTransferCreatedPayloadDataStatus {
...
impl fmt::Display for PostTransferCreatedPayloadDataStatus {
