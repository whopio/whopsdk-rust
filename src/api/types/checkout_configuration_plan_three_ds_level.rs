...
pub enum CheckoutConfigurationPlanThreeDsLevel {
    MandateChallenge,
    Frictionless,
...
impl Serialize for CheckoutConfigurationPlanThreeDsLevel {
...
impl<'de> Deserialize<'de> for CheckoutConfigurationPlanThreeDsLevel {
...
impl fmt::Display for CheckoutConfigurationPlanThreeDsLevel {
