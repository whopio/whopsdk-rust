...
pub struct CreateInvoicesRequestProductPlan {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub custom_fields: Option<Vec<CreateInvoicesRequestProductPlanCustomFieldsItem>>,
    ...
    pub payment_method_configuration:
        Option<CreateInvoicesRequestProductPlanPaymentMethodConfiguration>,
...
impl CreateInvoicesRequestProductPlan {
    pub fn builder() -> CreateInvoicesRequestProductPlanBuilder {
        <CreateInvoicesRequestProductPlanBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateInvoicesRequestProductPlanBuilder {
    adaptive_pricing_enabled: Option<bool>,
    billing_period: Option<i64>,
    currency: Option<Currencies>,
    custom_fields: Option<Vec<CreateInvoicesRequestProductPlanCustomFieldsItem>>,
...
impl CreateInvoicesRequestProductPlanBuilder {
    ...
    pub fn custom_fields(
        mut self,
        value: Vec<CreateInvoicesRequestProductPlanCustomFieldsItem>,
    ) -> Self {
    ...
    pub fn payment_method_configuration(
        mut self,
        value: CreateInvoicesRequestProductPlanPaymentMethodConfiguration,
    ) -> Self {
    ...
    /// Consumes the builder and constructs a [`CreateInvoicesRequestProductPlan`].
    pub fn build(self) -> Result<CreateInvoicesRequestProductPlan, BuildError> {
        Ok(CreateInvoicesRequestProductPlan {
