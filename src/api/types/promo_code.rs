...
pub struct PromoCode {
    ...
    pub currency: PromoCodeCurrency,
    /// How long the discount applies.
    pub duration: PromoCodeDuration,
    ...
    pub promo_type: PromoCodePromoType,
    /// Promo code lifecycle status.
    pub status: PromoCodeStatus,
...
impl PromoCode {
    pub fn builder() -> PromoCodeBuilder {
        <PromoCodeBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PromoCodeBuilder {
    account: Option<AccountSummary>,
    amount_off: Option<f64>,
    churned_users_only: Option<bool>,
    code: Option<String>,
    created_at: Option<String>,
    currency: Option<PromoCodeCurrency>,
    duration: Option<PromoCodeDuration>,
    ...
    promo_type: Option<PromoCodePromoType>,
    status: Option<PromoCodeStatus>,
    stock: Option<i64>,
...
impl PromoCodeBuilder {
    ...
    pub fn currency(mut self, value: PromoCodeCurrency) -> Self {
        self.currency = Some(value);
        self
    }

    pub fn duration(mut self, value: PromoCodeDuration) -> Self {
    ...
    pub fn promo_type(mut self, value: PromoCodePromoType) -> Self {
        self.promo_type = Some(value);
        self
    }

    pub fn status(mut self, value: PromoCodeStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`PromoCode`].
    /// This method will fail if any of the following fields are not set:
    /// - [`account`](PromoCodeBuilder::account)
    /// - [`amount_off`](PromoCodeBuilder::amount_off)
    /// - [`churned_users_only`](PromoCodeBuilder::churned_users_only)
    /// - [`created_at`](PromoCodeBuilder::created_at)
    /// - [`currency`](PromoCodeBuilder::currency)
    /// - [`duration`](PromoCodeBuilder::duration)
    /// - [`existing_memberships_only`](PromoCodeBuilder::existing_memberships_only)
    /// - [`id`](PromoCodeBuilder::id)
    /// - [`metadata`](PromoCodeBuilder::metadata)
    /// - [`new_users_only`](PromoCodeBuilder::new_users_only)
    /// - [`one_per_customer`](PromoCodeBuilder::one_per_customer)
    /// - [`promo_type`](PromoCodeBuilder::promo_type)
    /// - [`status`](PromoCodeBuilder::status)
    /// - [`stock`](PromoCodeBuilder::stock)
    /// - [`unlimited_stock`](PromoCodeBuilder::unlimited_stock)
    /// - [`updated_at`](PromoCodeBuilder::updated_at)
    /// - [`uses`](PromoCodeBuilder::uses)
    pub fn build(self) -> Result<PromoCode, BuildError> {
        Ok(PromoCode {
            account: self
                .account
