...
pub struct UpdateInvoicesRequestPlan {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub custom_fields: Option<Vec<UpdateInvoicesRequestPlanCustomFieldsItem>>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub payment_method_configuration: Option<UpdateInvoicesRequestPlanPaymentMethodConfiguration>,
...
impl UpdateInvoicesRequestPlan {
    pub fn builder() -> UpdateInvoicesRequestPlanBuilder {
        <UpdateInvoicesRequestPlanBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct UpdateInvoicesRequestPlanBuilder {
    adaptive_pricing_enabled: Option<bool>,
    billing_period: Option<i64>,
    currency: Option<Currencies>,
    custom_fields: Option<Vec<UpdateInvoicesRequestPlanCustomFieldsItem>>,
    description: Option<String>,
    expiration_days: Option<i64>,
    initial_price: Option<f64>,
    internal_notes: Option<String>,
    legacy_payment_method_controls: Option<bool>,
    payment_method_configuration: Option<UpdateInvoicesRequestPlanPaymentMethodConfiguration>,
...
impl UpdateInvoicesRequestPlanBuilder {
    ...
    pub fn custom_fields(mut self, value: Vec<UpdateInvoicesRequestPlanCustomFieldsItem>) -> Self {
    ...
    pub fn payment_method_configuration(
        mut self,
        value: UpdateInvoicesRequestPlanPaymentMethodConfiguration,
    ) -> Self {
    ...
    /// Consumes the builder and constructs a [`UpdateInvoicesRequestPlan`].
    pub fn build(self) -> Result<UpdateInvoicesRequestPlan, BuildError> {
        Ok(UpdateInvoicesRequestPlan {
