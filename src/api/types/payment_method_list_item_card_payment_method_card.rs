...
pub struct PaymentMethodListItemCardPaymentMethodCard {
...
impl PaymentMethodListItemCardPaymentMethodCard {
    pub fn builder() -> PaymentMethodListItemCardPaymentMethodCardBuilder {
        <PaymentMethodListItemCardPaymentMethodCardBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PaymentMethodListItemCardPaymentMethodCardBuilder {
...
impl PaymentMethodListItemCardPaymentMethodCardBuilder {
    ...
    /// Consumes the builder and constructs a [`PaymentMethodListItemCardPaymentMethodCard`].
    /// This method will fail if any of the following fields are not set:
    /// - [`expired`](PaymentMethodListItemCardPaymentMethodCardBuilder::expired)
    /// - [`three_ds_verified`](PaymentMethodListItemCardPaymentMethodCardBuilder::three_ds_verified)
    pub fn build(self) -> Result<PaymentMethodListItemCardPaymentMethodCard, BuildError> {
        Ok(PaymentMethodListItemCardPaymentMethodCard {
            brand: self.brand,
