...
pub enum CreatePaymentRulesRequestAction {
    Allow,
    Block,
    Enforce3Ds,
...
impl Serialize for CreatePaymentRulesRequestAction {
...
impl<'de> Deserialize<'de> for CreatePaymentRulesRequestAction {
...
impl fmt::Display for CreatePaymentRulesRequestAction {
