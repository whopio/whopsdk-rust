...
pub struct PostPayoutReversedPayloadData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub failure: Option<PostPayoutReversedPayloadDataFailure>,
    ...
    pub fee_paid_by: PostPayoutReversedPayloadDataFeePaidBy,
    ...
    pub object: PostPayoutReversedPayloadDataObject,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub payout_method: Option<PostPayoutReversedPayloadDataPayoutMethod>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub source: Option<PostPayoutReversedPayloadDataSource>,
    /// Payout delivery speed.
    pub speed: PostPayoutReversedPayloadDataSpeed,
    ...
    pub status: PostPayoutReversedPayloadDataStatus,
...
impl PostPayoutReversedPayloadData {
    pub fn builder() -> PostPayoutReversedPayloadDataBuilder {
        <PostPayoutReversedPayloadDataBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostPayoutReversedPayloadDataBuilder {
    ...
    failure: Option<PostPayoutReversedPayloadDataFailure>,
    fee_amount: Option<String>,
    fee_paid_by: Option<PostPayoutReversedPayloadDataFeePaidBy>,
    id: Option<String>,
    markup_fee: Option<String>,
    metadata: Option<HashMap<String, String>>,
    net_amount: Option<String>,
    notes: Option<String>,
    object: Option<PostPayoutReversedPayloadDataObject>,
    payer_name: Option<String>,
    payout_method: Option<PostPayoutReversedPayloadDataPayoutMethod>,
    payout_request_id: Option<String>,
    source: Option<PostPayoutReversedPayloadDataSource>,
    speed: Option<PostPayoutReversedPayloadDataSpeed>,
    statement_descriptor: Option<String>,
    status: Option<PostPayoutReversedPayloadDataStatus>,
    status_detail: Option<String>,
    trace_code: Option<String>,
}

impl PostPayoutReversedPayloadDataBuilder {
    ...
    pub fn failure(mut self, value: PostPayoutReversedPayloadDataFailure) -> Self {
    ...
    pub fn fee_paid_by(mut self, value: PostPayoutReversedPayloadDataFeePaidBy) -> Self {
    ...
    pub fn object(mut self, value: PostPayoutReversedPayloadDataObject) -> Self {
    ...
    pub fn payout_method(mut self, value: PostPayoutReversedPayloadDataPayoutMethod) -> Self {
    ...
    pub fn source(mut self, value: PostPayoutReversedPayloadDataSource) -> Self {
        self.source = Some(value);
        self
    }

    pub fn speed(mut self, value: PostPayoutReversedPayloadDataSpeed) -> Self {
    ...
    pub fn status(mut self, value: PostPayoutReversedPayloadDataStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostPayoutReversedPayloadData`].
    /// This method will fail if any of the following fields are not set:
    /// - [`amount`](PostPayoutReversedPayloadDataBuilder::amount)
    /// - [`created_at`](PostPayoutReversedPayloadDataBuilder::created_at)
    /// - [`currency`](PostPayoutReversedPayloadDataBuilder::currency)
    /// - [`fee_amount`](PostPayoutReversedPayloadDataBuilder::fee_amount)
    /// - [`fee_paid_by`](PostPayoutReversedPayloadDataBuilder::fee_paid_by)
    /// - [`id`](PostPayoutReversedPayloadDataBuilder::id)
    /// - [`markup_fee`](PostPayoutReversedPayloadDataBuilder::markup_fee)
    /// - [`metadata`](PostPayoutReversedPayloadDataBuilder::metadata)
    /// - [`net_amount`](PostPayoutReversedPayloadDataBuilder::net_amount)
    /// - [`object`](PostPayoutReversedPayloadDataBuilder::object)
    /// - [`speed`](PostPayoutReversedPayloadDataBuilder::speed)
    /// - [`status`](PostPayoutReversedPayloadDataBuilder::status)
    /// - [`status_detail`](PostPayoutReversedPayloadDataBuilder::status_detail)
    pub fn build(self) -> Result<PostPayoutReversedPayloadData, BuildError> {
        Ok(PostPayoutReversedPayloadData {
            amount: self
                .amount
