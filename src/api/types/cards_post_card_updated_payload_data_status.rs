...
pub enum PostCardUpdatedPayloadDataStatus {
    Active,
    Frozen,
    Canceled,
    Invited,
...
impl Serialize for PostCardUpdatedPayloadDataStatus {
...
impl<'de> Deserialize<'de> for PostCardUpdatedPayloadDataStatus {
...
impl fmt::Display for PostCardUpdatedPayloadDataStatus {
