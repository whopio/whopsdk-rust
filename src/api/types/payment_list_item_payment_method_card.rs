...
pub struct PaymentListItemPaymentMethodCard {
...
impl PaymentListItemPaymentMethodCard {
    pub fn builder() -> PaymentListItemPaymentMethodCardBuilder {
        <PaymentListItemPaymentMethodCardBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PaymentListItemPaymentMethodCardBuilder {
...
impl PaymentListItemPaymentMethodCardBuilder {
    ...
    /// Consumes the builder and constructs a [`PaymentListItemPaymentMethodCard`].
    pub fn build(self) -> Result<PaymentListItemPaymentMethodCard, BuildError> {
        Ok(PaymentListItemPaymentMethodCard {
            brand: self.brand,
