...
pub enum PostAdCampaignUpdatedPayloadDataBidType {
    MinimumCost,
    AverageTarget,
    MaximumTarget,
...
impl Serialize for PostAdCampaignUpdatedPayloadDataBidType {
...
impl<'de> Deserialize<'de> for PostAdCampaignUpdatedPayloadDataBidType {
...
impl fmt::Display for PostAdCampaignUpdatedPayloadDataBidType {
