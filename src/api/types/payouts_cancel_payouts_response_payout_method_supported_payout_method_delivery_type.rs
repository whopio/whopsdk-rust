...
pub enum CancelPayoutsResponsePayoutMethodSupportedPayoutMethodDeliveryType {
    CashPickup,
    BankDeposit,
    HomeDelivery,
    MobileWallet,
...
impl Serialize for CancelPayoutsResponsePayoutMethodSupportedPayoutMethodDeliveryType {
...
impl<'de> Deserialize<'de> for CancelPayoutsResponsePayoutMethodSupportedPayoutMethodDeliveryType {
...
impl fmt::Display for CancelPayoutsResponsePayoutMethodSupportedPayoutMethodDeliveryType {
