...
pub struct ForumListItem {
    ...
    #[serde(default)]
    pub experience: ForumListItemExperience,
...
impl ForumListItem {
    pub fn builder() -> ForumListItemBuilder {
        <ForumListItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ForumListItemBuilder {
    email_notification_preference: Option<ForumEmailNotificationPreferences>,
    experience: Option<ForumListItemExperience>,
    id: Option<String>,
    who_can_comment: Option<ForumWhoCanCommentTypes>,
    who_can_post: Option<ForumWhoCanPostTypes>,
}

impl ForumListItemBuilder {
    ...
    pub fn experience(mut self, value: ForumListItemExperience) -> Self {
    ...
    /// Consumes the builder and constructs a [`ForumListItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`email_notification_preference`](ForumListItemBuilder::email_notification_preference)
    /// - [`experience`](ForumListItemBuilder::experience)
    /// - [`id`](ForumListItemBuilder::id)
    /// - [`who_can_comment`](ForumListItemBuilder::who_can_comment)
    /// - [`who_can_post`](ForumListItemBuilder::who_can_post)
    pub fn build(self) -> Result<ForumListItem, BuildError> {
        Ok(ForumListItem {
