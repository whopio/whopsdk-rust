...
pub struct ResolutionCenterCaseLegacy {
    /// The company involved in this resolution case. Null if the company no longer exists.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub company: Option<ResolutionCenterCaseLegacyCompany>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub member: Option<ResolutionCenterCaseLegacyMember>,
    ...
    #[serde(default)]
    pub payment: ResolutionCenterCaseLegacyPayment,
    ...
    #[serde(default)]
    pub resolution_events: Vec<ResolutionCenterCaseLegacyResolutionEventsItem>,
    ...
    #[serde(default)]
    pub user: ResolutionCenterCaseLegacyUser,
}

impl ResolutionCenterCaseLegacy {
    pub fn builder() -> ResolutionCenterCaseLegacyBuilder {
        <ResolutionCenterCaseLegacyBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ResolutionCenterCaseLegacyBuilder {
    company: Option<ResolutionCenterCaseLegacyCompany>,
    ...
    member: Option<ResolutionCenterCaseLegacyMember>,
    merchant_appealed: Option<bool>,
    merchant_response_actions: Option<Vec<ResolutionCenterCaseMerchantResponses>>,
    payment: Option<ResolutionCenterCaseLegacyPayment>,
    platform_response_actions: Option<Vec<ResolutionCenterCasePlatformResponses>>,
    resolution_events: Option<Vec<ResolutionCenterCaseLegacyResolutionEventsItem>>,
    status: Option<ResolutionCenterCaseStatuses>,
    updated_at: Option<DateTime<FixedOffset>>,
    user: Option<ResolutionCenterCaseLegacyUser>,
}

impl ResolutionCenterCaseLegacyBuilder {
    pub fn company(mut self, value: ResolutionCenterCaseLegacyCompany) -> Self {
    ...
    pub fn member(mut self, value: ResolutionCenterCaseLegacyMember) -> Self {
    ...
    pub fn payment(mut self, value: ResolutionCenterCaseLegacyPayment) -> Self {
    ...
    pub fn resolution_events(
        mut self,
        value: Vec<ResolutionCenterCaseLegacyResolutionEventsItem>,
    ) -> Self {
        self.resolution_events = Some(value);
        self
    }
    ...
    pub fn user(mut self, value: ResolutionCenterCaseLegacyUser) -> Self {
        self.user = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`ResolutionCenterCaseLegacy`].
    /// This method will fail if any of the following fields are not set:
    /// - [`created_at`](ResolutionCenterCaseLegacyBuilder::created_at)
    /// - [`customer_appealed`](ResolutionCenterCaseLegacyBuilder::customer_appealed)
    /// - [`customer_response_actions`](ResolutionCenterCaseLegacyBuilder::customer_response_actions)
    /// - [`id`](ResolutionCenterCaseLegacyBuilder::id)
    /// - [`issue`](ResolutionCenterCaseLegacyBuilder::issue)
    /// - [`merchant_appealed`](ResolutionCenterCaseLegacyBuilder::merchant_appealed)
    /// - [`merchant_response_actions`](ResolutionCenterCaseLegacyBuilder::merchant_response_actions)
    /// - [`payment`](ResolutionCenterCaseLegacyBuilder::payment)
    /// - [`platform_response_actions`](ResolutionCenterCaseLegacyBuilder::platform_response_actions)
    /// - [`resolution_events`](ResolutionCenterCaseLegacyBuilder::resolution_events)
    /// - [`status`](ResolutionCenterCaseLegacyBuilder::status)
    /// - [`updated_at`](ResolutionCenterCaseLegacyBuilder::updated_at)
    /// - [`user`](ResolutionCenterCaseLegacyBuilder::user)
    pub fn build(self) -> Result<ResolutionCenterCaseLegacy, BuildError> {
        Ok(ResolutionCenterCaseLegacy {
            ...
            resolution_events: self
                .resolution_events
                .ok_or_else(|| BuildError::missing_field("resolution_events"))?,
            status: self
                .status
