...
pub enum ResolutionCenterCaseReason {
    Fraudulent,
    ProductNotReceived,
    NotAsDescribed,
    ProductUnacceptable,
...
impl Serialize for ResolutionCenterCaseReason {
...
impl<'de> Deserialize<'de> for ResolutionCenterCaseReason {
...
impl fmt::Display for ResolutionCenterCaseReason {
