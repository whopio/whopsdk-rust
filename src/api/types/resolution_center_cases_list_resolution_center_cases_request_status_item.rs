...
pub enum ListResolutionCenterCasesRequestStatusItem {
    AwaitingMerchant,
    AwaitingCustomer,
    UnderReview,
    Closed,
...
impl Serialize for ListResolutionCenterCasesRequestStatusItem {
...
impl<'de> Deserialize<'de> for ListResolutionCenterCasesRequestStatusItem {
...
impl fmt::Display for ListResolutionCenterCasesRequestStatusItem {
