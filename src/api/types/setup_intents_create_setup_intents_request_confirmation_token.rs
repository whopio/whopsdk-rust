...
pub struct CreateSetupIntentsRequestConfirmationToken {
...
impl CreateSetupIntentsRequestConfirmationToken {
    pub fn builder() -> CreateSetupIntentsRequestConfirmationTokenBuilder {
        <CreateSetupIntentsRequestConfirmationTokenBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateSetupIntentsRequestConfirmationTokenBuilder {
...
impl CreateSetupIntentsRequestConfirmationTokenBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateSetupIntentsRequestConfirmationToken`].
    /// This method will fail if any of the following fields are not set:
    /// - [`company_id`](CreateSetupIntentsRequestConfirmationTokenBuilder::company_id)
    /// - [`confirmation_token`](CreateSetupIntentsRequestConfirmationTokenBuilder::confirmation_token)
    pub fn build(self) -> Result<CreateSetupIntentsRequestConfirmationToken, BuildError> {
        Ok(CreateSetupIntentsRequestConfirmationToken {
            company_id: self
                .company_id
