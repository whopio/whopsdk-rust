...
pub enum PermissionGrantedToSystemRolesItem {
    Owner,
    Admin,
    Moderator,
    SalesManager,
...
impl Serialize for PermissionGrantedToSystemRolesItem {
...
impl<'de> Deserialize<'de> for PermissionGrantedToSystemRolesItem {
...
impl fmt::Display for PermissionGrantedToSystemRolesItem {
