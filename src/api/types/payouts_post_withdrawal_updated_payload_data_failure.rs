...
pub struct PostWithdrawalUpdatedPayloadDataFailure {
...
impl PostWithdrawalUpdatedPayloadDataFailure {
    pub fn builder() -> PostWithdrawalUpdatedPayloadDataFailureBuilder {
        <PostWithdrawalUpdatedPayloadDataFailureBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostWithdrawalUpdatedPayloadDataFailureBuilder {
    code: Option<String>,
    funds_returned_at: Option<DateTime<FixedOffset>>,
    message: Option<String>,
}

impl PostWithdrawalUpdatedPayloadDataFailureBuilder {
    ...
    /// Consumes the builder and constructs a [`PostWithdrawalUpdatedPayloadDataFailure`].
    pub fn build(self) -> Result<PostWithdrawalUpdatedPayloadDataFailure, BuildError> {
        Ok(PostWithdrawalUpdatedPayloadDataFailure {
            code: self.code,
