...
pub enum ProductPublicPlanVisibility {
    Visible,
    Hidden,
    Archived,
    QuickLink,
...
impl Serialize for ProductPublicPlanVisibility {
...
impl<'de> Deserialize<'de> for ProductPublicPlanVisibility {
...
impl fmt::Display for ProductPublicPlanVisibility {
