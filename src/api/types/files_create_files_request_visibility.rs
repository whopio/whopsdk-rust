...
pub enum CreateFilesRequestVisibility {
    Public,
    Private,
...
impl Serialize for CreateFilesRequestVisibility {
...
impl<'de> Deserialize<'de> for CreateFilesRequestVisibility {
...
impl fmt::Display for CreateFilesRequestVisibility {
