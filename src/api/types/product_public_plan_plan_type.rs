...
pub enum ProductPublicPlanPlanType {
    Renewal,
    OneTime,
...
impl Serialize for ProductPublicPlanPlanType {
...
impl<'de> Deserialize<'de> for ProductPublicPlanPlanType {
...
impl fmt::Display for ProductPublicPlanPlanType {
