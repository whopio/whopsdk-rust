...
pub struct ListCheckoutConfigurationsResponseDataItem {
    ...
    pub effective_payment_method_configuration:
        Option<ListCheckoutConfigurationsResponseDataItemEffectivePaymentMethodConfiguration>,
    ...
    pub mode: ListCheckoutConfigurationsResponseDataItemMode,
    ...
    pub payment_method_configuration:
        Option<ListCheckoutConfigurationsResponseDataItemPaymentMethodConfiguration>,
    /// Plan used for payment checkout. `null` in setup mode.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub plan: Option<ListCheckoutConfigurationsResponseDataItemPlan>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub three_ds_level: Option<ListCheckoutConfigurationsResponseDataItemThreeDsLevel>,
    /// When the checkout configuration was last updated, as an ISO 8601 timestamp.
    #[serde(default)]
    pub updated_at: String,
}

impl ListCheckoutConfigurationsResponseDataItem {
    pub fn builder() -> ListCheckoutConfigurationsResponseDataItemBuilder {
        <ListCheckoutConfigurationsResponseDataItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListCheckoutConfigurationsResponseDataItemBuilder {
    ...
    mode: Option<ListCheckoutConfigurationsResponseDataItemMode>,
    payment_method_configuration:
        Option<ListCheckoutConfigurationsResponseDataItemPaymentMethodConfiguration>,
    plan: Option<ListCheckoutConfigurationsResponseDataItemPlan>,
    purchase_url: Option<String>,
    redirect_url: Option<String>,
    three_ds_level: Option<ListCheckoutConfigurationsResponseDataItemThreeDsLevel>,
    updated_at: Option<String>,
}

impl ListCheckoutConfigurationsResponseDataItemBuilder {
    ...
    pub fn effective_payment_method_configuration(
        mut self,
        value: ListCheckoutConfigurationsResponseDataItemEffectivePaymentMethodConfiguration,
    ) -> Self {
    ...
    pub fn mode(mut self, value: ListCheckoutConfigurationsResponseDataItemMode) -> Self {
    ...
    pub fn payment_method_configuration(
        mut self,
        value: ListCheckoutConfigurationsResponseDataItemPaymentMethodConfiguration,
    ) -> Self {
        self.payment_method_configuration = Some(value);
        self
    }

    pub fn plan(mut self, value: ListCheckoutConfigurationsResponseDataItemPlan) -> Self {
    ...
    pub fn three_ds_level(
        mut self,
        value: ListCheckoutConfigurationsResponseDataItemThreeDsLevel,
    ) -> Self {
    ...
    /// Consumes the builder and constructs a [`ListCheckoutConfigurationsResponseDataItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`account_id`](ListCheckoutConfigurationsResponseDataItemBuilder::account_id)
    /// - [`created_at`](ListCheckoutConfigurationsResponseDataItemBuilder::created_at)
    /// - [`id`](ListCheckoutConfigurationsResponseDataItemBuilder::id)
    /// - [`mode`](ListCheckoutConfigurationsResponseDataItemBuilder::mode)
    /// - [`updated_at`](ListCheckoutConfigurationsResponseDataItemBuilder::updated_at)
    pub fn build(self) -> Result<ListCheckoutConfigurationsResponseDataItem, BuildError> {
        Ok(ListCheckoutConfigurationsResponseDataItem {
            account_id: self
                .account_id
