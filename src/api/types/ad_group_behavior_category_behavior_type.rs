...
pub enum AdGroupBehaviorCategoryBehaviorType {
    Video,
    Creator,
    Hashtag,
...
impl Serialize for AdGroupBehaviorCategoryBehaviorType {
...
impl<'de> Deserialize<'de> for AdGroupBehaviorCategoryBehaviorType {
...
impl fmt::Display for AdGroupBehaviorCategoryBehaviorType {
