...
pub struct CreateInvoicesRequestProductBillingAddress {
...
impl CreateInvoicesRequestProductBillingAddress {
    pub fn builder() -> CreateInvoicesRequestProductBillingAddressBuilder {
        <CreateInvoicesRequestProductBillingAddressBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateInvoicesRequestProductBillingAddressBuilder {
    city: Option<String>,
...
impl CreateInvoicesRequestProductBillingAddressBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateInvoicesRequestProductBillingAddress`].
    pub fn build(self) -> Result<CreateInvoicesRequestProductBillingAddress, BuildError> {
        Ok(CreateInvoicesRequestProductBillingAddress {
            city: self.city,
