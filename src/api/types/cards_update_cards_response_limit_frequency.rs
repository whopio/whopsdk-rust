...
pub enum UpdateCardsResponseLimitFrequency {
    Daily,
    Weekly,
    Monthly,
    OneTime,
...
impl Serialize for UpdateCardsResponseLimitFrequency {
...
impl<'de> Deserialize<'de> for UpdateCardsResponseLimitFrequency {
...
impl fmt::Display for UpdateCardsResponseLimitFrequency {
