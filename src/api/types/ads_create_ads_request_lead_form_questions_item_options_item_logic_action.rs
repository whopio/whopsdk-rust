...
pub enum CreateAdsRequestLeadFormQuestionsItemOptionsItemLogicAction {
    GoToQuestion,
    SubmitForm,
    CloseForm,
...
impl Serialize for CreateAdsRequestLeadFormQuestionsItemOptionsItemLogicAction {
...
impl<'de> Deserialize<'de> for CreateAdsRequestLeadFormQuestionsItemOptionsItemLogicAction {
...
impl fmt::Display for CreateAdsRequestLeadFormQuestionsItemOptionsItemLogicAction {
