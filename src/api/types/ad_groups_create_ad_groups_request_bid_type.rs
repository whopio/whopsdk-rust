...
pub enum CreateAdGroupsRequestBidType {
    MinimumCost,
    AverageTarget,
    MaximumTarget,
...
impl Serialize for CreateAdGroupsRequestBidType {
...
impl<'de> Deserialize<'de> for CreateAdGroupsRequestBidType {
...
impl fmt::Display for CreateAdGroupsRequestBidType {
