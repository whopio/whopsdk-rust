...
pub enum SocialAccountParentPlatform {
    X,
    Instagram,
    Youtube,
    Tiktok,
...
impl Serialize for SocialAccountParentPlatform {
...
impl<'de> Deserialize<'de> for SocialAccountParentPlatform {
...
impl fmt::Display for SocialAccountParentPlatform {
