...
pub enum ListCardsResponseDataItemLimitFrequency {
    Daily,
    Weekly,
    Monthly,
    OneTime,
...
impl Serialize for ListCardsResponseDataItemLimitFrequency {
...
impl<'de> Deserialize<'de> for ListCardsResponseDataItemLimitFrequency {
...
impl fmt::Display for ListCardsResponseDataItemLimitFrequency {
