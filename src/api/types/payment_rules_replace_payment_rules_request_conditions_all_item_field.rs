...
pub enum ReplacePaymentRulesRequestConditionsAllItemField {
    RiskScore,
    CardCountry,
    CustomerEmail,
...
impl Serialize for ReplacePaymentRulesRequestConditionsAllItemField {
...
impl<'de> Deserialize<'de> for ReplacePaymentRulesRequestConditionsAllItemField {
...
impl fmt::Display for ReplacePaymentRulesRequestConditionsAllItemField {
