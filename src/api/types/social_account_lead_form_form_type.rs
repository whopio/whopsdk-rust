...
pub enum SocialAccountLeadFormFormType {
    MoreVolume,
    HigherIntent,
...
impl Serialize for SocialAccountLeadFormFormType {
...
impl<'de> Deserialize<'de> for SocialAccountLeadFormFormType {
...
impl fmt::Display for SocialAccountLeadFormFormType {
