...
pub enum CreateExperimentsRequestTargetingRulesItemConditionsItemType {
    UserId,
    AccountId,
    Property,
...
impl Serialize for CreateExperimentsRequestTargetingRulesItemConditionsItemType {
...
impl<'de> Deserialize<'de> for CreateExperimentsRequestTargetingRulesItemConditionsItemType {
...
impl fmt::Display for CreateExperimentsRequestTargetingRulesItemConditionsItemType {
