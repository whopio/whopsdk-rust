...
pub enum PostPayoutMethodCreatedPayloadDataSupportedPayoutMethodDeliveryType {
    CashPickup,
    BankDeposit,
    HomeDelivery,
    MobileWallet,
...
impl Serialize for PostPayoutMethodCreatedPayloadDataSupportedPayoutMethodDeliveryType {
...
impl<'de> Deserialize<'de> for PostPayoutMethodCreatedPayloadDataSupportedPayoutMethodDeliveryType {
...
impl fmt::Display for PostPayoutMethodCreatedPayloadDataSupportedPayoutMethodDeliveryType {
