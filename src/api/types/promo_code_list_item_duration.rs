...
pub enum PromoCodeListItemDuration {
    Forever,
    Once,
    Repeating,
...
impl Serialize for PromoCodeListItemDuration {
...
impl<'de> Deserialize<'de> for PromoCodeListItemDuration {
...
impl fmt::Display for PromoCodeListItemDuration {
