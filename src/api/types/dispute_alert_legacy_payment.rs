...
pub struct DisputeAlertLegacyPayment {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub member: Option<DisputeAlertLegacyPaymentMember>,
    /// The membership attached to this payment.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub membership: Option<DisputeAlertLegacyPaymentMembership>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub user: Option<DisputeAlertLegacyPaymentUser>,
}

impl DisputeAlertLegacyPayment {
    pub fn builder() -> DisputeAlertLegacyPaymentBuilder {
        <DisputeAlertLegacyPaymentBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct DisputeAlertLegacyPaymentBuilder {
    ...
    id: Option<String>,
    member: Option<DisputeAlertLegacyPaymentMember>,
    membership: Option<DisputeAlertLegacyPaymentMembership>,
    paid_at: Option<DateTime<FixedOffset>>,
    payment_method_type: Option<PaymentMethodTypes>,
    subtotal: Option<f64>,
    total: Option<f64>,
    usd_total: Option<f64>,
    user: Option<DisputeAlertLegacyPaymentUser>,
}

impl DisputeAlertLegacyPaymentBuilder {
    ...
    pub fn member(mut self, value: DisputeAlertLegacyPaymentMember) -> Self {
        self.member = Some(value);
        self
    }

    pub fn membership(mut self, value: DisputeAlertLegacyPaymentMembership) -> Self {
    ...
    pub fn user(mut self, value: DisputeAlertLegacyPaymentUser) -> Self {
        self.user = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`DisputeAlertLegacyPayment`].
    /// This method will fail if any of the following fields are not set:
    /// - [`created_at`](DisputeAlertLegacyPaymentBuilder::created_at)
    /// - [`currency`](DisputeAlertLegacyPaymentBuilder::currency)
    /// - [`id`](DisputeAlertLegacyPaymentBuilder::id)
    pub fn build(self) -> Result<DisputeAlertLegacyPayment, BuildError> {
        Ok(DisputeAlertLegacyPayment {
