...
pub enum PostAdUpdatedPayloadDataDeliveryStatus {
    Rejected,
    InReview,
    Draft,
    CampaignPaused,
...
impl Serialize for PostAdUpdatedPayloadDataDeliveryStatus {
...
impl<'de> Deserialize<'de> for PostAdUpdatedPayloadDataDeliveryStatus {
...
impl fmt::Display for PostAdUpdatedPayloadDataDeliveryStatus {
