...
pub enum ListCardsResponseDataItemStatus {
    Active,
    Frozen,
    Canceled,
    Invited,
...
impl Serialize for ListCardsResponseDataItemStatus {
...
impl<'de> Deserialize<'de> for ListCardsResponseDataItemStatus {
...
impl fmt::Display for ListCardsResponseDataItemStatus {
