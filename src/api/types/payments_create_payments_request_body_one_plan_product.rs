...
pub struct CreatePaymentsRequestBodyOnePlanProduct {
...
impl CreatePaymentsRequestBodyOnePlanProduct {
    pub fn builder() -> CreatePaymentsRequestBodyOnePlanProductBuilder {
        <CreatePaymentsRequestBodyOnePlanProductBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreatePaymentsRequestBodyOnePlanProductBuilder {
...
impl CreatePaymentsRequestBodyOnePlanProductBuilder {
    ...
    /// Consumes the builder and constructs a [`CreatePaymentsRequestBodyOnePlanProduct`].
    /// This method will fail if any of the following fields are not set:
    /// - [`external_identifier`](CreatePaymentsRequestBodyOnePlanProductBuilder::external_identifier)
    /// - [`title`](CreatePaymentsRequestBodyOnePlanProductBuilder::title)
    pub fn build(self) -> Result<CreatePaymentsRequestBodyOnePlanProduct, BuildError> {
        Ok(CreatePaymentsRequestBodyOnePlanProduct {
