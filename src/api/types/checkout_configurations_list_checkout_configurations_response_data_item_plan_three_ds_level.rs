...
pub enum ListCheckoutConfigurationsResponseDataItemPlanThreeDsLevel {
    MandateChallenge,
    Frictionless,
...
impl Serialize for ListCheckoutConfigurationsResponseDataItemPlanThreeDsLevel {
...
impl<'de> Deserialize<'de> for ListCheckoutConfigurationsResponseDataItemPlanThreeDsLevel {
...
impl fmt::Display for ListCheckoutConfigurationsResponseDataItemPlanThreeDsLevel {
