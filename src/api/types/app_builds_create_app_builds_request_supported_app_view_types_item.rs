...
pub enum CreateAppBuildsRequestSupportedAppViewTypesItem {
    Hub,
    Discover,
    Dash,
    Dashboard,
...
impl Serialize for CreateAppBuildsRequestSupportedAppViewTypesItem {
...
impl<'de> Deserialize<'de> for CreateAppBuildsRequestSupportedAppViewTypesItem {
...
impl fmt::Display for CreateAppBuildsRequestSupportedAppViewTypesItem {
