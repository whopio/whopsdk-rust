...
pub struct PaymentLegacyResolutionsItem {
...
impl PaymentLegacyResolutionsItem {
    pub fn builder() -> PaymentLegacyResolutionsItemBuilder {
        <PaymentLegacyResolutionsItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PaymentLegacyResolutionsItemBuilder {
...
impl PaymentLegacyResolutionsItemBuilder {
    ...
    /// Consumes the builder and constructs a [`PaymentLegacyResolutionsItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`customer_appealed`](PaymentLegacyResolutionsItemBuilder::customer_appealed)
    /// - [`customer_response_actions`](PaymentLegacyResolutionsItemBuilder::customer_response_actions)
    /// - [`id`](PaymentLegacyResolutionsItemBuilder::id)
    /// - [`issue`](PaymentLegacyResolutionsItemBuilder::issue)
    /// - [`merchant_appealed`](PaymentLegacyResolutionsItemBuilder::merchant_appealed)
    /// - [`merchant_response_actions`](PaymentLegacyResolutionsItemBuilder::merchant_response_actions)
    /// - [`platform_response_actions`](PaymentLegacyResolutionsItemBuilder::platform_response_actions)
    /// - [`status`](PaymentLegacyResolutionsItemBuilder::status)
    pub fn build(self) -> Result<PaymentLegacyResolutionsItem, BuildError> {
        Ok(PaymentLegacyResolutionsItem {
