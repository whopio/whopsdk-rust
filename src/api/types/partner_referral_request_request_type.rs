...
pub enum PartnerReferralRequestRequestType {
    Manual,
    OwnershipTransfer,
    RewardLink,
...
impl Serialize for PartnerReferralRequestRequestType {
...
impl<'de> Deserialize<'de> for PartnerReferralRequestRequestType {
...
impl fmt::Display for PartnerReferralRequestRequestType {
