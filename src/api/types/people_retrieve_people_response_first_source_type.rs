...
pub enum RetrievePeopleResponseFirstSourceType {
    AdClick,
    LeadForm,
    ExternalAdClick,
    Referrer,
...
impl Serialize for RetrievePeopleResponseFirstSourceType {
...
impl<'de> Deserialize<'de> for RetrievePeopleResponseFirstSourceType {
...
impl fmt::Display for RetrievePeopleResponseFirstSourceType {
