...
pub enum PostAdUpdatedPayloadDataPostSource {
    Facebook,
    Instagram,
...
impl Serialize for PostAdUpdatedPayloadDataPostSource {
...
impl<'de> Deserialize<'de> for PostAdUpdatedPayloadDataPostSource {
...
impl fmt::Display for PostAdUpdatedPayloadDataPostSource {
