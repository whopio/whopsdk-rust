...
pub struct CreateInvoicesRequestBodyProductPlanPaymentMethodConfiguration {
...
impl CreateInvoicesRequestBodyProductPlanPaymentMethodConfiguration {
    pub fn builder() -> CreateInvoicesRequestBodyProductPlanPaymentMethodConfigurationBuilder {
        <CreateInvoicesRequestBodyProductPlanPaymentMethodConfigurationBuilder as Default>::default(
        )
    }
}
...
#[non_exhaustive]
pub struct CreateInvoicesRequestBodyProductPlanPaymentMethodConfigurationBuilder {
    disabled: Option<Vec<PaymentMethodTypes>>,
    enabled: Option<Vec<PaymentMethodTypes>>,
    include_platform_defaults: Option<bool>,
}

impl CreateInvoicesRequestBodyProductPlanPaymentMethodConfigurationBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateInvoicesRequestBodyProductPlanPaymentMethodConfiguration`].
    /// This method will fail if any of the following fields are not set:
    /// - [`disabled`](CreateInvoicesRequestBodyProductPlanPaymentMethodConfigurationBuilder::disabled)
    /// - [`enabled`](CreateInvoicesRequestBodyProductPlanPaymentMethodConfigurationBuilder::enabled)
    pub fn build(
        self,
    ) -> Result<CreateInvoicesRequestBodyProductPlanPaymentMethodConfiguration, BuildError> {
        Ok(
            CreateInvoicesRequestBodyProductPlanPaymentMethodConfiguration {
                disabled: self
                    .disabled
