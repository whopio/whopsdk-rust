...
pub enum ListPayoutsResponseDataItemSource {
    Api,
    Dashboard,
    Automatic,
...
impl Serialize for ListPayoutsResponseDataItemSource {
...
impl<'de> Deserialize<'de> for ListPayoutsResponseDataItemSource {
...
impl fmt::Display for ListPayoutsResponseDataItemSource {
