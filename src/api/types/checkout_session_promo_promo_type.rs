...
pub enum CheckoutSessionPromoPromoType {
    Percentage,
    FlatAmount,
...
impl Serialize for CheckoutSessionPromoPromoType {
...
impl<'de> Deserialize<'de> for CheckoutSessionPromoPromoType {
...
impl fmt::Display for CheckoutSessionPromoPromoType {
