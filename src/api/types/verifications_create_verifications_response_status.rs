...
pub enum CreateVerificationsResponseStatus {
    NotStarted,
    Pending,
    Processing,
    ManualReview,
...
impl Serialize for CreateVerificationsResponseStatus {
...
impl<'de> Deserialize<'de> for CreateVerificationsResponseStatus {
...
impl fmt::Display for CreateVerificationsResponseStatus {
