...
pub struct IdentityProfileListItem {
    /// Registered business address reported by the identity provider. Present on `business` profiles.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub business_address: Option<IdentityProfileListItemBusinessAddress>,
    ...
    #[serde(default)]
    pub linked_companies: Vec<IdentityProfileListItemLinkedCompaniesItem>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub personal_address: Option<IdentityProfileListItemPersonalAddress>,
    ...
    #[serde(default)]
    pub verifications: Vec<IdentityProfileListItemVerificationsItem>,
}

impl IdentityProfileListItem {
    pub fn builder() -> IdentityProfileListItemBuilder {
        <IdentityProfileListItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct IdentityProfileListItemBuilder {
    business_address: Option<IdentityProfileListItemBusinessAddress>,
    ...
    linked_companies: Option<Vec<IdentityProfileListItemLinkedCompaniesItem>>,
    payout_status: Option<PayoutAccountCalculatedStatuses>,
    payouts_enabled: Option<bool>,
    personal_address: Option<IdentityProfileListItemPersonalAddress>,
    phone: Option<String>,
    profile_type: Option<String>,
    status: Option<IdentityProfileStatuses>,
    updated_at: Option<DateTime<FixedOffset>>,
    verifications: Option<Vec<IdentityProfileListItemVerificationsItem>>,
}

impl IdentityProfileListItemBuilder {
    pub fn business_address(mut self, value: IdentityProfileListItemBusinessAddress) -> Self {
    ...
    pub fn linked_companies(
        mut self,
        value: Vec<IdentityProfileListItemLinkedCompaniesItem>,
    ) -> Self {
    ...
    pub fn personal_address(mut self, value: IdentityProfileListItemPersonalAddress) -> Self {
    ...
    pub fn verifications(mut self, value: Vec<IdentityProfileListItemVerificationsItem>) -> Self {
        self.verifications = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`IdentityProfileListItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`created_at`](IdentityProfileListItemBuilder::created_at)
    /// - [`id`](IdentityProfileListItemBuilder::id)
    /// - [`linked_companies`](IdentityProfileListItemBuilder::linked_companies)
    /// - [`payout_status`](IdentityProfileListItemBuilder::payout_status)
    /// - [`payouts_enabled`](IdentityProfileListItemBuilder::payouts_enabled)
    /// - [`profile_type`](IdentityProfileListItemBuilder::profile_type)
    /// - [`status`](IdentityProfileListItemBuilder::status)
    /// - [`updated_at`](IdentityProfileListItemBuilder::updated_at)
    /// - [`verifications`](IdentityProfileListItemBuilder::verifications)
    pub fn build(self) -> Result<IdentityProfileListItem, BuildError> {
        Ok(IdentityProfileListItem {
