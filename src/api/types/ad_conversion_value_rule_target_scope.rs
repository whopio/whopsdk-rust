...
pub enum AdConversionValueRuleTargetScope {
    Business,
    Campaign,
    AdGroup,
    Ad,
...
impl Serialize for AdConversionValueRuleTargetScope {
...
impl<'de> Deserialize<'de> for AdConversionValueRuleTargetScope {
...
impl fmt::Display for AdConversionValueRuleTargetScope {
