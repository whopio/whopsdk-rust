...
pub enum CreatePayoutsResponseSource {
    Api,
    Dashboard,
    Automatic,
...
impl Serialize for CreatePayoutsResponseSource {
...
impl<'de> Deserialize<'de> for CreatePayoutsResponseSource {
...
impl fmt::Display for CreatePayoutsResponseSource {
