...
pub enum PostPayoutCreatedPayloadDataStatus {
    Requested,
    InReview,
    Processing,
    Completed,
...
impl Serialize for PostPayoutCreatedPayloadDataStatus {
...
impl<'de> Deserialize<'de> for PostPayoutCreatedPayloadDataStatus {
...
impl fmt::Display for PostPayoutCreatedPayloadDataStatus {
