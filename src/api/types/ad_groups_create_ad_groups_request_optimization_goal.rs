...
pub enum CreateAdGroupsRequestOptimizationGoal {
    Conversions,
    LinkClicks,
    LandingPageViews,
    Reach,
...
impl Serialize for CreateAdGroupsRequestOptimizationGoal {
...
impl<'de> Deserialize<'de> for CreateAdGroupsRequestOptimizationGoal {
...
impl fmt::Display for CreateAdGroupsRequestOptimizationGoal {
