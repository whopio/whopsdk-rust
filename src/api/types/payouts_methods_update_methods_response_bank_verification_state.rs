...
pub enum UpdateMethodsResponseBankVerificationState {
    Checking,
    Verified,
    NoData,
    Warning,
...
impl Serialize for UpdateMethodsResponseBankVerificationState {
...
impl<'de> Deserialize<'de> for UpdateMethodsResponseBankVerificationState {
...
impl fmt::Display for UpdateMethodsResponseBankVerificationState {
