...
pub struct ListBusinessesResponseDataItem {
    /// Referred account.
    ...
    #[serde(default)]
    pub earnings_usd: ListBusinessesResponseDataItemEarningsUsd,
    /// The partner who referred the business owner onto Whop (first tier). Null if there is no active first-tier partner.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub first_tier_partner: Option<ListBusinessesResponseDataItemFirstTierPartner>,
    /// Partner business ID.
    #[serde(default)]
    pub id: String,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub owner: Option<ListBusinessesResponseDataItemOwner>,
    /// The referrer's commission rate for each income source, expressed as a fraction (0.3 = 30%).
    #[serde(default)]
    pub payout_percentages: ListBusinessesResponseDataItemPayoutPercentages,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub second_tier_partner: Option<ListBusinessesResponseDataItemSecondTierPartner>,
    /// Current referral status.
    pub status: ListBusinessesResponseDataItemStatus,
    #[serde(default)]
    pub volume_usd: ListBusinessesResponseDataItemVolumeUsd,
}

impl ListBusinessesResponseDataItem {
    pub fn builder() -> ListBusinessesResponseDataItemBuilder {
        <ListBusinessesResponseDataItemBuilder as Default>::default()
    }
}
...
pub struct ListBusinessesResponseDataItemBuilder {
    ...
    id: Option<String>,
    my_partner_tier: Option<ListBusinessesResponseDataItemMyPartnerTier>,
    object: Option<ListBusinessesResponseDataItemObject>,
    owner: Option<ListBusinessesResponseDataItemOwner>,
    payout_percentages: Option<ListBusinessesResponseDataItemPayoutPercentages>,
    referral_expires_at: Option<DateTime<FixedOffset>>,
    referral_started_at: Option<DateTime<FixedOffset>>,
    second_tier_partner: Option<ListBusinessesResponseDataItemSecondTierPartner>,
    status: Option<ListBusinessesResponseDataItemStatus>,
    volume_usd: Option<ListBusinessesResponseDataItemVolumeUsd>,
}
...
impl ListBusinessesResponseDataItemBuilder {
    ...
    pub fn earnings_usd(mut self, value: ListBusinessesResponseDataItemEarningsUsd) -> Self {
        self.earnings_usd = Some(value);
        self
    }

    pub fn first_tier_partner(
        mut self,
        value: ListBusinessesResponseDataItemFirstTierPartner,
    ) -> Self {
    ...
    pub fn my_partner_tier(mut self, value: ListBusinessesResponseDataItemMyPartnerTier) -> Self {
        self.my_partner_tier = Some(value);
        self
    }

    pub fn object(mut self, value: ListBusinessesResponseDataItemObject) -> Self {
        self.object = Some(value);
        self
    }

    pub fn owner(mut self, value: ListBusinessesResponseDataItemOwner) -> Self {
    ...
    pub fn payout_percentages(
        mut self,
        value: ListBusinessesResponseDataItemPayoutPercentages,
    ) -> Self {
    ...
    pub fn second_tier_partner(
        mut self,
        value: ListBusinessesResponseDataItemSecondTierPartner,
    ) -> Self {
        self.second_tier_partner = Some(value);
        self
    }

    pub fn status(mut self, value: ListBusinessesResponseDataItemStatus) -> Self {
        self.status = Some(value);
        self
    }

    pub fn volume_usd(mut self, value: ListBusinessesResponseDataItemVolumeUsd) -> Self {
        self.volume_usd = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`ListBusinessesResponseDataItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`created_at`](ListBusinessesResponseDataItemBuilder::created_at)
    /// - [`earnings_usd`](ListBusinessesResponseDataItemBuilder::earnings_usd)
    /// - [`id`](ListBusinessesResponseDataItemBuilder::id)
    /// - [`my_partner_tier`](ListBusinessesResponseDataItemBuilder::my_partner_tier)
    /// - [`object`](ListBusinessesResponseDataItemBuilder::object)
    /// - [`payout_percentages`](ListBusinessesResponseDataItemBuilder::payout_percentages)
    /// - [`status`](ListBusinessesResponseDataItemBuilder::status)
    /// - [`volume_usd`](ListBusinessesResponseDataItemBuilder::volume_usd)
