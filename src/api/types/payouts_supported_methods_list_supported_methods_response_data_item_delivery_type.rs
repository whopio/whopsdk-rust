...
pub enum ListSupportedMethodsResponseDataItemDeliveryType {
    CashPickup,
    BankDeposit,
    HomeDelivery,
    MobileWallet,
...
impl Serialize for ListSupportedMethodsResponseDataItemDeliveryType {
...
impl<'de> Deserialize<'de> for ListSupportedMethodsResponseDataItemDeliveryType {
...
impl fmt::Display for ListSupportedMethodsResponseDataItemDeliveryType {
