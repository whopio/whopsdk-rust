...
pub struct PostPayoutCreatedPayloadDataFailure {
...
impl PostPayoutCreatedPayloadDataFailure {
    pub fn builder() -> PostPayoutCreatedPayloadDataFailureBuilder {
        <PostPayoutCreatedPayloadDataFailureBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostPayoutCreatedPayloadDataFailureBuilder {
    code: Option<String>,
    funds_returned_at: Option<DateTime<FixedOffset>>,
    message: Option<String>,
}

impl PostPayoutCreatedPayloadDataFailureBuilder {
    ...
    /// Consumes the builder and constructs a [`PostPayoutCreatedPayloadDataFailure`].
    pub fn build(self) -> Result<PostPayoutCreatedPayloadDataFailure, BuildError> {
        Ok(PostPayoutCreatedPayloadDataFailure {
            code: self.code,
