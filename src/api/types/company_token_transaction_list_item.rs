...
pub struct CompanyTokenTransactionListItem {
    ...
    #[serde(default)]
    pub company: CompanyTokenTransactionListItemCompany,
    ...
    #[serde(default)]
    pub member: CompanyTokenTransactionListItemMember,
    ...
    #[serde(default)]
    pub user: CompanyTokenTransactionListItemUser,
}

impl CompanyTokenTransactionListItem {
    pub fn builder() -> CompanyTokenTransactionListItemBuilder {
        <CompanyTokenTransactionListItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CompanyTokenTransactionListItemBuilder {
    amount: Option<f64>,
    company: Option<CompanyTokenTransactionListItemCompany>,
    created_at: Option<DateTime<FixedOffset>>,
    description: Option<String>,
    id: Option<String>,
    idempotency_key: Option<String>,
    linked_transaction_id: Option<String>,
    member: Option<CompanyTokenTransactionListItemMember>,
    transaction_type: Option<CompanyTokenTransactionTypes>,
    user: Option<CompanyTokenTransactionListItemUser>,
}

impl CompanyTokenTransactionListItemBuilder {
    pub fn amount(mut self, value: f64) -> Self {
        self.amount = Some(value);
        self
    }

    pub fn company(mut self, value: CompanyTokenTransactionListItemCompany) -> Self {
    ...
    pub fn member(mut self, value: CompanyTokenTransactionListItemMember) -> Self {
    ...
    pub fn user(mut self, value: CompanyTokenTransactionListItemUser) -> Self {
        self.user = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`CompanyTokenTransactionListItem`].
    /// This method will fail if any of the following fields are not set:
    /// - [`amount`](CompanyTokenTransactionListItemBuilder::amount)
    /// - [`company`](CompanyTokenTransactionListItemBuilder::company)
    /// - [`created_at`](CompanyTokenTransactionListItemBuilder::created_at)
    /// - [`id`](CompanyTokenTransactionListItemBuilder::id)
    /// - [`member`](CompanyTokenTransactionListItemBuilder::member)
    /// - [`transaction_type`](CompanyTokenTransactionListItemBuilder::transaction_type)
    /// - [`user`](CompanyTokenTransactionListItemBuilder::user)
    pub fn build(self) -> Result<CompanyTokenTransactionListItem, BuildError> {
        Ok(CompanyTokenTransactionListItem {
            amount: self
                .amount
