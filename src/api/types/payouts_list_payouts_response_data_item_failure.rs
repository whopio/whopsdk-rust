...
pub struct ListPayoutsResponseDataItemFailure {
...
impl ListPayoutsResponseDataItemFailure {
    pub fn builder() -> ListPayoutsResponseDataItemFailureBuilder {
        <ListPayoutsResponseDataItemFailureBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListPayoutsResponseDataItemFailureBuilder {
    code: Option<String>,
    funds_returned_at: Option<DateTime<FixedOffset>>,
    message: Option<String>,
}

impl ListPayoutsResponseDataItemFailureBuilder {
    ...
    /// Consumes the builder and constructs a [`ListPayoutsResponseDataItemFailure`].
    pub fn build(self) -> Result<ListPayoutsResponseDataItemFailure, BuildError> {
        Ok(ListPayoutsResponseDataItemFailure {
            code: self.code,
