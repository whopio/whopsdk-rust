...
pub enum LogsAppsResponseDataItemLevel {
    Log,
    Debug,
    Info,
    Warn,
...
impl Serialize for LogsAppsResponseDataItemLevel {
...
impl<'de> Deserialize<'de> for LogsAppsResponseDataItemLevel {
...
impl fmt::Display for LogsAppsResponseDataItemLevel {
