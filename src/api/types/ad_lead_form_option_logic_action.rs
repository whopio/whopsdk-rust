...
pub enum AdLeadFormOptionLogicAction {
    GoToQuestion,
    SubmitForm,
    CloseForm,
...
impl Serialize for AdLeadFormOptionLogicAction {
...
impl<'de> Deserialize<'de> for AdLeadFormOptionLogicAction {
...
impl fmt::Display for AdLeadFormOptionLogicAction {
