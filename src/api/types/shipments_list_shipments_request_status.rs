...
pub enum ListShipmentsRequestStatus {
    Unknown,
    PreTransit,
    InTransit,
    OutForDelivery,
...
impl Serialize for ListShipmentsRequestStatus {
...
impl<'de> Deserialize<'de> for ListShipmentsRequestStatus {
...
impl fmt::Display for ListShipmentsRequestStatus {
