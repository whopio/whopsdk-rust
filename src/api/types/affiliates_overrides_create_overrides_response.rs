...
pub struct CreateOverridesResponse {
...
impl CreateOverridesResponse {
    pub fn builder() -> CreateOverridesResponseBuilder {
        <CreateOverridesResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateOverridesResponseBuilder {
...
impl CreateOverridesResponseBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateOverridesResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`commission_type`](CreateOverridesResponseBuilder::commission_type)
    /// - [`commission_value`](CreateOverridesResponseBuilder::commission_value)
    /// - [`id`](CreateOverridesResponseBuilder::id)
    /// - [`override_type`](CreateOverridesResponseBuilder::override_type)
    /// - [`total_referral_earnings_usd`](CreateOverridesResponseBuilder::total_referral_earnings_usd)
    pub fn build(self) -> Result<CreateOverridesResponse, BuildError> {
        Ok(CreateOverridesResponse {
