...
pub struct CourseLessonMainPdf {
...
impl CourseLessonMainPdf {
    pub fn builder() -> CourseLessonMainPdfBuilder {
        <CourseLessonMainPdfBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CourseLessonMainPdfBuilder {
...
impl CourseLessonMainPdfBuilder {
    ...
    /// Consumes the builder and constructs a [`CourseLessonMainPdf`].
    /// This method will fail if any of the following fields are not set:
    /// - [`id`](CourseLessonMainPdfBuilder::id)
    pub fn build(self) -> Result<CourseLessonMainPdf, BuildError> {
        Ok(CourseLessonMainPdf {
