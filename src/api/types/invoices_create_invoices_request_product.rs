...
pub struct CreateInvoicesRequestProduct {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub billing_address: Option<CreateInvoicesRequestProductBillingAddress>,
...
impl CreateInvoicesRequestProduct {
    pub fn builder() -> CreateInvoicesRequestProductBuilder {
        <CreateInvoicesRequestProductBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateInvoicesRequestProductBuilder {
    automatically_finalizes_at: Option<DateTime<FixedOffset>>,
    billing_address: Option<CreateInvoicesRequestProductBillingAddress>,
    ...
    line_items: Option<Vec<CreateInvoicesRequestProductLineItemsItem>>,
    mailing_address_id: Option<String>,
    member_id: Option<String>,
    payment_method_id: Option<String>,
    payment_token_id: Option<String>,
    plan: Option<CreateInvoicesRequestProductPlan>,
    product: Option<CreateInvoicesRequestProductProduct>,
    save_as_draft: Option<bool>,
    subscription_billing_anchor_at: Option<DateTime<FixedOffset>>,
}

impl CreateInvoicesRequestProductBuilder {
    pub fn automatically_finalizes_at(mut self, value: DateTime<FixedOffset>) -> Self {
        self.automatically_finalizes_at = Some(value);
        self
    }

    pub fn billing_address(mut self, value: CreateInvoicesRequestProductBillingAddress) -> Self {
    ...
    pub fn line_items(mut self, value: Vec<CreateInvoicesRequestProductLineItemsItem>) -> Self {
    ...
    pub fn plan(mut self, value: CreateInvoicesRequestProductPlan) -> Self {
        self.plan = Some(value);
        self
    }

    pub fn product(mut self, value: CreateInvoicesRequestProductProduct) -> Self {
    ...
    /// Consumes the builder and constructs a [`CreateInvoicesRequestProduct`].
    /// This method will fail if any of the following fields are not set:
    /// - [`collection_method`](CreateInvoicesRequestProductBuilder::collection_method)
    /// - [`company_id`](CreateInvoicesRequestProductBuilder::company_id)
    /// - [`plan`](CreateInvoicesRequestProductBuilder::plan)
    /// - [`product`](CreateInvoicesRequestProductBuilder::product)
    pub fn build(self) -> Result<CreateInvoicesRequestProduct, BuildError> {
        Ok(CreateInvoicesRequestProduct {
