...
pub enum CreateAdCampaignsRequestSpecialAdCategoriesItem {
    Housing,
    Employment,
    FinancialProducts,
    Politics,
...
impl Serialize for CreateAdCampaignsRequestSpecialAdCategoriesItem {
...
impl<'de> Deserialize<'de> for CreateAdCampaignsRequestSpecialAdCategoriesItem {
...
impl fmt::Display for CreateAdCampaignsRequestSpecialAdCategoriesItem {
