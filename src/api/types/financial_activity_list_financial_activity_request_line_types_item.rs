...
pub enum ListFinancialActivityRequestLineTypesItem {
    AdBudgetRelease,
    AdCampaignBudget,
    AdPublisherPayout,
...
impl Serialize for ListFinancialActivityRequestLineTypesItem {
...
impl<'de> Deserialize<'de> for ListFinancialActivityRequestLineTypesItem {
...
impl fmt::Display for ListFinancialActivityRequestLineTypesItem {
