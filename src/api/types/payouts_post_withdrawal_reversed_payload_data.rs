...
pub struct PostWithdrawalReversedPayloadData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub failure: Option<PostWithdrawalReversedPayloadDataFailure>,
    ...
    pub fee_paid_by: PostWithdrawalReversedPayloadDataFeePaidBy,
    ...
    pub object: PostWithdrawalReversedPayloadDataObject,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub payout_method: Option<PostWithdrawalReversedPayloadDataPayoutMethod>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub source: Option<PostWithdrawalReversedPayloadDataSource>,
    /// Payout delivery speed.
    pub speed: PostWithdrawalReversedPayloadDataSpeed,
    /// Current payout status.
    pub status: PostWithdrawalReversedPayloadDataStatus,
...
impl PostWithdrawalReversedPayloadData {
    pub fn builder() -> PostWithdrawalReversedPayloadDataBuilder {
        <PostWithdrawalReversedPayloadDataBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostWithdrawalReversedPayloadDataBuilder {
    ...
    failure: Option<PostWithdrawalReversedPayloadDataFailure>,
    fee_amount: Option<String>,
    fee_paid_by: Option<PostWithdrawalReversedPayloadDataFeePaidBy>,
    id: Option<String>,
    markup_fee: Option<String>,
    metadata: Option<HashMap<String, String>>,
    net_amount: Option<String>,
    notes: Option<String>,
    object: Option<PostWithdrawalReversedPayloadDataObject>,
    payer_name: Option<String>,
    payout_method: Option<PostWithdrawalReversedPayloadDataPayoutMethod>,
    payout_request_id: Option<String>,
    source: Option<PostWithdrawalReversedPayloadDataSource>,
    speed: Option<PostWithdrawalReversedPayloadDataSpeed>,
    status: Option<PostWithdrawalReversedPayloadDataStatus>,
    status_detail: Option<String>,
    trace_code: Option<String>,
}

impl PostWithdrawalReversedPayloadDataBuilder {
    ...
    pub fn failure(mut self, value: PostWithdrawalReversedPayloadDataFailure) -> Self {
    ...
    pub fn fee_paid_by(mut self, value: PostWithdrawalReversedPayloadDataFeePaidBy) -> Self {
    ...
    pub fn object(mut self, value: PostWithdrawalReversedPayloadDataObject) -> Self {
    ...
    pub fn payout_method(mut self, value: PostWithdrawalReversedPayloadDataPayoutMethod) -> Self {
    ...
    pub fn source(mut self, value: PostWithdrawalReversedPayloadDataSource) -> Self {
        self.source = Some(value);
        self
    }

    pub fn speed(mut self, value: PostWithdrawalReversedPayloadDataSpeed) -> Self {
        self.speed = Some(value);
        self
    }

    pub fn status(mut self, value: PostWithdrawalReversedPayloadDataStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`PostWithdrawalReversedPayloadData`].
    /// This method will fail if any of the following fields are not set:
    /// - [`amount`](PostWithdrawalReversedPayloadDataBuilder::amount)
    /// - [`created_at`](PostWithdrawalReversedPayloadDataBuilder::created_at)
    /// - [`currency`](PostWithdrawalReversedPayloadDataBuilder::currency)
    /// - [`fee_amount`](PostWithdrawalReversedPayloadDataBuilder::fee_amount)
    /// - [`fee_paid_by`](PostWithdrawalReversedPayloadDataBuilder::fee_paid_by)
    /// - [`id`](PostWithdrawalReversedPayloadDataBuilder::id)
    /// - [`markup_fee`](PostWithdrawalReversedPayloadDataBuilder::markup_fee)
    /// - [`metadata`](PostWithdrawalReversedPayloadDataBuilder::metadata)
    /// - [`net_amount`](PostWithdrawalReversedPayloadDataBuilder::net_amount)
    /// - [`object`](PostWithdrawalReversedPayloadDataBuilder::object)
    /// - [`speed`](PostWithdrawalReversedPayloadDataBuilder::speed)
    /// - [`status`](PostWithdrawalReversedPayloadDataBuilder::status)
    /// - [`status_detail`](PostWithdrawalReversedPayloadDataBuilder::status_detail)
    pub fn build(self) -> Result<PostWithdrawalReversedPayloadData, BuildError> {
        Ok(PostWithdrawalReversedPayloadData {
            amount: self
                .amount
