...
pub struct AdGroupsRetrieveQueryRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub attribution_model: Option<RetrieveAdGroupsRequestAttributionModel>,
}

impl AdGroupsRetrieveQueryRequest {
    pub fn builder() -> AdGroupsRetrieveQueryRequestBuilder {
        <AdGroupsRetrieveQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct AdGroupsRetrieveQueryRequestBuilder {
...
impl AdGroupsRetrieveQueryRequestBuilder {
    ...
    pub fn attribution_model(mut self, value: RetrieveAdGroupsRequestAttributionModel) -> Self {
        self.attribution_model = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`AdGroupsRetrieveQueryRequest`].
    pub fn build(self) -> Result<AdGroupsRetrieveQueryRequest, BuildError> {
        Ok(AdGroupsRetrieveQueryRequest {
