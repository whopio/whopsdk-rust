...
pub enum CreateAdGroupsRequestConversionLocation {
    Website,
    Profile,
...
impl Serialize for CreateAdGroupsRequestConversionLocation {
...
impl<'de> Deserialize<'de> for CreateAdGroupsRequestConversionLocation {
...
impl fmt::Display for CreateAdGroupsRequestConversionLocation {
