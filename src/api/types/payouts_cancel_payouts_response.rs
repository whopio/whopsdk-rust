...
pub struct CancelPayoutsResponse {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub failure: Option<CancelPayoutsResponseFailure>,
    ...
    pub fee_paid_by: CancelPayoutsResponseFeePaidBy,
    ...
    pub object: CancelPayoutsResponseObject,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub payout_method: Option<CancelPayoutsResponsePayoutMethod>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub source: Option<CancelPayoutsResponseSource>,
    /// Payout delivery speed.
    pub speed: CancelPayoutsResponseSpeed,
    /// Current payout status.
    pub status: CancelPayoutsResponseStatus,
...
impl CancelPayoutsResponse {
    pub fn builder() -> CancelPayoutsResponseBuilder {
        <CancelPayoutsResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CancelPayoutsResponseBuilder {
    ...
    failure: Option<CancelPayoutsResponseFailure>,
    fee_amount: Option<String>,
    fee_paid_by: Option<CancelPayoutsResponseFeePaidBy>,
    id: Option<String>,
    markup_fee: Option<String>,
    metadata: Option<HashMap<String, String>>,
    net_amount: Option<String>,
    notes: Option<String>,
    object: Option<CancelPayoutsResponseObject>,
    payer_name: Option<String>,
    payout_method: Option<CancelPayoutsResponsePayoutMethod>,
    payout_request_id: Option<String>,
    source: Option<CancelPayoutsResponseSource>,
    speed: Option<CancelPayoutsResponseSpeed>,
    status: Option<CancelPayoutsResponseStatus>,
    status_detail: Option<String>,
    trace_code: Option<String>,
}

impl CancelPayoutsResponseBuilder {
    ...
    pub fn failure(mut self, value: CancelPayoutsResponseFailure) -> Self {
    ...
    pub fn fee_paid_by(mut self, value: CancelPayoutsResponseFeePaidBy) -> Self {
    ...
    pub fn object(mut self, value: CancelPayoutsResponseObject) -> Self {
    ...
    pub fn payout_method(mut self, value: CancelPayoutsResponsePayoutMethod) -> Self {
    ...
    pub fn source(mut self, value: CancelPayoutsResponseSource) -> Self {
        self.source = Some(value);
        self
    }

    pub fn speed(mut self, value: CancelPayoutsResponseSpeed) -> Self {
        self.speed = Some(value);
        self
    }

    pub fn status(mut self, value: CancelPayoutsResponseStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`CancelPayoutsResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`amount`](CancelPayoutsResponseBuilder::amount)
    /// - [`created_at`](CancelPayoutsResponseBuilder::created_at)
    /// - [`currency`](CancelPayoutsResponseBuilder::currency)
    /// - [`fee_amount`](CancelPayoutsResponseBuilder::fee_amount)
    /// - [`fee_paid_by`](CancelPayoutsResponseBuilder::fee_paid_by)
    /// - [`id`](CancelPayoutsResponseBuilder::id)
    /// - [`markup_fee`](CancelPayoutsResponseBuilder::markup_fee)
    /// - [`metadata`](CancelPayoutsResponseBuilder::metadata)
    /// - [`net_amount`](CancelPayoutsResponseBuilder::net_amount)
    /// - [`object`](CancelPayoutsResponseBuilder::object)
    /// - [`speed`](CancelPayoutsResponseBuilder::speed)
    /// - [`status`](CancelPayoutsResponseBuilder::status)
    /// - [`status_detail`](CancelPayoutsResponseBuilder::status_detail)
    pub fn build(self) -> Result<CancelPayoutsResponse, BuildError> {
        Ok(CancelPayoutsResponse {
            amount: self
                .amount
