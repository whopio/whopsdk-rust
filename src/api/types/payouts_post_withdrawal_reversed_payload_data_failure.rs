...
pub struct PostWithdrawalReversedPayloadDataFailure {
...
impl PostWithdrawalReversedPayloadDataFailure {
    pub fn builder() -> PostWithdrawalReversedPayloadDataFailureBuilder {
        <PostWithdrawalReversedPayloadDataFailureBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PostWithdrawalReversedPayloadDataFailureBuilder {
    code: Option<String>,
    funds_returned_at: Option<DateTime<FixedOffset>>,
    message: Option<String>,
}

impl PostWithdrawalReversedPayloadDataFailureBuilder {
    ...
    /// Consumes the builder and constructs a [`PostWithdrawalReversedPayloadDataFailure`].
    pub fn build(self) -> Result<PostWithdrawalReversedPayloadDataFailure, BuildError> {
        Ok(PostWithdrawalReversedPayloadDataFailure {
            code: self.code,
