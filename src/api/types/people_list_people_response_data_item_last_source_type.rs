...
pub enum ListPeopleResponseDataItemLastSourceType {
    AdClick,
    LeadForm,
    ExternalAdClick,
    Referrer,
...
impl Serialize for ListPeopleResponseDataItemLastSourceType {
...
impl<'de> Deserialize<'de> for ListPeopleResponseDataItemLastSourceType {
...
impl fmt::Display for ListPeopleResponseDataItemLastSourceType {
