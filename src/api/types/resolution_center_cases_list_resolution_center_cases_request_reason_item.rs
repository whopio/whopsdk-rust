...
pub enum ListResolutionCenterCasesRequestReasonItem {
    Fraudulent,
    ProductNotReceived,
    NotAsDescribed,
    ProductUnacceptable,
...
impl Serialize for ListResolutionCenterCasesRequestReasonItem {
...
impl<'de> Deserialize<'de> for ListResolutionCenterCasesRequestReasonItem {
...
impl fmt::Display for ListResolutionCenterCasesRequestReasonItem {
