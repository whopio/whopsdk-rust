...
pub enum PostCardCreatedPayloadDataLimitFrequency {
    Daily,
    Weekly,
    Monthly,
    OneTime,
...
impl Serialize for PostCardCreatedPayloadDataLimitFrequency {
...
impl<'de> Deserialize<'de> for PostCardCreatedPayloadDataLimitFrequency {
...
impl fmt::Display for PostCardCreatedPayloadDataLimitFrequency {
