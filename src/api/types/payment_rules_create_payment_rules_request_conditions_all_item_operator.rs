...
pub enum CreatePaymentRulesRequestConditionsAllItemOperator {
    Eq,
    Neq,
    Gt,
    Gte,
...
impl Serialize for CreatePaymentRulesRequestConditionsAllItemOperator {
...
impl<'de> Deserialize<'de> for CreatePaymentRulesRequestConditionsAllItemOperator {
...
impl fmt::Display for CreatePaymentRulesRequestConditionsAllItemOperator {
