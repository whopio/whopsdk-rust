...
pub enum PostWithdrawalUpdatedPayloadDataSource {
    Api,
    Dashboard,
    Automatic,
...
impl Serialize for PostWithdrawalUpdatedPayloadDataSource {
...
impl<'de> Deserialize<'de> for PostWithdrawalUpdatedPayloadDataSource {
...
impl fmt::Display for PostWithdrawalUpdatedPayloadDataSource {
