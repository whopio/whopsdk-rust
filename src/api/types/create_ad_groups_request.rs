...
pub struct CreateAdGroupsRequest {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub bid_type: Option<CreateAdGroupsRequestBidType>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub budget_type: Option<CreateAdGroupsRequestBudgetType>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub conversion_location: Option<CreateAdGroupsRequestConversionLocation>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub frequency_cap: Option<CreateAdGroupsRequestFrequencyCap>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub message_apps: Option<Vec<CreateAdGroupsRequestMessageAppsItem>>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub optimization_goal: Option<CreateAdGroupsRequestOptimizationGoal>,
    ...
    /// - `whatsapp`: `status`
    #[serde(skip_serializing_if = "Option::is_none")]
    pub placements: Option<CreateAdGroupsRequestPlacements>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<CreateAdGroupsRequestStatus>,
    /// The display name of the ad group.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub title: Option<String>,
}

impl CreateAdGroupsRequest {
    pub fn builder() -> CreateAdGroupsRequestBuilder {
        <CreateAdGroupsRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateAdGroupsRequestBuilder {
    ad_campaign_id: Option<String>,
    audiences: Option<AdGroupAudiencesBody>,
    bid_type: Option<CreateAdGroupsRequestBidType>,
    budget_amount: Option<f64>,
    budget_type: Option<CreateAdGroupsRequestBudgetType>,
    conversion_event: Option<ConversionEvent>,
    conversion_location: Option<CreateAdGroupsRequestConversionLocation>,
    ...
    frequency_cap: Option<CreateAdGroupsRequestFrequencyCap>,
    languages: Option<Vec<String>>,
    message_apps: Option<Vec<CreateAdGroupsRequestMessageAppsItem>>,
    minimum_daily_spend: Option<f64>,
    optimization_goal: Option<CreateAdGroupsRequestOptimizationGoal>,
    placements: Option<CreateAdGroupsRequestPlacements>,
    regions: Option<AdGroupRegionsBody>,
    starts_at: Option<String>,
    status: Option<CreateAdGroupsRequestStatus>,
    title: Option<String>,
}

impl CreateAdGroupsRequestBuilder {
    ...
    pub fn bid_type(mut self, value: CreateAdGroupsRequestBidType) -> Self {
    ...
    pub fn budget_type(mut self, value: CreateAdGroupsRequestBudgetType) -> Self {
    ...
    pub fn conversion_location(mut self, value: CreateAdGroupsRequestConversionLocation) -> Self {
    ...
    pub fn frequency_cap(mut self, value: CreateAdGroupsRequestFrequencyCap) -> Self {
    ...
    pub fn message_apps(mut self, value: Vec<CreateAdGroupsRequestMessageAppsItem>) -> Self {
    ...
    pub fn optimization_goal(mut self, value: CreateAdGroupsRequestOptimizationGoal) -> Self {
        self.optimization_goal = Some(value);
        self
    }

    pub fn placements(mut self, value: CreateAdGroupsRequestPlacements) -> Self {
    ...
    pub fn status(mut self, value: CreateAdGroupsRequestStatus) -> Self {
    ...
    /// Consumes the builder and constructs a [`CreateAdGroupsRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`ad_campaign_id`](CreateAdGroupsRequestBuilder::ad_campaign_id)
    pub fn build(self) -> Result<CreateAdGroupsRequest, BuildError> {
        Ok(CreateAdGroupsRequest {
            ad_campaign_id: self
                .ad_campaign_id
                .ok_or_else(|| BuildError::missing_field("ad_campaign_id"))?,
