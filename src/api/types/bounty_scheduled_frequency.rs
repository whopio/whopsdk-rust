...
pub enum BountyScheduledFrequency {
    Once,
    Hourly,
    Daily,
    Weekly,
...
impl Serialize for BountyScheduledFrequency {
...
impl<'de> Deserialize<'de> for BountyScheduledFrequency {
...
impl fmt::Display for BountyScheduledFrequency {
